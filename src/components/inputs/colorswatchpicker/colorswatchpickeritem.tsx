import {
    ...
    ColorSwatchPickerItemProps as ReactAriaColorSwatchPickerItemProps
} from 'react-aria-components';
import {ColorSwatch, ColorSwatchProps} from './colorswatch.js';
