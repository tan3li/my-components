...
# Severa UI Component Library

Collection of Severa UI components and some general documentation.

This Storybook is up-to-date with main-branch of [severa-ui-components](https://github.com/Visma-Severa/severa-ui-components) repository. Release version content may be behind.
...
4. Configure token to use SSO by clicking "Configure SSO" and select Visma Severa.
...
```text
@visma-severa:registry=https://npm.pkg.github.com
...
```shell
yarn add @visma-severa/severa-ui-components@x.y.z
```

or `npm`

```shell
npm install @visma-severa/severa-ui-components@x.y.z
```
...
```scss
@import '@visma-severa/severa-ui-components/dist/index.css';
```
...
```jsx
import {Button, ButtonStyle, ButtonVariant} from '@visma-severa/severa-ui-components';
...
import {I18nProvider} from '@visma-severa/severa-ui-components';
...
Design tokens live in their own package [severa-design-tokens](https://github.com/Visma-Severa/severa-design-tokens) which is a dependency of this library. Design tokens package provides
