...
var headless = require('react-hot-toast/headless');
...
var codes = require('country-calling-code');
...
var ListItem$1 = require('@tiptap/extension-list-item');
...
var BaseHeading = require('@tiptap/extension-heading');
var core = require('@tiptap/core');
var reactDom = require('react-dom');
var interactions = require('@react-aria/interactions');
var sortBy = require('lodash.sortby');
var dTokens = require('@tan3li/d-tokens');
var Highcharts = require('highcharts');
require('highcharts/modules/accessibility');
var highchartsReactOfficial = require('highcharts-react-official');
...
function Icon(_a) {
    ...
    return (jsxRuntime.jsx(SvgIcon, { "aria-hidden": ariaHidden, "aria-label": ariaLabel, className: classNames('icon', className), color: color, height: size, ref: ref, width: size }));
}
...
})(exports.AriaRole || (exports.AriaRole = {}));
...
exports.KeyboardEventKey = void 0;
...
})(exports.KeyboardEventKey || (exports.KeyboardEventKey = {}));
var CTRL_MODIFIER_KEY = utils.isMac() ? 'metaKey' : 'ctrlKey';

exports.LabelPlacement = void 0;
(function (LabelPlacement) {
    LabelPlacement["Start"] = "start";
    LabelPlacement["End"] = "end";
})(exports.LabelPlacement || (exports.LabelPlacement = {}));
...
function Label(_a) {
    ...
    var Element = elementType !== null && elementType !== void 0 ? elementType : (htmlFor ? exports.HTMLElementType.Label : exports.HTMLElementType.Span);
    return (jsxRuntime.jsx(Element, __assign({}, props, { className: classNames("label label--".concat(size), className) }, (Element === exports.HTMLElementType.Label && { htmlFor: htmlFor }))));
}
...
function ActionItemContent(_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [prefix, leftIconName && jsxRuntime.jsx(Icon, { className: "action-item__left-icon", name: leftIconName, size: exports.IconSize.MD }), jsxRuntime.jsxs("div", __assign({ className: "action-item__body" }, { children: [jsxRuntime.jsx(reactAriaComponents.Text, __assign({ className: classNames('action-item__label', LABEL_SIZE_MD_CSS_CLASS), slot: "label" }, { children: label })), description && (jsxRuntime.jsx(reactAriaComponents.Text, __assign({ className: classNames('action-item__description', LABEL_SIZE_SM_CSS_CLASS), slot: "description" }, { children: description })))] })), (!!rightIconName || !!actionLabel || !!suffix) && (jsxRuntime.jsxs("div", __assign({ className: "action-item__suffix" }, { children: [suffix, actionLabel && (jsxRuntime.jsx(Label, __assign({ className: "action-item__action-label", size: exports.Size.md }, { children: actionLabel }))), rightIconName && (jsxRuntime.jsx(Icon, { className: "action-item__right-icon", name: rightIconName, size: exports.IconSize.MD }))] })))] }));
}

function BodyText(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.start : _b, children = _a.children, className = _a.className, elementType = _a.elementType, ref = _a.ref, size = _a.size, style = _a.style;
    var Element = elementType !== null && elementType !== void 0 ? elementType : exports.HTMLElementType.P;
    return (jsxRuntime.jsx(Element, __assign({ className: classNames("body-text body-text--".concat(size, " body-text--align-").concat(alignment), className), ref: ref, style: style }, { children: children })));
}

function RequiredIndicator(_a) {
    var className = _a.className;
    return (jsxRuntime.jsx("svg", __assign({ className: classNames('required-indicator', className), height: "6", viewBox: "0 0 6 6", width: "6" }, { children: jsxRuntime.jsx("path", { d: "M2.29159 5.72727L2.37114 3.53977L0.521706 4.71307L0.0444336 3.87784L1.9933 2.86364L0.0444336 1.84943L0.521706 1.0142L2.37114 2.1875L2.29159 0H3.24614L3.16659 2.1875L5.01602 1.0142L5.4933 1.84943L3.54443 2.86364L5.4933 3.87784L5.01602 4.71307L3.16659 3.53977L3.24614 5.72727H2.29159Z", fill: "currentColor" }) })));
}
...
function TooltipTrigger(_a) {
    ...
    return (jsxRuntime.jsx(reactAriaComponents.TooltipTrigger, __assign({}, props, { delay: delay }, { children: children })));
}
...
function Tooltip(_a) {
    var children = _a.children, className = _a.className, _b = _a.elementType, elementType = _b === void 0 ? exports.HTMLElementType.Div : _b, headerIconName = _a.headerIconName, headerText = _a.headerText, _c = _a.maxWidth, maxWidth = _c === void 0 ? DEFAULT_MAX_WIDTH : _c, _d = _a.position, position = _d === void 0 ? exports.Position.Top : _d, _e = _a.showArrow, showArrow = _e === void 0 ? true : _e, type = _a.type, props = __rest(_a, ["children", "className", "elementType", "headerIconName", "headerText", "maxWidth", "position", "showArrow", "type"]);
    return (jsxRuntime.jsxs(reactAriaComponents.Tooltip, __assign({}, props, { className: classNames("tooltip tooltip--".concat(type), className), placement: position, style: { maxWidth: maxWidth } }, { children: [type === 'rich' && (jsxRuntime.jsxs("div", __assign({ className: "tooltip__header" }, { children: [jsxRuntime.jsx(Label, __assign({ className: "tooltip__header-text", size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: headerText }) })), headerIconName && (jsxRuntime.jsx(Icon, { className: "tooltip__header-icon", name: headerIconName, size: exports.IconSize.SM }))] }))), showArrow && (jsxRuntime.jsx(reactAriaComponents.OverlayArrow, { children: jsxRuntime.jsx("svg", __assign({ className: "tooltip__arrow", height: "12", viewBox: "0 0 12 12", width: "12" }, { children: jsxRuntime.jsx("path", { d: "M6 6.16614L7.15493e-08 0L12 0L6 6.16614Z" }) })) })), jsxRuntime.jsx(BodyText, __assign({ elementType: elementType, size: exports.Size.xs }, { children: children }))] })));
}
...
function TriggerElement(_a) {
    ...
    var ElementType = elementType !== null && elementType !== void 0 ? elementType : exports.HTMLElementType.Span;
    var ref = react.useRef(null);
    var _b = reactAria.useFocusRing(props), focusProps = _b.focusProps, isFocused = _b.isFocused, isFocusVisible = _b.isFocusVisible;
    var buttonProps = reactAria.useButton(__assign({ elementType: ElementType }, props), ref).buttonProps;
    var renderProps = {
        isFocused: isFocused,
        isFocusVisible: isFocusVisible
    };
    react.useImperativeHandle(outerRef, function () { return ref.current; }, []);
    return (jsxRuntime.jsx(ElementType, __assign({}, reactAria.mergeProps(buttonProps, focusProps), { className: classNames('trigger-element', className), ref: ref, role: role !== null && role !== void 0 ? role : buttonProps.role, style: __assign(__assign({}, buttonProps.style), style) }, { children: isFunction(children) ? children(renderProps) : children })));
}

function FieldLabel(_a) {
    var children = _a.children, className = _a.className, isDisabled = _a.isDisabled, isRequired = _a.isRequired, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b, suffix = _a.suffix, tooltipContent = _a.tooltipContent, props = __rest(_a, ["children", "className", "isDisabled", "isRequired", "size", "suffix", "tooltipContent"]);
    var _c = tooltipContent !== null && tooltipContent !== void 0 ? tooltipContent : {}, ttContent = _c.content, ttProps = __rest(_c, ["content"]);
    var iconSize = exports.IconSize.XS;
    if (size === exports.Size.md) {
        iconSize = exports.IconSize.SM;
    }
    return (jsxRuntime.jsxs(reactAriaComponents.Label, __assign({}, props, { className: classNames('field-label', className, {
            'field-label--disabled': isDisabled
        }) }, { children: [isRequired && jsxRuntime.jsx(RequiredIndicator, {}), jsxRuntime.jsx(Label, __assign({ size: size }, { children: jsxRuntime.jsx("strong", { children: children }) })), ttContent && (jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(TriggerElement, { children: jsxRuntime.jsx(Icon, { className: "field-label__icon", name: iconNames.Help, size: iconSize }) }), jsxRuntime.jsx(Tooltip, __assign({}, ttProps, { type: exports.TooltipType.Rich }, { children: ttContent }))] })), suffix] })));
}
...
function Heading(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.start : _b, children = _a.children, className = _a.className, Element = _a.elementType, size = _a.size, props = __rest(_a, ["alignment", "children", "className", "elementType", "size"]);
    var cssClassName = classNames("heading heading--".concat(size, " heading--align-").concat(alignment), className);
    if (Element) {
        return (jsxRuntime.jsx(Element, __assign({}, props, { className: cssClassName }, { children: children })));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Heading, __assign({}, props, { className: cssClassName }, { children: children })));
}

function useTranslateFn(prefix) {
    var t = reactI18next.useTranslation().t;
    return react.useCallback(function (phrase, keys) { return t("".concat(prefix, ".").concat(phrase), keys); }, [t, prefix]);
}
...
exports.HelpTextVariant = void 0;
...
})(exports.HelpTextVariant || (exports.HelpTextVariant = {}));
function getIconProps(variant, translateFn) {
    var name, label;
    switch (variant) {
        case exports.HelpTextVariant.Danger:
            name = iconNames.EmergencyHomeFilled;
            label = translateFn('warning');
            break;
        case exports.HelpTextVariant.Success:
...
function HelpText(_a) {
    var children = _a.children, className = _a.className, id = _a.id, showIcon = _a.showIcon, _b = _a.variant, variant = _b === void 0 ? exports.HelpTextVariant.Neutral : _b;
    var translateCommon = useTranslateCommon();
    var content = [
        jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: children }), "text")
    ];
    if (showIcon || variant === exports.HelpTextVariant.Danger) {
        var _c = getIconProps(variant, translateCommon), name_1 = _c.name, label = _c.label;
        content.unshift(jsxRuntime.jsx(Icon, { ariaLabel: label, name: name_1, size: exports.IconSize.SM }, "icon"));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Text, __assign({ className: classNames("help-text help-text--".concat(variant), className), id: id, slot: "description" }, { children: content })));
}

function Title(_a) {
    var children = _a.children, className = _a.className, _b = _a.elementType, Element = _b === void 0 ? exports.HTMLElementType.Div : _b, size = _a.size, props = __rest(_a, ["children", "className", "elementType", "size"]);
...
exports.SpinnerVariant = void 0;
(function (SpinnerVariant) {
    SpinnerVariant["Neutral"] = "neutral";
    SpinnerVariant["Accent"] = "accent";
    SpinnerVariant["None"] = "none";
})(exports.SpinnerVariant || (exports.SpinnerVariant = {}));
function Spinner(_a) {
    var _b;
    var ariaLabel = _a["aria-label"], ariaLabelledBy = _a["aria-labelledby"], className = _a.className, label = _a.label, _c = _a.labelPosition, labelPosition = _c === void 0 ? exports.Position.Bottom : _c, labelSize = _a.labelSize, ref = _a.ref, size = _a.size, _d = _a.variant, variant = _d === void 0 ? exports.SpinnerVariant.Accent : _d;
    return (jsxRuntime.jsxs("div", __assign({ "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, className: classNames("spinner spinner--".concat(size), className, (_b = {},
            _b["spinner--".concat(variant)] = variant !== exports.SpinnerVariant.None,
            _b["spinner--label-".concat(labelPosition)] = !!label,
            _b)), ref: ref, role: exports.AriaRole.status }, { children: [jsxRuntime.jsx("span", { className: "spinner__loader" }), label && (jsxRuntime.jsx(Label, __assign({ className: "spinner__label", size: labelSize !== null && labelSize !== void 0 ? labelSize : (size === exports.Size.xl ? exports.Size.lg : exports.Size.md) }, { children: label })))] })));
}
...
})(exports.ButtonRole || (exports.ButtonRole = {}));
function Button(_a) {
    var ariaLabel = _a["aria-label"], className = _a.className, children = _a.children, endIconName = _a.endIconName, inverted = _a.inverted, isLoading = _a.isLoading, ref = _a.ref, _b = _a.role, role = _b === void 0 ? exports.ButtonRole.Button : _b, _c = _a.size, size = _c === void 0 ? exports.Size.md : _c, startIconName = _a.startIconName, style = _a.style, variant = _a.variant, props = __rest(_a, ['aria-label', "className", "children", "endIconName", "inverted", "isLoading", "ref", "role", "size", "startIconName", "style", "variant"]);
    ...
    var content = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [isLoading && (jsxRuntime.jsx(Spinner, { className: "button__spinner", size: size === exports.Size.lg ? exports.Size.md : exports.Size.sm, variant: exports.SpinnerVariant.None })), startIconName && (jsxRuntime.jsx(Icon, { ariaHidden: true, className: "button__icon button__icon--".concat(size), name: startIconName })), jsxRuntime.jsx(Label, __assign({ className: "button__label", size: size }, { children: isChildrenStrOrNum ?
                    jsxRuntime.jsx("strong", { children: children })
                    : children })), endIconName && (jsxRuntime.jsx(Icon, { ariaHidden: true, className: "button__icon button__icon--".concat(size), name: endIconName }))] }));
    if (role === exports.ButtonRole.Link) {
        return (jsxRuntime.jsx(reactAriaComponents.Link, __assign({}, props, commonProps, { ref: ref }, { children: content })));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Button, __assign({}, props, commonProps, { ref: ref }, { children: content })));
}
...
function ClearButton(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsx(reactAriaComponents.Button, __assign({}, props, { "aria-label": (_b = props['aria-label']) !== null && _b !== void 0 ? _b : translateCommon('clear'), className: classNames('clear-button', className) }, { children: jsxRuntime.jsx(Icon, { className: "clear-button__icon", name: iconNames.CancelFilled }) })));
}
...
function I18nProvider(_a) {
    ...
    var value = react.useMemo(function () { return ({ cultureLocale: cultureLocale, languageLocale: languageLocale, timeZone: timeZone }); }, [cultureLocale, languageLocale, timeZone]);
    return (jsxRuntime.jsx(reactAria.I18nProvider, __assign({ locale: languageLocale }, { children: jsxRuntime.jsx(I18nContext, __assign({ value: value }, { children: children })) })));
}
...
function IconButton(_a) {
    var className = _a.className, iconName = _a.iconName, inverted = _a.inverted, isLoading = _a.isLoading, ref = _a.ref, _b = _a.role, role = _b === void 0 ? exports.ButtonRole.Button : _b, _c = _a.size, size = _c === void 0 ? exports.Size.md : _c, style = _a.style, variant = _a.variant, props = __rest(_a, ["className", "iconName", "inverted", "isLoading", "ref", "role", "size", "style", "variant"]);
    var commonProps = {
    ...
    var content = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [isLoading && (jsxRuntime.jsx(Spinner, { className: "button__spinner", size: size === exports.Size.lg ? exports.Size.md : exports.Size.sm, variant: exports.SpinnerVariant.None })), jsxRuntime.jsx(Icon, { className: classNames("button__icon icon-button__icon icon-button__icon--".concat(size), {
...
exports.AlertBannerVariant = void 0;
...
})(exports.AlertBannerVariant || (exports.AlertBannerVariant = {}));
function AlertBanner(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("alert-banner alert-banner--".concat(variant), className, {
            'alert-banner--dismissible': isDismissible
        }), ref: ref, role: role }, { children: [iconName && jsxRuntime.jsx(Icon, { className: "alert-banner__icon", name: iconName, size: exports.IconSize.MD }), jsxRuntime.jsx(BodyText, __assign({ className: "alert-banner__content", size: exports.Size.md }, { children: children })), isDismissible && (jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('closeNotification'), className: "alert-banner__close-button", iconName: iconNames.CloseFilled, inverted: variant !== exports.AlertBannerVariant.Warning, onPress: onDismiss, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }))] })));
}

function useIntersectionObserver(callback) {
    var observer = react.useRef(null);
    var onVisible = react.useCallback(function (entries) {
...
function ProgressBar(props) {
    ...
    var _a = react.useState(0), progressBarWidth = _a[0], setProgressBarWidth = _a[1];
    var _b = react.useState(0), tooltipArrowOffset = _b[0], setTooltipArrowOffset = _b[1];
    var isValueLabelPositionRight = valueLabelPosition === exports.Position.Right;
    ...
    var onProgressBarResize = react.useCallback(function () {
        var _a, _b;
    ...
    return (jsxRuntime.jsx(reactAriaComponents.ProgressBar, __assign({}, props, { className: classNames('progress-bar', className) }, { children: function (_a) {
            var percentage = _a.percentage, valueText = _a.valueText;
            return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && labelPosition === exports.Position.Top && (jsxRuntime.jsx(Label, __assign({ className: classNames('progress-bar__label', {
                            'progress-bar__label--top': !valueText || !isValueLabelPositionRight
                        }), elementType: exports.HTMLElementType.Div, size: exports.Size.md }, { children: label }))), jsxRuntime.jsxs("div", __assign({ className: "progress-bar__top_container" }, { children: [jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx("div", __assign({ className: "progress-bar__bar-wrapper", ref: progressBarRef }, { children: jsxRuntime.jsx(TriggerElement, __assign({ "aria-label": label !== null && label !== void 0 ? label : props['aria-label'], className: "progress-bar__bar" }, { children: jsxRuntime.jsx("div", { className: classNames('progress-bar__fill', {
                                                    'progress-bar__fill--indeterminate': isIndeterminate
                                                }), style: isIndeterminate ? {} : { width: "".concat(percentage, "%") } }) })) })), valueText && (jsxRuntime.jsx(Tooltip, __assign({ arrowBoundaryOffset: tooltipArrowOffset, crossOffset: calculateTooltipOffset(percentage), position: tooltipPosition, ref: tooltipRef, type: exports.TooltipType.Plain }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: valueText }) })) })))] }), valueText && isValueLabelPositionRight && (jsxRuntime.jsx(Label, __assign({ className: "progress-bar__value-label progress-bar__value-label--right", size: exports.Size.md }, { children: valueText })))] })), jsxRuntime.jsxs("div", __assign({ className: "progress-bar__bottom_container" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "progress-bar__bottom_left-container" }, { children: [label && labelPosition === exports.Position.Bottom && (jsxRuntime.jsx(Label, __assign({ className: classNames('progress-bar__label', {
                                            'progress-bar__label--bottom': !valueText || !isValueLabelPositionRight
                                        }), size: exports.Size.md }, { children: label }))), helpText && (jsxRuntime.jsx(HelpText, __assign({ className: "progress-bar__help-text", showIcon: showHelpTextIcon }, { children: helpText })))] })), valueText && valueLabelPosition === exports.Position.Bottom && (jsxRuntime.jsx(Label, __assign({ className: "progress-bar__value-label progress-bar__value-label--bottom", size: exports.Size.md }, { children: valueText })))] }))] }));
        } })));
}

function LoadingIndicatorProgressBar() {
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsx(ProgressBar, { "aria-label": translateCommon('loading'), className: "loading-indicator-progress-bar", isIndeterminate: true }));
}

exports.OverlayHeaderVariant = void 0;
...
})(exports.OverlayHeaderVariant || (exports.OverlayHeaderVariant = {}));
function OverlayHeader(_a) {
    var _b = _a.autoFocusClose, autoFocusClose = _b === void 0 ? true : _b, children = _a.children, className = _a.className, details = _a.details, iconName = _a.iconName, onClose = _a.onClose, onExpand = _a.onExpand, ref = _a.ref, showLoadingIndicator = _a.showLoadingIndicator, _c = _a.variant, variant = _c === void 0 ? exports.OverlayHeaderVariant.Neutral : _c;
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("overlay-header overlay-header--".concat(variant), className), ref: ref }, { children: [iconName && (jsxRuntime.jsx("div", __assign({ className: "overlay-header__icon-area" }, { children: jsxRuntime.jsx(Icon, { name: iconName, size: exports.IconSize.MD }) }))), jsxRuntime.jsxs("div", __assign({ className: "overlay-header__title" }, { children: [jsxRuntime.jsx(Heading, __assign({ size: exports.Size.xs, slot: "title" }, { children: children })), details] })), onExpand && (jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('expand'), iconName: iconNames.PanZoom, onPress: onExpand, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })), jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('close'), autoFocus: autoFocusClose, iconName: iconNames.CloseFilled, onPress: onClose, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }), showLoadingIndicator && jsxRuntime.jsx(LoadingIndicatorProgressBar, {})] })));
}
...
function OverlayFooter(_a) {
    ...
    if (destructiveAction) {
        if (destructiveAction.iconName) {
            destructiveButton = (jsxRuntime.jsx(IconButton, { "aria-label": destructiveAction.label, autoFocus: destructiveAction.autoFocus, iconName: destructiveAction.iconName, isDisabled: destructiveAction.isDisabled, isLoading: destructiveAction.isLoading, onPress: function () { return safeCall(destructiveAction === null || destructiveAction === void 0 ? void 0 : destructiveAction.onPress, closeCallback); }, size: exports.Size.lg, style: exports.ButtonStyle.Plain, variant: (_b = destructiveAction.variant) !== null && _b !== void 0 ? _b : exports.ButtonVariant.Danger }));
        }
        else {
            destructiveButton = (jsxRuntime.jsx(Button, __assign({ autoFocus: destructiveAction.autoFocus, isDisabled: destructiveAction.isDisabled, isLoading: destructiveAction.isLoading, onPress: function () { return safeCall(destructiveAction === null || destructiveAction === void 0 ? void 0 : destructiveAction.onPress, closeCallback); }, size: exports.Size.lg, style: exports.ButtonStyle.Plain, variant: (_c = destructiveAction.variant) !== null && _c !== void 0 ? _c : exports.ButtonVariant.Danger }, { children: destructiveAction.label })));
        }
    }
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('overlay-footer', className), ref: ref }, { children: [destructiveButton, jsxRuntime.jsxs("div", __assign({ className: "overlay-footer__actions" }, { children: [secondaryAction && (jsxRuntime.jsx(Button, __assign({ autoFocus: secondaryAction.autoFocus, isDisabled: secondaryAction.isDisabled, isLoading: secondaryAction.isLoading, onPress: function () { return safeCall(secondaryAction === null || secondaryAction === void 0 ? void 0 : secondaryAction.onPress, closeCallback); }, size: exports.Size.lg, style: (_d = secondaryAction.style) !== null && _d !== void 0 ? _d : exports.ButtonStyle.Outline, variant: (_e = secondaryAction.variant) !== null && _e !== void 0 ? _e : exports.ButtonVariant.Neutral }, { children: secondaryAction.label }))), primaryAction && (jsxRuntime.jsx(Button, __assign({ autoFocus: primaryAction.autoFocus, isDisabled: primaryAction.isDisabled, isLoading: primaryAction.isLoading, onPress: function () { return safeCall(primaryAction === null || primaryAction === void 0 ? void 0 : primaryAction.onPress, closeCallback); }, size: exports.Size.lg, style: (_f = primaryAction.style) !== null && _f !== void 0 ? _f : exports.ButtonStyle.Fill, variant: (_g = primaryAction.variant) !== null && _g !== void 0 ? _g : exports.ButtonVariant.Accent }, { children: primaryAction.label })))] }))] })));
}
...
function useBodyScrollPosition() {
    var _a = react.useState(null), bodyScrollPosition = _a[0], setBodyScrollPosition = _a[1];
    var detectAndSetBodyScrollPosition = react.useCallback(function (bodyElement) {
    ...
    var onScroll = react.useCallback(throttle(function (e) {
        detectAndSetBodyScrollPosition(e.target);
    }, 100), []);
    var resizeObserver = react.useRef(null);
    var onBodyRef = react.useCallback(function (bodyElement) {
        if (bodyElement) {
...
function AlertModal(_a) {
    ...
    var renderContent = function (_a) {
        var close = _a.close;
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(OverlayHeader, __assign({ autoFocusClose: autoFocusClose, className: "alert-modal-dialog__header", iconName: headerIcon, onClose: close, variant: variant }, { children: title })), jsxRuntime.jsx("div", __assign({ className: classNames('alert-modal-dialog__body', {
                    ...
                    tabIndex: 0 }, { children: isFunction(children) ? children(close) : children })), hasFooter && (jsxRuntime.jsx(OverlayFooter, { className: "alert-modal-dialog__footer", closeCallback: close, destructiveAction: destructiveAction, primaryAction: primaryAction, secondaryAction: secondaryAction }))] }));
    };
    return (jsxRuntime.jsx(reactAriaComponents.ModalOverlay, __assign({}, props, { className: classNames('alert-modal-overlay', className, {
            'alert-modal-overlay--scrollable': shouldScrollInViewport
        }), isDismissable: isDismissibleOnOutClick }, { children: jsxRuntime.jsx("div", __assign({ className: "alert-modal-wrapper" }, { children: jsxRuntime.jsx(reactAriaComponents.Modal, __assign({ className: "alert-modal alert-modal--".concat(size) }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ className: classNames('alert-modal-dialog', (_b = {},
...
})(exports.BadgeVariant || (exports.BadgeVariant = {}));
function useIconLabel(variant) {
    var translateCommon = useTranslateCommon();
    switch (variant) {
        case exports.BadgeVariant.Informative:
            return translateCommon('info');
        case exports.BadgeVariant.Success:
            return translateCommon('success');
        case exports.BadgeVariant.Danger:
            return translateCommon('danger');
        case exports.BadgeVariant.Warning:
...
function Badge(_a) {
    ...
    return (jsxRuntime.jsxs("span", __assign({ "aria-label": ariaLabel, className: classNames("badge badge--".concat(variant, " ").concat(style, "-badge ").concat(style, "-badge--").concat(variant), className, {
            'badge--disabled': isDisabled
        }), ref: ref, role: role }, { children: [iconName && jsxRuntime.jsx(Icon, { ariaLabel: iconLabel, className: "badge__icon", name: iconName, size: exports.IconSize.XS }), jsxRuntime.jsx(Label, __assign({ className: "badge__label", size: exports.Size.sm }, { children: isStringOrNumberChild ?
                    jsxRuntime.jsx("strong", { children: children })
                    : children }))] })));
}
...
function useAutoHeightAnimation(_a) {
    ...
    var isLoadedRef = react.useRef(isExpanded);
...
function Callout(_a) {
    ...
    var state = reactStately.useDisclosureState(props);
    var panelRef = react.useRef(null);
    var triggerRef = react.useRef(null);
    var _b = reactAria.useDisclosure(props, state, panelRef), triggerProps = _b.buttonProps, panelProps = _b.panelProps;
    var buttonProps = reactAria.useButton(triggerProps, triggerRef).buttonProps;
    var _c = reactAria.useFocusRing(), isFocusVisible = _c.isFocusVisible, focusProps = _c.focusProps;
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('callout', className), ref: ref }, { children: [jsxRuntime.jsxs("button", __assign({}, reactAria.mergeProps(buttonProps, focusProps), { className: "callout__header", "data-focus-visible": isFocusVisible || undefined, ref: triggerRef }, { children: [jsxRuntime.jsxs("div", __assign({ className: "callout__header-left" }, { children: [jsxRuntime.jsx(Icon, { ariaHidden: true, className: "callout__icon", name: iconName, size: exports.IconSize.MD }), jsxRuntime.jsx(Label, __assign({ className: "callout__title", size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: title }) }))] })), jsxRuntime.jsx(Icon, { ariaHidden: true, className: "callout__expander-icon", name: isExpanded ? iconNames.ExpandMore : iconNames.ChevronRight, size: exports.IconSize.MD })] })), jsxRuntime.jsx("div", __assign({}, reactAria.mergeProps(panelProps, animationProps), { className: "callout__panel", ref: panelRef }, { children: (isExpanded || isLoaded) && (jsxRuntime.jsx("div", __assign({ className: "callout__panel-content" }, { children: jsxRuntime.jsx(BodyText, __assign({ elementType: exports.HTMLElementType.Div, size: exports.Size.sm }, { children: children })) }))) }))] })));
}

exports.DrawerVariant = void 0;
(function (DrawerVariant) {
    DrawerVariant["FullOverlay"] = "full-overlay";
    DrawerVariant["Standard"] = "standard";
})(exports.DrawerVariant || (exports.DrawerVariant = {}));
exports.DrawerWidth = void 0;
(function (DrawerWidth) {
    DrawerWidth["Medium"] = "medium";
    DrawerWidth["Wide"] = "wide";
})(exports.DrawerWidth || (exports.DrawerWidth = {}));
exports.DrawerHeaderStyle = void 0;
(function (DrawerHeaderStyle) {
    DrawerHeaderStyle["Emphasized"] = "emphasized";
    DrawerHeaderStyle["Standard"] = "standard";
})(exports.DrawerHeaderStyle || (exports.DrawerHeaderStyle = {}));
function Drawer(_a) {
    var ariaLabel = _a["aria-label"], autoFocusClose = _a.autoFocusClose, children = _a.children, className = _a.className, destructiveAction = _a.destructiveAction, footer = _a.footer, header = _a.header, headerDetails = _a.headerDetails, _b = _a.headerStyle, headerStyle = _b === void 0 ? exports.DrawerHeaderStyle.Standard : _b, isDismissable = _a.isDismissable, primaryAction = _a.primaryAction, scrollRef = _a.scrollRef, secondaryAction = _a.secondaryAction, showHeaderLoadingIndicator = _a.showHeaderLoadingIndicator, _c = _a.shouldAnimate, shouldAnimate = _c === void 0 ? true : _c, title = _a.title, _d = _a.variant, variant = _d === void 0 ? exports.DrawerVariant.Standard : _d, _e = _a.width, width = _e === void 0 ? exports.DrawerWidth.Medium : _e, props = __rest(_a, ['aria-label', "autoFocusClose", "children", "className", "destructiveAction", "footer", "header", "headerDetails", "headerStyle", "isDismissable", "primaryAction", "scrollRef", "secondaryAction", "showHeaderLoadingIndicator", "shouldAnimate", "title", "variant", "width"]);
    ...
    var renderContent = function (_a) {
        ...
        if (header) {
            headerElement = jsxRuntime.jsx("div", __assign({ className: headerCssClass }, { children: isFunction(header) ? header({ close: close }) : header }));
        }
        else if (title) {
            headerElement = (jsxRuntime.jsx(OverlayHeader, __assign({ autoFocusClose: autoFocusClose, className: headerCssClass, details: headerDetails, onClose: close, showLoadingIndicator: showHeaderLoadingIndicator, variant: exports.OverlayHeaderVariant.Neutral }, { children: title })));
        }
        if (footer) {
            footerElement = jsxRuntime.jsx("div", __assign({ className: footerCssClass }, { children: isFunction(footer) ? footer({ close: close }) : footer }));
        }
        else if (primaryAction) {
            footerElement = (jsxRuntime.jsx(OverlayFooter, { className: footerCssClass, closeCallback: close, destructiveAction: destructiveAction, primaryAction: primaryAction, secondaryAction: secondaryAction }));
        }
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [headerElement, jsxRuntime.jsx("div", __assign({ className: "drawer__body", onScroll: onScroll, ref: utils.mergeRefs(scrollRef, onBodyRef) }, { children: children })), footerElement] }));
    };
    return (jsxRuntime.jsx(reactAriaComponents.ModalOverlay, __assign({}, props, { className: classNames("drawer-overlay drawer-overlay--".concat(variant), {
            'drawer-overlay--animated': shouldAnimate
        }), isDismissable: isDismissable !== null && isDismissable !== void 0 ? isDismissable : true }, { children: jsxRuntime.jsx(reactAriaComponents.Modal, __assign({ className: classNames("drawer drawer--".concat(width), className) }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ "aria-label": ariaLabel, className: "drawer__dialog drawer__dialog--scroll-".concat(bodyScrollPosition) }, { children: renderContent })) })) })));
}

exports.InlineAlertVariant = void 0;
...
})(exports.InlineAlertVariant || (exports.InlineAlertVariant = {}));
function getIconName(variant) {
    switch (variant) {
        case exports.InlineAlertVariant.Danger:
            return iconNames.EmergencyHomeFilled;
        case exports.InlineAlertVariant.Success:
            return iconNames.CheckCircleFilled;
        case exports.InlineAlertVariant.Warning:
...
function InlineAlert(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("inline-alert inline-alert--".concat(variant), className), ref: ref, role: "alert" }, { children: [variant && jsxRuntime.jsx(Icon, { className: "inline-alert__icon", name: getIconName(variant), size: exports.IconSize.MD }), jsxRuntime.jsxs("div", __assign({ className: "inline-alert__content" }, { children: [title && (jsxRuntime.jsx(BodyText, __assign({ elementType: exports.HTMLElementType.Div, size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: title }) }))), jsxRuntime.jsx(BodyText, __assign({ elementType: exports.HTMLElementType.Div, size: exports.Size.sm }, { children: content }))] })), (!!actionLabel || isDismissible) && (jsxRuntime.jsxs("div", __assign({ className: "inline-alert__actions" }, { children: [actionLabel && (jsxRuntime.jsx(Button, __assign({ className: "inline-alert__action-button", onPress: onAction, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: actionLabel }))), isDismissible && (jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('close'), className: "inline-alert__close-button", iconName: iconNames.CloseFilled, onPress: function () { return setIsVisible(!isVisible); }, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }))] })))] })));
}
...
})(exports.SkeletonShape || (exports.SkeletonShape = {}));
function Skeleton(_a) {
    var ariaHidden = _a["aria-hidden"], className = _a.className, height = _a.height, _b = _a.shape, shape = _b === void 0 ? exports.SkeletonShape.Rectangle : _b, style = _a.style, width = _a.width, props = __rest(_a, ['aria-hidden', "className", "height", "shape", "style", "width"]);
    return (jsxRuntime.jsx("div", __assign({}, props, { "aria-hidden": ariaHidden === false ? undefined : true, className: classNames("skeleton skeleton--".concat(shape), className), style: __assign(__assign({}, style), { height: height, width: width }) })));
}

exports.SkeletonTextType = void 0;
...
})(exports.SkeletonTextType || (exports.SkeletonTextType = {}));
function SkeletonText(_a) {
    var ariaHidden = _a["aria-hidden"], className = _a.className, ref = _a.ref, size = _a.size, _b = _a.type, type = _b === void 0 ? exports.SkeletonTextType.Body : _b, width = _a.width;
    return (jsxRuntime.jsx("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames("skeleton-text skeleton-text--".concat(type, "-").concat(size), className), ref: ref, style: { width: width } }, { children: jsxRuntime.jsx(Skeleton, { "aria-hidden": false }) })));
}
function SkeletonTextMultiline(_a) {
    ...
    if (lineCount < 2) {
        return jsxRuntime.jsx(SkeletonText, __assign({}, props, { "aria-hidden": ariaHidden, className: className, ref: ref, width: width }));
    }
    return (jsxRuntime.jsx("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-text-multiline', className), ref: ref }, { children: Array.from({ length: lineCount }, function (_, i) { return (jsxRuntime.jsx(SkeletonText, __assign({ "aria-hidden": false }, props, { width: i === lineCount - 1 ? '60%' : width }), i)); }) })));
}
...
function ToastProgressBar(_a) {
    ...
    var _b = react.useState(timeout), remainingTimeout = _b[0], setRemainingTimeout = _b[1];
    var fillRef = react.useRef(null);
    var prevTimeRef = react.useRef(null);
    ...
    return (jsxRuntime.jsx(reactAriaComponents.ProgressBar, __assign({ "aria-label": translateProject('progress'), className: "toast-progress-bar", value: (remainingTimeout / timeout) * 100 }, { children: jsxRuntime.jsx("div", __assign({ className: "toast-progress-bar__bar" }, { children: jsxRuntime.jsx("div", { className: "toast-progress-bar__fill", ref: fillRef }) })) })));
}

var rhtToastDismiss = headless.toast.dismiss;
...
var ToastHandler = /** @class */ (function () {
    ...
    ToastHandler.prototype.add = function (message, opts) {
        ...
        if (this._visibleToastIds.size >= this._maxVisibleCount) {
            ...
            headless.toast(message, __assign(__assign({}, opts), { id: id }));
...
headless.toast.dismiss = toastHandler.dismiss;
...
function Toast(_a) {
    ...
    var pausedAt = headless.useToasterStore().pausedAt;
    var translateCommon = useTranslateCommon();
    ...
    if (variant === ToastVariant.Loading) {
        prefix = jsxRuntime.jsx(Spinner, { size: exports.Size.sm, variant: exports.SpinnerVariant.None });
    }
    else {
        var iconName = getPrefixIcon(variant);
        if (iconName) {
            prefix = (jsxRuntime.jsx("div", __assign({ className: "toast__icon-wrapper" }, { children: jsxRuntime.jsx(Icon, { className: "toast__icon", name: iconName, size: exports.IconSize.MD }) })));
        }
    }
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-labelledby": textId, "aria-modal": false, className: classNames("toast toast--".concat(variant), animationCssClass), role: "alertdialog", 
        // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
        tabIndex: 0 }, { children: [jsxRuntime.jsxs("div", __assign({ "aria-atomic": true, className: "toast__body", role: "alert" }, { children: [prefix, jsxRuntime.jsx("div", __assign({ className: "toast__text", id: textId }, { children: jsxRuntime.jsx(BodyText, __assign({ size: exports.Size.md }, { children: children })) })), actionLabel && (jsxRuntime.jsx(Button, __assign({ className: "toast__action-button", inverted: true, onPress: onActionPress, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: actionLabel }))), jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('close'), className: "toast__close-button", iconName: iconNames.CloseFilled, inverted: true, onPress: function () {
                            toastHandler.dismiss(id);
                        }, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })] })), duration && jsxRuntime.jsx(ToastProgressBar, { isPaused: !!pausedAt, timeout: duration })] })));
}
...
function ToastWrapper(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames('toast-wrapper', {
...
function addToast(children, variant, options) {
    ...
    return toastHandler.add(function (t) { return (jsxRuntime.jsx(Toast, { toast: __assign(__assign({}, t), { content: {
...
function GlobalToastRegion(props) {
    var _a = headless.useToaster(), handlers = _a.handlers, toasts = _a.toasts;
    return (jsxRuntime.jsx("div", __assign({}, props, { className: "global-toast-region", onMouseEnter: handlers.startPause, onMouseLeave: handlers.endPause }, { children: toasts.map(function (t) {
            ...
            return (jsxRuntime.jsx(ToastWrapper, __assign({ id: id, isActive: t.visible, onHeightUpdate: handlers.updateHeight, style: {
                    transform: "translateY(".concat(offset * -1, "px)")
                } }, { children: isFunction(message) ? message(t) : message }), id));
        }) })));
}

exports.DueDateButtonVariant = void 0;
...
})(exports.DueDateButtonVariant || (exports.DueDateButtonVariant = {}));
function DueDateButton(_a) {
    var date = _a.date, tooltipContent = _a.tooltipContent, _b = _a.variant, variant = _b === void 0 ? exports.DueDateButtonVariant.Neutral : _b, props = __rest(_a, ["date", "tooltipContent", "variant"]);
    var cultureDay = useCultureDay();
    var startIconName = variant === exports.DueDateButtonVariant.Danger ? iconNames.EmergencyHomeFilled : iconNames.CalendarToday;
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !tooltipContent }, { children: [jsxRuntime.jsx(Button, __assign({}, props, { "aria-label": date, className: classNames("due-date-button due-date-button--".concat(variant), props.className), size: exports.Size.sm, startIconName: startIconName, style: exports.ButtonStyle.Fill, variant: exports.ButtonVariant.Neutral }, { children: "".concat(cultureDay(date).format('l')) })), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: tooltipContent }))] })));
}
...
function MenuOptionInner(_a) {
    ...
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !tooltipContent, isOpen: isTooltipOpen, onOpenChange: setIsTooltipOpen }, { children: [jsxRuntime.jsx(MenuOptionContent, __assign({}, props, { ref: ref })), jsxRuntime.jsx(Tooltip, __assign({ offset: -2, position: exports.Position.Left, ref: tooltipRef, triggerRef: ref, type: exports.TooltipType.Plain }, { children: tooltipContent }))] })));
}
function MenuOption(_a) {
    ...
    var ref = react.useRef(null);
    return (jsxRuntime.jsx(reactAriaComponents.MenuItem, __assign({}, props, { className: classNames('menu-item', className), ref: utils.mergeRefs(outerRef, ref, function (node) {
            // RAC MenuItem does not support aria-disabled prop so need to do this the hard way...
            if (node && isReadOnly) {
                node.setAttribute('aria-disabled', 'true');
            }
        }) }, { children: function (itemRenderProps) { return (jsxRuntime.jsx(MenuOptionInner, __assign({}, itemRenderProps, { actionLabel: actionLabel, description: description, isDestructive: isDestructive, isReadOnly: isReadOnly, label: label, leftIconName: leftIconName, prefix: prefix, rightIconName: rightIconName, tooltip: tooltip, tooltipRef: function (tooltipNode) {
...
function MenuLinkButton(_a) {
    ...
    var state = react.useContext(reactAriaComponents.RootMenuTriggerStateContext);
    return (jsxRuntime.jsx(Button, __assign({ className: "menu-link-button", onPress: function () {
            safeCall(onPress);
            state === null || state === void 0 ? void 0 : state.close();
        }, role: role, style: exports.ButtonStyle.Link, variant: exports.ButtonVariant.Neutral }, { children: children })));
}

function Divider(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.center : _b, className = _a.className, _c = _a.orientation, orientation = _c === void 0 ? exports.Orientation.horizontal : _c, ref = _a.ref, size = _a.size, style = _a.style, text = _a.text;
    ...
    if (!text) {
        return (jsxRuntime.jsx(reactAriaComponents.Separator, { className: cssClassName, elementType: exports.HTMLElementType.Div, orientation: orientation, style: style }));
    }
    return (jsxRuntime.jsx("div", __assign({ "aria-orientation": orientation, className: cssClassName, ref: ref, role: exports.AriaRole.separator, style: style }, { children: jsxRuntime.jsx(Label, __assign({ className: "divider__label", size: exports.Size.sm }, { children: text })) })));
}

function MenuGroupHeader(_a) {
    var children = _a.children, className = _a.className;
    return (jsxRuntime.jsx(reactAriaComponents.Header, __assign({ className: classNames('menu-group-header', className) }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: children }) })) })));
}

exports.SubmenuBehavior = void 0;
(function (SubmenuBehavior) {
    SubmenuBehavior["Separate"] = "separate";
    SubmenuBehavior["InPlace"] = "in-place";
})(exports.SubmenuBehavior || (exports.SubmenuBehavior = {}));
...
function Menu(_a) {
    ...
    var _c = react.useState(new Set(selectedKeysFromProps)), selectedKeys = _c[0], setSelectedKeys = _c[1];
    var _d = react.useState(false), isOpen = _d[0], setIsOpen = _d[1];
    var skipCloseRef = react.useRef(false);
    var menuRef = react.useRef(null);
    var _e = react.useState(null), activeSubMenuItem = _e[0], setActiveSubMenuItem = _e[1];
    ...
    react.useImperativeHandle(ref, function () { return menuRef.current; }, []);
    var onAction = function (key) {
        ...
        if (item.isSubmenuTrigger) {
            skipCloseRef.current = item.selectionMode !== exports.SelectionMode.Multiple || activeSubMenuItem === null;
    ...
    var renderItem = function (item) {
        ...
        var id = item.id, itemProps = item.props, name = item.name, itemChildren = item.children, hasSeparator = item.hasSeparator, isSubmenuTrigger = item.isSubmenuTrigger, _g = item.submenuBehavior, submenuBehavior = _g === void 0 ? exports.SubmenuBehavior.Separate : _g, selectionMode = item.selectionMode;
        if (itemChildren) {
            if (isSubmenuTrigger) {
                if (submenuBehavior === exports.SubmenuBehavior.InPlace) {
                    return (jsxRuntime.jsxs(react.Fragment, { children: [react.createElement(MenuOption, __assign({}, itemProps, { id: id, key: id, label: (_a = itemProps === null || itemProps === void 0 ? void 0 : itemProps.label) !== null && _a !== void 0 ? _a : name, rightIconName: iconNames.ArrowRightFilled, textValue: (_b = itemProps === null || itemProps === void 0 ? void 0 : itemProps.textValue) !== null && _b !== void 0 ? _b : name })), hasSeparator && jsxRuntime.jsx(Divider, { size: exports.Size.sm })] }, id));
                }
                return (jsxRuntime.jsxs(react.Fragment, { children: [jsxRuntime.jsxs(reactAriaComponents.SubmenuTrigger, { children: [react.createElement(MenuOption, __assign({}, itemProps, { key: id, label: (_c = itemProps === null || itemProps === void 0 ? void 0 : itemProps.label) !== null && _c !== void 0 ? _c : name, textValue: (_d = itemProps === null || itemProps === void 0 ? void 0 : itemProps.textValue) !== null && _d !== void 0 ? _d : name })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "menu-popover" }, { children: jsxRuntime.jsx("div", __assign({ className: "menu-popover__content" }, { children: jsxRuntime.jsx(reactAriaComponents.Menu, __assign({ className: classNames('menu', className), onAction: onAction, onSelectionChange: onSelectionChange, selectedKeys: selectedKeys, selectionMode: selectionMode }, { children: itemChildren.map(renderItem) })) })) }))] }), hasSeparator && jsxRuntime.jsx(Divider, { size: exports.Size.sm })] }, id));
            }
            return (jsxRuntime.jsxs(react.Fragment, { children: [jsxRuntime.jsxs(reactAriaComponents.MenuSection, __assign({ className: "menu-section" }, { children: [jsxRuntime.jsx(MenuGroupHeader, { children: name }), itemChildren.map(renderItem)] })), hasSeparator && jsxRuntime.jsx(Divider, { size: exports.Size.sm })] }, id));
        }
        return (jsxRuntime.jsxs(react.Fragment, { children: [react.createElement(MenuOption, __assign({}, itemProps, { className: classNames(itemProps === null || itemProps === void 0 ? void 0 : itemProps.className, { 'menu-item--back': isSubmenuTrigger }), id: id, key: id, label: (_e = itemProps === null || itemProps === void 0 ? void 0 : itemProps.label) !== null && _e !== void 0 ? _e : name, leftIconName: isSubmenuTrigger ? iconNames.ArrowLeftFilled : itemProps === null || itemProps === void 0 ? void 0 : itemProps.leftIconName, textValue: (_f = itemProps === null || itemProps === void 0 ? void 0 : itemProps.textValue) !== null && _f !== void 0 ? _f : name })), hasSeparator && jsxRuntime.jsx(Divider, { size: exports.Size.sm })] }, id));
    };
    return (jsxRuntime.jsxs(reactAriaComponents.MenuTrigger, __assign({ isOpen: isOpen, onOpenChange: onOpenChange }, { children: [children, jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "menu-popover", placement: placement }, { children: jsxRuntime.jsxs("div", __assign({ className: "menu-popover__content" }, { children: [header && (jsxRuntime.jsx("div", __assign({ className: "menu-header" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: header }) })) }))), jsxRuntime.jsx(reactAriaComponents.Menu, __assign({}, props, { className: classNames('menu', className), onAction: onAction, onSelectionChange: onSelectionChange, ref: menuRef, selectedKeys: selectedKeys, selectionMode: (_b = activeSubMenuItem === null || activeSubMenuItem === void 0 ? void 0 : activeSubMenuItem.selectionMode) !== null && _b !== void 0 ? _b : props.selectionMode, style: { minWidth: minWidth ? "".concat(minWidth, "px") : undefined } }, { children: itemsToRender.map(renderItem) })), footerItems && footerItems.length > 0 && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Divider, { size: exports.Size.sm }), jsxRuntime.jsx("div", __assign({ className: "menu-footer", onBlur: function () {
                                        if (menuRef.current) {
                                    ...
                                    } }, { children: footerItems.map(function (footerItem) { return (jsxRuntime.jsx(MenuLinkButton, __assign({ onPress: footerItem.onPress, role: footerItem.role }, { children: footerItem.name }), footerItem.id)); }) }))] }))] })) }))] })));
}

var DialogTrigger = reactAriaComponents.DialogTrigger;
...
function Popover(_a) {
    ...
    return (jsxRuntime.jsx(reactAriaComponents.Popover, __assign({}, props, { className: classNames('popover', className), style: __assign(__assign({}, style), { maxWidth: maxWidth }) }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, className: "popover__dialog", style: isObject(padding) && !isString(padding) ?
                {
...
function SegmentedControlItem(_a) {
    ...
    var buttonElement = (jsxRuntime.jsxs(reactAriaComponents.Button, __assign({}, props, { className: "segmented-control-item" }, { children: [startIconName && jsxRuntime.jsx(Icon, { className: "segmented-control-item__icon", name: startIconName }), label && (jsxRuntime.jsx(Label, __assign({ className: "segmented-control-item__label", size: exports.Size.md }, { children: label })))] })));
    if (label) {
        return buttonElement;
    }
    return (jsxRuntime.jsxs(TooltipTrigger, { children: [buttonElement, jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: props['aria-label'] }))] }));
}
...
function SegmentedControl(_a) {
    ...
    var _b = react.useState(initialSelectedKey !== null && initialSelectedKey !== void 0 ? initialSelectedKey : (items.length > 0 ? items[0].id : null)), selectedKey = _b[0], setSelectedKey = _b[1];
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames('segmented-control', className), ref: ref, role: "group" }, { children: items.map(function (_a) {
            ...
            return (jsxRuntime.jsx(SegmentedControlItem, { "aria-label": ariaLabel, "aria-pressed": isSelected, "data-selected": isSelected || undefined, isDisabled: isDisabled, label: label, onPress: function () { return onChange(id); }, startIconName: startIconName }, id));
        }) })));
}

exports.CollapsibleItemStyle = void 0;
(function (CollapsibleItemStyle) {
    CollapsibleItemStyle["Card"] = "card";
    CollapsibleItemStyle["Plain"] = "plain";
})(exports.CollapsibleItemStyle || (exports.CollapsibleItemStyle = {}));
function CollapsibleItem(_a) {
    var _b = _a.arrowPlacement, arrowPlacement = _b === void 0 ? exports.Alignment.start : _b, groupState = _a.groupState, isDisabled = _a.isDisabled, item = _a.item, ref = _a.ref, _c = _a.style, style = _c === void 0 ? exports.CollapsibleItemStyle.Plain : _c, props = __rest(_a, ["arrowPlacement", "groupState", "isDisabled", "item", "ref", "style"]);
    ...
    var state = reactStately.useDisclosureState(__assign(__assign({}, props), { isExpanded: propsIsExpanded, onExpandedChange: function (newIsExpanded) {
            var _a;
            if (groupState) {
    ...
    var _d = reactAria.useDisclosure(__assign(__assign({}, props), { isExpanded: propsIsExpanded, isDisabled: isDisabled }), state, panelRef), buttonProps = _d.buttonProps, panelProps = _d.panelProps;
    var isExpanded = state.isExpanded;
    var _e = useAutoHeightAnimation({ isExpanded: isExpanded, ref: panelRef }), isLoaded = _e.isLoaded, panelProps2 = _e.props;
    var onKeyDown = function (e) {
        if (isExpanded && e.key === exports.KeyboardEventKey.Escape) {
            state.collapse();
        }
    };
    var tooltipElement = tooltipContent ?
        jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(TriggerElement, { children: jsxRuntime.jsx(Icon, { className: "collapsible-item__tooltip-icon", name: iconNames.InfoFilled, size: style === exports.CollapsibleItemStyle.Card ? exports.IconSize.SM : exports.IconSize.XS }) }), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: tooltipContent }))] })
        : null;
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("collapsible-item collapsible-item--".concat(style, " collapsible-item--arrow-").concat(arrowPlacement), {
            'collapsible-item--disabled': isDisabled,
            'collapsible-item--open': isExpanded
        }), ref: ref }, { children: [jsxRuntime.jsx(reactAria.FocusRing, __assign({ focusRingClass: "collapsible-item__header--focused" }, { children: jsxRuntime.jsxs(reactAriaComponents.Button, __assign({}, buttonProps, { className: "collapsible-item__header", onKeyDown: reactAria.chain(buttonProps.onKeyDown, onKeyDown) }, { children: [style === exports.CollapsibleItemStyle.Card ?
                            jsxRuntime.jsxs(Heading, __assign({ className: "collapsible-item__header-text", level: 1, size: exports.Size.xs }, { children: [title, tooltipElement] }))
                            : jsxRuntime.jsxs(Label, __assign({ className: "collapsible-item__header-text", size: exports.Size.lg }, { children: [jsxRuntime.jsx("strong", { children: title }), tooltipElement] })), jsxRuntime.jsx(Icon, { className: "collapsible-item__header-icon", name: isExpanded ? iconNames.ExpandMore : iconNames.ChevronRight, size: exports.IconSize.LG })] })) })), jsxRuntime.jsx("div", __assign({}, reactAria.mergeProps(panelProps, panelProps2), { className: "collapsible-item__content-wrapper", ref: panelRef }, { children: (isExpanded || isLoaded) && jsxRuntime.jsx("div", __assign({ className: "collapsible-item__content" }, { children: children })) })), style === exports.CollapsibleItemStyle.Plain && jsxRuntime.jsx(Divider, { className: "collapsible-item__divider", size: exports.Size.sm })] })));
}

function Collapsible(_a) {
    var _b = _a.allowsMultipleExpanded, allowsMultipleExpanded = _b === void 0 ? true : _b, _c = _a.arrowPlacement, arrowPlacement = _c === void 0 ? exports.Alignment.start : _c, className = _a.className, disabledKeys = _a.disabledKeys, items = _a.items, ref = _a.ref, _d = _a.style, style = _d === void 0 ? exports.CollapsibleItemStyle.Plain : _d, props = __rest(_a, ["allowsMultipleExpanded", "arrowPlacement", "className", "disabledKeys", "items", "ref", "style"]);
    var groupState = reactStately.useDisclosureGroupState(__assign({ allowsMultipleExpanded: allowsMultipleExpanded }, props));
    var disabledKeysSet = react.useMemo(function () { return (disabledKeys ? new Set(disabledKeys) : new Set()); }, [disabledKeys]);
    return (jsxRuntime.jsx("div", __assign({ className: classNames("collapsible collapsible--".concat(style, "-items"), className), ref: ref }, { children: items.map(function (item) {
            var _a;
            return (jsxRuntime.jsx(CollapsibleItem, { arrowPlacement: arrowPlacement, groupState: groupState, isDisabled: (_a = props.isDisabled) !== null && _a !== void 0 ? _a : disabledKeysSet.has(item.id), item: item, style: style }, item.id));
        }) })));
}
...
function CalendarCell(_a) {
    var date$1 = _a.date, isSelectedAsRelatedValue = _a.isSelectedAsRelatedValue, rangeInfo = _a.rangeInfo, renderContent = _a.renderContent, state = _a.state;
    var ref = react.useRef(null);
    var timeZone = useLocales().timeZone;
    var _b = reactAria.useCalendarCell({ date: date$1 }, state, ref), cellProps = _b.cellProps, buttonProps = _b.buttonProps, formattedDate = _b.formattedDate, isSelected = _b.isSelected, isFocused = _b.isFocused, isDisabled = _b.isDisabled, isOutsideVisibleRange = _b.isOutsideVisibleRange, isUnavailable = _b.isUnavailable;
    var isToday = date.isSameDay(date$1, date.today(timeZone));
    ...
    if (renderContent) {
        ...
        content = jsxRuntime.jsx(DayOfMonth, __assign({}, dayOfMonthProps));
    }
    return (jsxRuntime.jsx("td", __assign({}, cellProps, { className: "calendar-grid__cell", "data-in-range": !!isInRange || undefined, "data-range-end": !!isEndOfRange || undefined, "data-range-start": !!isStartOfRange || undefined }, { children: jsxRuntime.jsx("div", __assign({ className: "calendar-grid__cell-content" }, { children: content })) })));
}

function CalendarHeaderCell(_a) {
    var ariaLabel = _a["aria-label"], children = _a.children;
    return (jsxRuntime.jsx("th", __assign({ "aria-label": ariaLabel, className: "calendar-grid__header-cell" }, { children: children && (jsxRuntime.jsx("div", __assign({ className: "calendar-grid__header-cell-content" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: children }) })) }))) })));
}

function getDateValue(value) {
    if (value) {
        return isString(value) ? date.parseDate(value) : value;
    }
    return null;
}
...
function CalendarWeekNumberCell(_a) {
    ...
    return (jsxRuntime.jsx("td", __assign({ className: "calendar-grid__week-nr-cell" }, { children: jsxRuntime.jsx("div", __assign({ className: "calendar-grid__week-nr-cell-content" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: children }) })) })) })));
}
...
function CalendarGrid(_a) {
    ...
    var _b = reactAria.useCalendarGrid(props, state), gridProps = _b.gridProps, headerProps = _b.headerProps;
    ...
    var renderHeaderCells = function () {
        var cells = __spreadArray([], state.getDatesInWeek(0).map(function (date, i) {
            ...
            return jsxRuntime.jsx(CalendarHeaderCell, { children: weekDay }, i);
        }), true);
        if (showWeekNumbers) {
            cells.unshift(jsxRuntime.jsx(CalendarHeaderCell, { "aria-label": translateDatePeriod('weekShort') }, "week"));
        }
        return cells;
    };
    var renderBodyCells = function (weekDates) {
        var cells = [];
        weekDates.forEach(function (date$1, i) {
            if (date$1) {
                if (i === 0 && showWeekNumbers) {
                    var weekNumber = cultureDay(date$1.toString()).week();
                    cells.push(jsxRuntime.jsx(CalendarWeekNumberCell, { children: weekNumber }, "week"));
                }
                var selectedValue = state.value;
                var relatedSelectedValue = relatedValue ? getDateValue(relatedValue) : null;
                var hasRange = !!relatedSelectedValue && !!selectedValue && !date.isSameDay(selectedValue, relatedSelectedValue);
                var isInRange = hasRange &&
                    cultureDay(date$1.toString()).isBetween(relatedSelectedValue.toString(), selectedValue.toString(), 'day', '[]');
                var isSelectedAsRelatedValue = !!relatedSelectedValue && date.isSameDay(relatedSelectedValue, date$1);
                ...
                if (hasRange && isInRange) {
                    ...
                    isStartOfRange = date.isSameDay(startDateOfRange, date$1);
                    isEndOfRange = !isStartOfRange && date.isSameDay(endDateOfRange, date$1);
                }
                cells.push(jsxRuntime.jsx(CalendarCell, { date: date$1, isSelectedAsRelatedValue: isSelectedAsRelatedValue, rangeInfo: { isInRange: isInRange, isStartOfRange: isStartOfRange, isEndOfRange: isEndOfRange }, renderContent: renderCellContent, state: state }, i));
            }
            else {
                cells.push(jsxRuntime.jsx("td", { className: "calendar-grid__cell" }, i));
            }
        });
        return cells;
    };
    return (jsxRuntime.jsxs("table", __assign({}, gridProps, { className: "calendar-grid" }, { children: [jsxRuntime.jsx("thead", __assign({}, headerProps, { className: "calendar-grid__header" }, { children: jsxRuntime.jsx("tr", __assign({ className: "calendar-grid__header-row" }, { children: renderHeaderCells() })) })), jsxRuntime.jsx("tbody", __assign({ className: "calendar-grid__body" }, { children: __spreadArray([], new Array(VISIBLE_WEEKS_IN_MONTH).keys(), true).map(function (weekIndex) {
                    var _a, _b;
...
exports.SpecialSelectItemKey = void 0;
(function (SpecialSelectItemKey) {
    SpecialSelectItemKey["CREATABLE"] = "creatable";
})(exports.SpecialSelectItemKey || (exports.SpecialSelectItemKey = {}));
...
function useFieldHelpText(props) {
    ...
    var helpId = utils.useSlotId([!!helpContent]);
    return {
        fieldProps: {
...
function useNonModalPopoverInModalFix(isOpen, triggerRef, popoverRef) {
    react.useEffect(function () {
        if (isOpen && triggerRef.current && popoverRef.current) {
            return overlays.ariaHideOutside([triggerRef.current, popoverRef.current]);
        }
...
function useSelectItemHighlight() {
    var _a = react.useState(-1), highlightedIndex = _a[0], setHighlightedIndex = _a[1];
    var _b = react.useState(InteractionSource.Mouse), highlightSource = _b[0], setHighlightSource = _b[1];
...
function useControlledState(defaultValue, value, onChange) {
    var _a = react.useState(value !== null && value !== void 0 ? value : defaultValue), stateValue = _a[0], setStateValue = _a[1];
...
function useSelectCommon(_a) {
    ...
    var triggerContentRef = react.useRef(null);
    var popoverRef = react.useRef(null);
    var listBoxRef = react.useRef(null);
    var _b = reactAria.useFocusRing({ within: true, isTextInput: false }), baseFocusProps = _b.focusProps, isFocused = _b.isFocused, isFocusVisible = _b.isFocusVisible;
    var focusProps = reactAria.mergeProps(baseFocusProps, {
    ...
    var _c = reactAria.useHover(props), hoverProps = _c.hoverProps, isHovered = _c.isHovered;
    ...
    var _h = react.useState(0), dynamicMenuWidth = _h[0], setDynamicMenuWidth = _h[1];
    var _j = react.useState(value && text ? { value: value, text: text } : null), selectedItem = _j[0], setSelectedItem = _j[1];
    var _k = react.useState(text !== null && text !== void 0 ? text : ''), inputValue = _k[0], setInputValue = _k[1];
    var _l = react.useState(null), filteredItems = _l[0], setFilteredItems = _l[1];
    var localFilter = reactAria.useFilter({ sensitivity: 'base' });
    var itemsToRender = react.useMemo(function () {
        ...
        if (allowCreate && inputValue && isOpen && !hasItemWithText(items, inputValue)) {
            baseItems.push({ value: exports.SpecialSelectItemKey.CREATABLE, text: inputValue });
        }
        return baseItems;
    ...
    var flatItems = react.useMemo(function () { return createFlatSelectItemList(itemsToRender, false, expandedKeys); }, [itemsToRender, expandedKeys]);
    var onResize = react.useCallback(function () {
        updateMenuWidth();
    }, [triggerContentRef]);
    utils.useResizeObserver({ ref: triggerContentRef, onResize: onResize });
...
function getHelpContentAndVariant(_a) {
    ...
    var helpContent = helpText, helpVariant = exports.HelpTextVariant.Neutral;
    if (hasError) {
        helpVariant = exports.HelpTextVariant.Danger;
        helpContent = errorMessage ? errorMessage : helpContent;
    }
    else if (helpTextSuccess) {
        helpVariant = exports.HelpTextVariant.Success;
        helpContent = helpTextSuccess;
    }
    else if (isDisabled) {
        helpVariant = exports.HelpTextVariant.Disabled;
    }
    return {
...
function Field(_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label && (jsxRuntime.jsx(FieldLabel, __assign({ isDisabled: isDisabled, isRequired: isRequired, size: size, suffix: labelSuffix, tooltipContent: tooltipContent }, { children: label }))), children, helpContent && (jsxRuntime.jsx(HelpText, __assign({ showIcon: showHelpTextIcon, variant: helpVariant }, { children: helpContent })))] }));
}
...
function SelectOptionsEmptyState(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('select-options-empty-state', className), ref: ref, role: "presentation" }, { children: [jsxRuntime.jsx(Icon, { className: "select-options-empty-state__icon", name: iconName }), jsxRuntime.jsx(Label, __assign({ size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: text !== null && text !== void 0 ? text : translateCommon('noResultsFound') }))] })));
}

function LoadingItem(_a) {
    var size = _a.size;
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsx("div", __assign({ className: "loading-item", role: "presentation" }, { children: jsxRuntime.jsx(Spinner, { label: "".concat(translateCommon('loading'), "..."), labelPosition: exports.Position.Right, labelSize: size === exports.Size.xs ? exports.Size.md : exports.Size.lg, size: exports.Size.sm, variant: exports.SpinnerVariant.Neutral }) })));
}

function BottomLoader(_a) {
    var onVisible = _a.onVisible;
    return jsxRuntime.jsx("div", { className: "bottom-loader", ref: useIntersectionObserver(onVisible) });
}
...
function SelectOptionContent(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('select-option-content', className, {
            'select-option-content--expandable': !!children
        }), ref: ref, style: level > 0 ? { paddingLeft: "".concat(INDENT_SIZE_PX * level, "px") } : undefined }, { children: [(action === null || action === void 0 ? void 0 : action.iconName) && (jsxRuntime.jsx(Icon, { className: "select-option-content__action-icon", name: action.iconName, size: exports.IconSize.MD })), isLoading && (jsxRuntime.jsx(Spinner, { className: "select-option-content__spinner", size: exports.Size.sm, variant: exports.SpinnerVariant.Neutral })), !action && onToggleItem && !isLoading && (
            ...
            jsxRuntime.jsx("div", __assign({ "aria-expanded": isExpanded, "aria-label": translateCommon(isExpanded ? 'collapse' : 'expand'), className: "select-option-content__expander", onClick: function (e) {
                    e.stopPropagation();
                    onToggleItem(item);
                }, role: "button" }, { children: jsxRuntime.jsx(Icon, { name: isExpanded ? iconNames.ExpandMoreFilled : iconNames.ChevronRightFilled, size: exports.IconSize.MD }) }))), jsxRuntime.jsxs("div", __assign({ className: "select-option-content__body" }, { children: [bodyPrefix && jsxRuntime.jsx("div", __assign({ className: "select-option-content__body-prefix" }, { children: bodyPrefix })), jsxRuntime.jsxs("div", __assign({ className: "select-option-content__body-content" }, { children: [label !== null && label !== void 0 ? label : (jsxRuntime.jsxs("div", __assign({ className: "select-option-content__label-wrapper" }, { children: [jsxRuntime.jsx(Label, __assign({ className: "select-option-content__label", ref: labelRef, size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: text })), labelSuffix && jsxRuntime.jsx("div", __assign({ className: "select-option-content__label-suffix" }, { children: labelSuffix }))] }))), description && (jsxRuntime.jsx(Label, __assign({ className: "select-option-content__description", ref: descriptionRef, size: exports.Size.md }, { children: description })))] })), bodySuffix && jsxRuntime.jsx("div", __assign({ className: "select-option-content__body-suffix" }, { children: bodySuffix }))] })), jsxRuntime.jsx(Icon, { "aria-hidden": true, className: "select-option-content__check", name: iconNames.InputCheck, size: exports.IconSize.MD }), suffix && jsxRuntime.jsx("div", __assign({ className: "select-option-content__suffix" }, { children: suffix }))] })));
}

function useIsTextTruncated(_a) {
    var onTruncatedChange = _a.onTruncatedChange, _b = _a.overflowDirection, overflowDirection = _b === void 0 ? exports.Orientation.horizontal : _b, ref = _a.ref;
    var _c = react.useState(false), isTruncated = _c[0], setIsTruncated = _c[1];
    var onResize = react.useCallback(function () {
        var element = ref.current;
        if (element) {
            var newIsTruncated = overflowDirection === exports.Orientation.vertical ?
    ...
    utils.useResizeObserver({ ref: ref, onResize: onResize });
    return isTruncated;
}

function SelectOptionInner(_a) {
    var children = _a.children, className = _a.className, isDisabled = _a.isDisabled, isFocused = _a.isFocused, isKeyboardFocused = _a.isKeyboardFocused, isReadOnly = _a.isReadOnly, isSelected = _a.isSelected, outerRef = _a.ref, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b, props = __rest(_a, ["children", "className", "isDisabled", "isFocused", "isKeyboardFocused", "isReadOnly", "isSelected", "ref", "size"]);
    var ref = react.useRef(null);
    var focusableProps = reactAria.useFocusable(props, ref).focusableProps;
    react.useImperativeHandle(outerRef, function () { return ref.current; }, []);
    return (jsxRuntime.jsx("div", __assign({}, focusableProps, props, { "aria-disabled": isReadOnly ? true : props['aria-disabled'], className: classNames("select-option select-option--".concat(size), className), "data-disabled": !!isDisabled || undefined, "data-focused": !!isFocused || undefined, "data-keyboard-focused": !!isKeyboardFocused || undefined, "data-readonly": !!isReadOnly || undefined, "data-selected": !!isSelected || undefined, ref: ref, tabIndex: undefined }, { children: children })));
}
function SelectOption(_a) {
    ...
    var isLabelTruncated = useIsTextTruncated({ overflowDirection: exports.Orientation.vertical, ref: labelRef });
    var isDescriptionTruncated = useIsTextTruncated({ overflowDirection: exports.Orientation.vertical, ref: descriptionRef });
    var _d = react.useState(false), isTooltipOpen = _d[0], setIsTooltipOpen = _d[1];
    var tooltipContent = [];
    ...
    if (item.tooltip) {
        tooltipContent.push(jsxRuntime.jsx("div", { children: item.tooltip.content }, "item-tt"));
    }
    if (isLabelTruncated) {
        if (tooltipContent.length > 0) {
            tooltipContent.push(jsxRuntime.jsx("br", {}, "br1"));
        }
        tooltipContent.push(jsxRuntime.jsx("div", { children: (_b = labelRef.current) === null || _b === void 0 ? void 0 : _b.textContent }, "text"));
    }
    if (isDescriptionTruncated) {
        if (tooltipContent.length > 0) {
            tooltipContent.push(jsxRuntime.jsx("br", {}, "br2"));
        }
        tooltipContent.push(jsxRuntime.jsx("div", { children: (_c = descriptionRef.current) === null || _c === void 0 ? void 0 : _c.textContent }, "desc"));
    }
    var content;
    if (renderItemContent) {
        ...
        content = jsxRuntime.jsx(SelectOptionContent, __assign({}, optionContentProps));
    }
    ...
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !hasTooltipContent, isOpen: isTooltipOpen, onOpenChange: setIsTooltipOpen }, { children: [jsxRuntime.jsx(SelectOptionInner, __assign({}, getItemProps({ item: item, index: itemIndex, ref: ref }), { className: classNames(isFunction(itemClassName) ? itemClassName(item) : itemClassName, {
                    'select-option--action': !!item.action
                }), "data-value": useDataValue ? itemValue : undefined, isDisabled: isItemDisabled, isFocused: isFocused, isKeyboardFocused: isItemKeyboardFocused, isReadOnly: isItemReadOnly, isSelected: isSelected, size: size }, { children: content })), jsxRuntime.jsx(Tooltip, __assign({ position: exports.Position.Right, triggerRef: ref, type: exports.TooltipType.Plain }, { children: tooltipContent }))] })));
}
var MemoizedSelectOption = react.memo(SelectOption);
...
function renderSelectItems(_a) {
    ...
    var renderItem = function (item, level) {
        ...
        return (jsxRuntime.jsx(MemoizedSelectOption, { disabledKeys: disabledKeys, getItemProps: getItemProps, highlightSource: highlightSource, isFocused: highlightedIndex === itemIndex, isSelected: isSelected, item: item, itemClassName: itemClassName, itemIndex: itemIndex, level: level, renderItemContent: renderItemContent, size: size }, itemValue));
    };
    var renderItems = function (itemArr, level) {
        ...
        var _loop_1 = function (i, len) {
            ...
            if (subItems) {
                ...
                itemNodes.push(jsxRuntime.jsxs("section", { children: [jsxRuntime.jsx("header", __assign({ className: "select-header" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: itemText })) })), renderItems(subItems, level)] }, itemValue));
            }
            else if (children) {
            ...
            else if (itemValue === exports.SpecialSelectItemKey.CREATABLE) {
                itemNodes.push(jsxRuntime.jsx(MemoizedSelectOption, { getItemProps: getItemProps, isFocused: highlightedIndex === itemIndex, item: item, itemIndex: itemIndex, level: level, renderItemContent: function (optionContentProps) { return (jsxRuntime.jsx(SelectOptionContent, __assign({}, optionContentProps, { bodyPrefix: jsxRuntime.jsx(Icon, { className: "select-option__start-icon", name: iconNames.AddCircleFilled }), label: jsxRuntime.jsx(Label, __assign({ size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: isFunction(createText) ? createText(itemText) : createText })) }))); }, size: size }, itemValue));
                itemIndex++;
            }
            else {
                itemNodes.push(renderItem(item, level));
            ...
            if (hasSeparator) {
                itemNodes.push(jsxRuntime.jsx(Divider, { size: exports.Size.sm }, "".concat(itemValue, "--separator")));
            }
        };
...
var defaultInputRectHeightForSize = (_a$7 = {},
    _a$7[exports.Size.xs] = 28,
    _a$7[exports.Size.sm] = 32,
    _a$7[exports.Size.md] = 40,
    _a$7[exports.Size.lg] = 40,
    _a$7);
function SkeletonField(_a) {
    ...
    var labelSize = exports.Size.md;
    if (size === exports.Size.xs) {
        labelSize = exports.Size.sm;
    }
    else if (size === exports.Size.lg) {
        labelSize = exports.Size.lg;
    }
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-field', className), ref: ref, style: style }, { children: [hasLabel && (jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: labelSize, type: exports.SkeletonTextType.Label, width: "50%" })), jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: inputRectHeight !== null && inputRectHeight !== void 0 ? inputRectHeight : defaultInputRectHeightForSize[size], shape: exports.SkeletonShape.Rectangle }), hasHelpText && (jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.sm, type: exports.SkeletonTextType.Label, width: "25%" }))] }), "".concat(hasLabel, "-").concat(hasHelpText)));
}

function SelectField(_a) {
    var fieldContent = _a.children, className = _a.className, dataState = _a.dataState, disabledKeys = _a.disabledKeys, expandedKeys = _a.expandedKeys, getItemProps = _a.getItemProps, getLabelProps = _a.getLabelProps, getMenuProps = _a.getMenuProps, hasError = _a.hasError, helpText = _a.helpText, helpTextProps = _a.helpTextProps, highlightedIndex = _a.highlightedIndex, highlightSource = _a.highlightSource, isDisabled = _a.isDisabled, isOpen = _a.isOpen, isLoading = _a.isLoading, isReadOnly = _a.isReadOnly, isRequired = _a.isRequired, isSkeleton = _a.isSkeleton, itemClassName = _a.itemClassName, itemsToRender = _a.itemsToRender, label = _a.label, listBoxRef = _a.listBoxRef, menuWidth = _a.menuWidth, onBottomLoaderVisible = _a.onBottomLoaderVisible, popoverRef = _a.popoverRef, ref = _a.ref, renderItemContent = _a.renderItemContent, propsRenderItemsEmptyState = _a.renderItemsEmptyState, tooltipContent = _a.tooltipContent, triggerContentRef = _a.triggerContentRef, selectedItem = _a.selectedItem, showHelpTextIcon = _a.showHelpTextIcon, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b;
    var translateCommon = useTranslateCommon();
    var renderCreateText = function (itemText) { return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: ["".concat(translateCommon('create'), " "), "\"", jsxRuntime.jsx("strong", { children: itemText }), "\""] })); };
    ...
    var renderItemsEmptyState = function () {
        ...
        return jsxRuntime.jsx(SelectOptionsEmptyState, __assign({}, emptyStateProps), "empty");
    };
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-select", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Provider, __assign({ values: [
            [reactAriaComponents.LabelContext, __assign({}, getLabelProps())],
            [reactAriaComponents.TextContext, { slots: { description: helpTextProps } }]
        ] }, { children: jsxRuntime.jsxs("div", __assign({ className: classNames('select', className), ref: ref }, { children: [jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: size === exports.Size.xs ? exports.Size.sm : exports.Size.md, tooltipContent: tooltipContent }, { children: fieldContent })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "select__popover", isNonModal: true, isOpen: isOpen, maxHeight: 280, placement: "bottom left", ref: popoverRef, shouldFlip: true, style: menuWidth ? { width: menuWidth } : undefined, triggerRef: triggerContentRef }, { children: jsxRuntime.jsxs("div", __assign({}, menuProps, { className: "select__listbox" }, { children: [(itemsToRender.length === 0 || itemsToRender[0].value === exports.SpecialSelectItemKey.CREATABLE) &&
                                !isLoading &&
                                ...
                                renderSelectItems({
                                    ...
                                    selectedItem: selectedItem,
                                    size: size
                                }), isLoading && jsxRuntime.jsx(LoadingItem, { size: size }, "loading"), onBottomLoaderVisible && jsxRuntime.jsx(BottomLoader, { onVisible: onBottomLoaderVisible }, "loader")] })) }))] })) })));
}
...
function useSelectOptionCountAnnouncement(_a) {
    ...
    react.useEffect(function () {
        if (isOpen) {
            liveAnnouncer.announce(translateCommon('optionsAvailable', { count: itemCount }));
        }
    }, [isOpen, itemCount]);
}
...
function ComboBox(props) {
    ...
    var _d = downshift.useCombobox({
        ...
        onIsOpenChange: function (_a) {
            ...
            if (isReadOnly || newIsOpen === isOpen || (type === downshift.useCombobox.stateChangeTypes.InputClick && isOpen)) {
                return;
            }
            if (newIsOpen) {
                // Clear external filtering on open.
                safeCall(props.onInputChange, '', exports.InputChangeTriggerAction.Focus);
                updateMenuWidth();
            }
            else {
        ...
        onStateChange: function (changes) {
            ...
            if ((type === downshift.useCombobox.stateChangeTypes.InputKeyDownArrowUp ||
                type === downshift.useCombobox.stateChangeTypes.InputKeyDownArrowDown) &&
    ...
    var onInputChange = function (e) {
        ...
        safeCall(props.onInputChange, newInputValue, exports.InputChangeTriggerAction.Input);
    ...
    return (jsxRuntime.jsx(SelectField, __assign({}, props, { getItemProps: getItemProps, getLabelProps: getLabelProps, getMenuProps: getMenuProps, hasError: hasError, helpTextProps: helpTextProps, highlightSource: highlightSource, highlightedIndex: highlightedIndex, isOpen: isOpen, itemsToRender: itemsToRender, listBoxRef: listBoxRef, menuWidth: menuWidth, popoverRef: popoverRef, selectedItem: selectedItem, triggerContentRef: triggerContentRef }, { children: jsxRuntime.jsxs("div", __assign({}, hoverProps, focusProps, { className: classNames("select__content select__content--".concat(size), {
                'select__content--plain': isPlain
            }), "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-hovered": isHovered || undefined, "data-invalid": !!hasError || undefined, "data-readonly": !!isReadOnly || undefined, ref: triggerContentRef }, { children: [isOpen && showSearchIcon && jsxRuntime.jsx(Icon, { className: "select__search-icon", name: iconNames.MagnifyingGlass }), !isOpen && startIconName && jsxRuntime.jsx(Icon, { className: "select__start-icon", name: startIconName }), !isOpen && isFunction(renderStartContent) && renderStartContent(selectedItem), jsxRuntime.jsx("input", __assign({}, inputProps, fieldProps, { "aria-label": props['aria-label'], className: classNames('select__input', size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS), onKeyDown: reactAria.chain(onKeyDown, inputProps.onKeyDown), placeholder: isOpen ? translateCommon('search') : props.placeholder, readOnly: isReadOnly, size: 1 })), jsxRuntime.jsxs("div", __assign({ className: "select__action-buttons" }, { children: [showClearButton && (jsxRuntime.jsx(ClearButton, { className: "select__clear-button", onPress: function () {
                                var _a;
                                selectItem(null);
                                (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.focus();
                            } })), jsxRuntime.jsx("button", __assign({}, toggleButtonProps, { "aria-label": translateCommon('toggleMenu'), className: "select__expander" }, { children: jsxRuntime.jsx(Icon, { className: "select__expand-icon", name: isOpen ? iconNames.ExpandLessFilled : iconNames.ExpandMoreFilled }) }))] }))] })) })));
}

function SelectBox(props) {
    var disabledKeys = props.disabledKeys, isClearable = props.isClearable, isDisabled = props.isDisabled, isPlain = props.isPlain, renderStartContent = props.renderStartContent, startIconName = props.startIconName, _a = props.size, size = _a === void 0 ? exports.Size.md : _a;
    ...
    var _c = react.useState(false), isClearFocused = _c[0], setIsClearFocused = _c[1];
    var _d = downshift.useSelect({
        highlightedIndex: highlightedIndex,
        isOpen: isOpen,
        items: flatItems,
        itemToString: function (item) { return (item ? item.text : ''); },
        ...
        onStateChange: function (changes) {
            if (changes.type === downshift.useSelect.stateChangeTypes.ToggleButtonKeyDownArrowDown &&
                changes.highlightedIndex === flatItems.length - 1) {
                // scroll at the bottom when last item is highlighted to make sure loader is visible
                scrollBottom(listBoxRef.current);
            }
    ...
    return (jsxRuntime.jsx(SelectField, __assign({}, props, { getItemProps: getItemProps, getLabelProps: getLabelProps, getMenuProps: getMenuProps, hasError: hasError, helpTextProps: helpTextProps, highlightSource: highlightSource, highlightedIndex: highlightedIndex, isOpen: isOpen, itemsToRender: itemsToRender, listBoxRef: listBoxRef, menuWidth: menuWidth, popoverRef: popoverRef, selectedItem: selectedItem, triggerContentRef: triggerContentRef }, { children: jsxRuntime.jsxs("div", __assign({}, hoverProps, focusProps, toggleButtonProps, fieldProps, { "aria-label": props['aria-label'], className: classNames("select__content select__content--".concat(size, " select__button"), {
                'select__content--plain': isPlain
            }), "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": (isFocused && !isDisabled) || undefined, "data-hovered": isHovered || undefined, "data-invalid": !!hasError || undefined, "data-readonly": !!isReadOnly || undefined, onBlur: reactAria.chain(focusProps.onBlur, toggleButtonProps.onBlur), onKeyDown: reactAria.chain(onKeyDown, toggleButtonProps.onKeyDown) }, { children: [startIconName && jsxRuntime.jsx(Icon, { className: "select__start-icon", name: startIconName }), isFunction(renderStartContent) && renderStartContent(selectedItem), jsxRuntime.jsx("span", __assign({ className: classNames('select__value', size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS), "data-placeholder": !selectedItem || undefined }, { children: selectedItem ? selectedItem.text : props.placeholder })), jsxRuntime.jsxs("div", __assign({ className: "select__action-buttons" }, { children: [showClearButton && (jsxRuntime.jsx(ClearButton, { className: "select__clear-button", onFocusChange: setIsClearFocused, onPress: function () {
                                var _a;
                                selectItem(null);
                                (_a = triggerContentRef.current) === null || _a === void 0 ? void 0 : _a.focus();
                            } })), jsxRuntime.jsx("div", __assign({ className: "select__expander" }, { children: jsxRuntime.jsx(Icon, { className: "select__expand-icon", name: isOpen ? iconNames.ExpandLessFilled : iconNames.ExpandMoreFilled }) }))] }))] })) })));
}

function Select(_a) {
    var _b = _a.isSearchable, isSearchable = _b === void 0 ? true : _b, props = __rest(_a, ["isSearchable"]);
    // eslint-disable-next-line sonarjs/no-selector-parameter
    return isSearchable ? jsxRuntime.jsx(ComboBox, __assign({}, props)) : jsxRuntime.jsx(SelectBox, __assign({}, props));
}

function InlineSelect(_a) {
    var _b = _a.size, size = _b === void 0 ? exports.Size.xs : _b, props = __rest(_a, ["size"]);
    ...
    var ref = react.useRef(null);
    var translateCommon = useTranslateCommon();
    react.useImperativeHandle(props.ref, function () { return ref.current; }, []);
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isOpen: hasError && isFocused }, { children: [jsxRuntime.jsx(Select, __assign({}, props, { className: classNames(props.className, 'inline-select'), isPlain: true, onFocusChange: reactAria.chain(setIsFocused, props.onFocusChange), ref: ref, showSearchIcon: false, size: size })), jsxRuntime.jsx(Tooltip, __assign({ className: "inline-select__error-tooltip", headerIconName: iconNames.EmergencyHomeFilled, headerText: translateCommon('error'), offset: 2, position: exports.Position.Left, triggerRef: ref, type: exports.TooltipType.Rich }, { children: errorMessage }))] })));
}

function SkeletonCalendar(_a) {
    var ariaHidden = _a["aria-hidden"], className = _a.className, ref = _a.ref;
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-calendar', className), ref: ref }, { children: [jsxRuntime.jsx("div", __assign({ className: "skeleton-calendar__header" }, { children: jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label, width: "50%" }) })), jsxRuntime.jsxs("div", __assign({ className: "skeleton-calendar__body" }, { children: [jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.sm, type: exports.SkeletonTextType.Label }), Array.from({ length: 5 }, function (_x, i) { return (jsxRuntime.jsx("div", __assign({ className: "skeleton-calendar__grid-row" }, { children: Array.from({ length: 7 }, function (_y, j) { return (jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 32, shape: exports.SkeletonShape.Rectangle, width: 32 }, j)); }) }), i)); })] }))] })));
}
...
function Calendar(_a) {
    ...
    var translateDatePeriod = useTranslateDatePeriod();
    var translateCommon = useTranslateCommon();
    var _f = reactAriaComponents.useContextProps(__assign(__assign({}, props), { maxValue: (_b = getDateValue(propsMaxValue)) !== null && _b !== void 0 ? _b : undefined, minValue: (_c = getDateValue(propsMinValue)) !== null && _c !== void 0 ? _c : undefined }), ref !== null && ref !== void 0 ? ref : null, reactAriaComponents.CalendarContext), contextProps = _f[0], refObj = _f[1];
    ...
    var _g = react.useState(getDateValue(value)), selectedDate = _g[0], setSelectedDate = _g[1];
    var _h = react.useState(selectedDate !== null && selectedDate !== void 0 ? selectedDate : date.today(timeZone)), focusedDate = _h[0], setFocusedDate = _h[1];
    ...
    var state = reactStately.useCalendarState(__assign(__assign({}, derivedProps), { locale: cultureLocale, createCalendar: date.createCalendar }));
    var _j = reactAria.useCalendar(derivedProps, state), calendarProps = _j.calendarProps, prevButtonProps = _j.prevButtonProps, nextButtonProps = _j.nextButtonProps;
    var monthItems = react.useMemo(function () {
        return languageDay()
            .localeData()
            .months()
            .map(function (month, i) { return ({ value: i + 1, text: month }); });
    }, [languageLocale]);
    var yearItems = react.useMemo(function () {
        ...
        if (yearSelectionRange) {
            ...
            var currentYear = date.today(timeZone).year;
    ...
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonCalendar, {});
    }
    return (jsxRuntime.jsxs("div", __assign({}, calendarProps, { className: classNames('calendar', className), ref: refObj }, { children: [jsxRuntime.jsxs("div", __assign({ className: "calendar-header" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "calendar-header__start" }, { children: [jsxRuntime.jsx(IconButton, __assign({}, prevButtonProps, { "aria-label": translateDatePeriod('previousMonth'), iconName: iconNames.ChevronLeft, size: exports.Size.md, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })), jsxRuntime.jsx(IconButton, __assign({}, nextButtonProps, { "aria-label": translateDatePeriod('nextMonth'), iconName: iconNames.ChevronRight, size: exports.Size.md, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })), jsxRuntime.jsx(Select, { "aria-label": translateDatePeriod('month'), isDisabled: isDisabled, isPlain: true, isReadOnly: isReadOnly, isSearchable: false, items: monthItems, menuWidth: "150px", onSelectionChange: function (month) {
                                    onFocusChange(new date.CalendarDate(focusedDate.year, month, focusedDate.day));
                                }, size: exports.Size.xs, text: monthItems[focusedDate.month - 1].text, value: focusedDate.month }), jsxRuntime.jsx(Select, { "aria-label": translateDatePeriod('year'), isDisabled: isDisabled, isPlain: true, isReadOnly: isReadOnly, isSearchable: false, items: yearItems, menuWidth: "100px", onSelectionChange: function (year) {
                                    onFocusChange(new date.CalendarDate(year, focusedDate.month, focusedDate.day));
                                }, size: exports.Size.xs, text: focusedDate.year.toString(), value: focusedDate.year })] })), jsxRuntime.jsx("div", __assign({ className: "calendar-header__end" }, { children: jsxRuntime.jsx(Button, __assign({ isDisabled: !!isDisabled || !!isReadOnly, onPress: function () {
                                onFocusChange(date.today(timeZone));
                            }, size: exports.Size.md, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('today') })) }))] })), jsxRuntime.jsx(Divider, { size: exports.Size.sm }), jsxRuntime.jsx(CalendarGrid, { highlightSelectedWeek: highlightSelectedWeek, relatedValue: relatedValue, renderCellContent: renderCellContent, showWeekNumbers: showWeekNumbers, state: state }), footer && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Divider, { size: exports.Size.sm }), jsxRuntime.jsx("div", __assign({ className: "calendar-footer" }, { children: footer }))] }))] })));
}

function InputIndeterminate(_a) {
    var size = _a.size;
    return (jsxRuntime.jsx("svg", __assign({ "aria-hidden": true, fill: "currentColor", height: size, viewBox: "0 0 24 24", width: size }, { children: jsxRuntime.jsx("path", { d: "M6.845 13.325c-.369 0-.681-.129-.94-.386A1.278 1.278 0 0 1 5.52 12c0-.368.128-.68.386-.938.258-.258.57-.387.939-.387h10.31c.368 0 .681.129.939.386.258.258.386.571.386.94 0 .367-.128.68-.386.938a1.28 1.28 0 0 1-.939.386H6.845Z" }) })));
}
...
function SkeletonCheckbox(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-checkbox', className), ref: ref, style: style }, { children: [jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: size === exports.Size.md ? exports.Size.lg : exports.Size.md, type: exports.SkeletonTextType.Label }), hasHelpText && (jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.sm, type: exports.SkeletonTextType.Label, width: "25%" }))] }), "".concat(hasHelpText)));
}

function Checkbox(_a) {
    var className = _a.className, changeCallback = _a.changeCallback, changeParams = _a.changeParams, dataState = _a.dataState, dataTestId = _a.dataTestId, helpText = _a.helpText, isDisabled = _a.isDisabled, isIndeterminate = _a.isIndeterminate, isInvalid = _a.isInvalid, isRequired = _a.isRequired, isSelected = _a.isSelected, isSkeleton = _a.isSkeleton, label = _a.label, _b = _a.labelPlacement, labelPlacement = _b === void 0 ? exports.LabelPlacement.End : _b, onChange = _a.onChange, _c = _a.size, size = _c === void 0 ? exports.Size.sm : _c, props = __rest(_a, ["className", "changeCallback", "changeParams", "dataState", "dataTestId", "helpText", "isDisabled", "isIndeterminate", "isInvalid", "isRequired", "isSelected", "isSkeleton", "label", "labelPlacement", "onChange", "size"]);
    var checkboxGroupState = react.useContext(reactAriaComponents.CheckboxGroupStateContext);
    ...
    var helpTextId = react.useId();
    var labelSize = exports.Size.md, iconSize = exports.IconSize.SM;
    if (size === exports.Size.md) {
        labelSize = exports.Size.lg;
        iconSize = exports.IconSize.LG;
    }
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonCheckbox, { hasHelpText: !!helpText || !!errorMessage, size: size });
    }
    var content = [];
    if (isRequired) {
        content.push(jsxRuntime.jsx(RequiredIndicator, {}, "required"));
    }
    var box = (jsxRuntime.jsx("div", __assign({ className: classNames("checkbox__box checkbox__box--".concat(size)) }, { children: isIndeterminate ?
            jsxRuntime.jsx(InputIndeterminate, { size: iconSize })
            : jsxRuntime.jsx(Icon, { "aria-hidden": true, name: iconNames.InputCheck, size: iconSize }) }), "box"));
    if (label) {
        var boxAndLabels = [];
        var labelNode = (jsxRuntime.jsx(Label, __assign({ className: "checkbox__label", size: labelSize }, { children: label }), "label"));
        var wrapperClass = 'checkbox__box-and-label';
        if (labelPlacement === exports.LabelPlacement.Start) {
        ...
        if (helpText || errorMessage) {
            ...
            if (labelPlacement === exports.LabelPlacement.End) {
                // needed to align the label and helpText in grid
                boxAndLabels.push(jsxRuntime.jsx("div", {}, "boxPlaceholder"));
            }
            boxAndLabels.push(jsxRuntime.jsx(HelpText, __assign({ id: helpTextId, variant: helpVariant }, { children: helpContent }), "helpText"));
        }
        content.push(jsxRuntime.jsx("div", __assign({ className: wrapperClass }, { children: boxAndLabels }), "boxAndLabel"));
    }
    else {
        content.push(box);
    }
    return (jsxRuntime.jsx(reactAriaComponents.Checkbox, __assign({}, props, { "aria-describedby": mergeStrings(' ', helpTextId, props['aria-describedby']), className: classNames('checkbox', className, {
            'checkbox--labeled': !!label,
            'checkbox--reversed': !!label && labelPlacement === exports.LabelPlacement.Start
...
function CheckboxGroup(_a) {
    ...
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var mappedChildren = react.Children.map(children, function (child) { return react.cloneElement(child, { size: size }); });
    ...
    var fieldSize = exports.Size.md;
    if (size === exports.Size.md) {
        fieldSize = exports.Size.lg;
    }
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-checkbox-group", hasHelpText: hasAnyHelpText, hasLabel: !!label, inputRectHeight: size === exports.Size.md ? '5.5rem' : '4.75rem', size: fieldSize }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.CheckboxGroup, __assign({}, props, { className: classNames('checkbox-group', className), isDisabled: isDisabled, isInvalid: hasError, isReadOnly: isReadOnly, isRequired: isRequired, onChange: onChange !== null && onChange !== void 0 ? onChange : changeParamsCb }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: isInvalid, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: fieldSize, tooltipContent: tooltipContent }, { children: mappedChildren })) })));
}

function ColorSelect(props) {
    return (jsxRuntime.jsx(Select, __assign({}, props, { renderItemContent: function (optionContentProps) {
            var item = optionContentProps.item;
            return (jsxRuntime.jsx(SelectOptionContent, __assign({}, optionContentProps, { bodyPrefix: jsxRuntime.jsx(reactAriaComponents.ColorSwatch, { className: "color-select-option__color-swatch", color: item.value }) })));
        }, renderStartContent: function (selectedItem) {
            if (selectedItem) {
                return (jsxRuntime.jsx(reactAriaComponents.ColorSwatch, { className: "color-select-option__color-swatch", color: selectedItem.value }));
            }
            return null;
        } })));
}
...
function ColorSwatchPickerItem(_a) {
    ...
    return (jsxRuntime.jsxs(reactAriaComponents.ColorSwatchPickerItem, __assign({}, props, { className: classNames('color-swatch-picker-item', className), "data-invalid": !!isInvalid || undefined }, { children: [jsxRuntime.jsx(ColorSwatch, { size: size }), jsxRuntime.jsx(ColorSwatchPickerItemLine, {}), jsxRuntime.jsx(Icon, { className: "color-swatch-picker-item__check", name: iconNames.InputCheck })] })));
}

var _a$6;
var rectWidthForSize = (_a$6 = {},
    _a$6[exports.Size.xs] = 28,
    _a$6[exports.Size.sm] = 32,
    _a$6[exports.Size.md] = 40,
    _a$6);
function SkeletonColorSwatchPicker(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-color-swatch-picker', className), "data-layout": layout, ref: ref }, { children: Array.from({ length: itemCount }, function (_, i) { return (jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: rectWidth, shape: exports.SkeletonShape.Rectangle, width: rectWidth }, i)); }) })));
}
...
function ColorSwatchPicker(_a) {
    ...
    var _b = react.useState(isString(initialValue) ? reactAriaComponents.parseColor(initialValue) : initialValue), value = _b[0], setValue = _b[1];
    var onChange = function (newValue) {
        setValue(newValue);
        safeCall(props.onChange, newValue);
    };
    react.useEffect(function () {
        setValue(isString(initialValue) ? reactAriaComponents.parseColor(initialValue) : initialValue);
    }, [initialValue]);
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonColorSwatchPicker, { itemCount: items.length, layout: props.layout, size: size });
    }
    return (jsxRuntime.jsx(reactAriaComponents.ColorSwatchPicker, __assign({}, props, { className: classNames('color-swatch-picker', className), onChange: onChange, value: value }, { children: items.map(function (_a) {
            var color = _a.color, isDisabled = _a.isDisabled, isInvalid = _a.isInvalid;
            return (jsxRuntime.jsx(ColorSwatchPickerItem, { color: color, isDisabled: isDisabled, isInvalid: isInvalid, size: size }, color));
        }) })));
}
...
var placeholders = new string.LocalizedStringDictionary({
...
function DatePicker(_a) {
    ...
    var firstSpinBtnRef = react.useRef(null);
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-datepicker", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsxs(reactAriaComponents.DatePicker, __assign({}, props, { className: classNames('datepicker', className), isInvalid: hasError, isReadOnly: isReadOnly, isRequired: isRequired, maxValue: (_b = getDateValue(maxValue)) !== null && _b !== void 0 ? _b : undefined, minValue: (_c = getDateValue(minValue)) !== null && _c !== void 0 ? _c : undefined, onBlur: function () {
        ...
        }, onOpenChange: setIsCalendarOpen, value: selectedValue }, { children: [jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: size === exports.Size.xs ? exports.Size.sm : exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsxs(reactAriaComponents.Group, __assign({ className: "datepicker__controls datepicker__controls--".concat(size) }, { children: [jsxRuntime.jsx(reactAria.I18nProvider, __assign({ locale: cultureLocale }, { children: jsxRuntime.jsx(reactAriaComponents.DateInput, __assign({ className: "datepicker__input" }, { children: function (segment) { return (
                                // Need to wrap DateSegment with div: https://github.com/adobe/react-spectrum/issues/3164
                                jsxRuntime.jsx(reactAria.I18nProvider, __assign({ locale: languageLocale }, { children: jsxRuntime.jsx("div", __assign({ ref: function (node) {
                                            var _a;
                                            if (node && ((_a = node.parentNode) === null || _a === void 0 ? void 0 : _a.firstChild) === node) {
                                                firstSpinBtnRef.current = node.firstChild;
                                            }
                                        } }, { children: jsxRuntime.jsx(reactAriaComponents.DateSegment, __assign({ className: "datepicker__segment ".concat(size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS), segment: segment }, { children: segment.isPlaceholder ?
                                                getPlaceholder(segment.type, segment.text, languageLocale)
                                                : segment.text })) })) }))); } })) })), jsxRuntime.jsxs("div", __assign({ className: "datepicker__buttons" }, { children: [showClearButton && !isDisabled && !isReadOnly && selectedValue && (jsxRuntime.jsx(ClearButton, { className: "datepicker__clear-button", onPress: function () {
                                        var _a;
                                        setSelectedValue(null);
                                        onChange(null);
                                        (_a = firstSpinBtnRef.current) === null || _a === void 0 ? void 0 : _a.focus();
                                    }, slot: null })), jsxRuntime.jsx(reactAriaComponents.Button, __assign({ "aria-label": translateCommon('toggleCalendar'), className: "datepicker__button" }, { children: jsxRuntime.jsx(Icon, { name: iconNames.Calendar, size: exports.IconSize.MD }) }))] }))] })) })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "datepicker__popover", placement: "bottom left" }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ className: "datepicker__dialog" }, { children: jsxRuntime.jsx(Calendar, __assign({}, calendarProps, { relatedValue: relatedValue })) })) }))] })));
}

function getDateTimeValue(value) {
    if (value) {
        return isString(value) ? date.parseDateTime(value) : value;
    }
    return null;
}
...
function TimeSegment(_a) {
    ...
    var ref = react.useRef(null);
    var segmentProps = reactAria.useDateSegment(segment, state, ref).segmentProps;
    var languageLocale = useLocales().languageLocale;
    ...
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsx("div", __assign({}, segmentProps, { className: classNames('timepicker__segment', className), ref: ref }, { children: isPlaceholder ? getPlaceholder(type, text, languageLocale) : text })) }));
}
...
function TimePicker(_a) {
    ...
    var _f = react.useState(getDateTimeValue(value)), selectedValue = _f[0], setSelectedValue = _f[1];
    var _g = react.useState(false), isOpen = _g[0], setIsOpen = _g[1];
    var inputRef = react.useRef(null);
    var groupRef = react.useRef(null);
    var presetMenuRef = react.useRef(null);
    var toggleBtnRef = react.useRef(null);
    var popoverRef = react.useRef(null);
    var firstSpinBtnRef = react.useRef(null);
    var translateCommon = useTranslateCommon();
    var onInnerChange = function (time) {
        var _a;
        var dateTime;
        if (time instanceof date.Time) {
            dateTime = date.toCalendarDateTime((_a = selectedValue !== null && selectedValue !== void 0 ? selectedValue : getDateTimeValue(relatedValue)) !== null && _a !== void 0 ? _a : date.today(timeZone), time);
        }
        else {
            dateTime = time;
        }
    ...
    var state = reactStately.useTimeFieldState(__assign(__assign({}, timeFieldHookProps), { locale: cultureLocale }));
    var _h = reactAria.useTimeField(timeFieldHookProps, state, inputRef), fieldProps = _h.fieldProps, labelProps = _h.labelProps;
    ...
    var _k = react.useState(null), groupWidth = _k[0], setGroupWidth = _k[1];
    var onResize = react.useCallback(function () {
        if (groupRef.current) {
    ...
    var selectedItem = react.useMemo(function () { return (selectedValue ? { value: selectedValue.toString() } : null); }, [selectedValue]);
    var defaultHighlightedIndex = getIndexWithPropertyValue(VALUE, getNearestTimeItemValue(selectedValue !== null && selectedValue !== void 0 ? selectedValue : date.now(timeZone)), timeItems);
    var _l = downshift.useSelect({
        ...
        onSelectedItemChange: function (_a) {
            ...
            if (newSelectedItem && type !== downshift.useSelect.stateChangeTypes.ToggleButtonBlur) {
                var dateTime = date.parseDateTime(newSelectedItem.value);
    ...
    var toggleButtonFocusRing = reactAria.useFocusRing({ within: true, isTextInput: false });
    ...
    react.useEffect(function () {
        if (isOpen) {
            ...
            if (presetMenu) {
                var dataValue = getNearestTimeItemValue(selectedValue !== null && selectedValue !== void 0 ? selectedValue : date.now(timeZone));
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-timepicker", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Provider, __assign({ values: [
            [reactAriaComponents.LabelContext, __assign({}, labelProps)],
            [reactAriaComponents.TextContext, { slots: { description: helpTextProps } }]
        ] }, { children: jsxRuntime.jsxs("div", __assign({ className: classNames('timepicker', className), ref: ref }, { children: [jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: size === exports.Size.xs ? exports.Size.sm : exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsxs(reactAriaComponents.Group, __assign({ className: "timepicker__controls timepicker__controls--".concat(size), isDisabled: isDisabled, isInvalid: hasError, ref: groupRef }, { children: [jsxRuntime.jsx("div", __assign({}, fieldProps, fieldProps2, { className: "timepicker__input", ref: inputRef }, { children: state.segments.map(function (segment, i) { return (jsxRuntime.jsx(TimeSegment, { className: size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS, ref: i === 0 ? firstSpinBtnRef : undefined, segment: segment, state: state }, i)); }) })), jsxRuntime.jsxs("div", __assign({ className: "timepicker__buttons" }, { children: [showClearButton && !isDisabled && !isReadOnly && selectedValue && (jsxRuntime.jsx(ClearButton, { className: "timepicker__clear-button", onPress: function () {
                                            var _a;
                                            setSelectedValue(null);
                                            onChange(null);
                                            (_a = firstSpinBtnRef.current) === null || _a === void 0 ? void 0 : _a.focus();
                                        }, slot: null })), jsxRuntime.jsx("button", __assign({}, toggleBtnProps, { "aria-label": translateCommon('toggleMenu'), className: "timepicker__button", "data-disabled": toggleBtnProps.disabled || undefined, "data-focus-visible": toggleButtonFocusRing.isFocusVisible || undefined, "data-focused": toggleButtonFocusRing.isFocused || undefined }, { children: jsxRuntime.jsx(Icon, { name: iconNames.Schedule, size: exports.IconSize.MD }) }))] }))] })) })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "timepicker__popover", isNonModal: true, isOpen: isOpen, maxHeight: 280, placement: "bottom start", ref: popoverRef, style: groupWidth ? { width: groupWidth } : undefined, triggerRef: groupRef }, { children: jsxRuntime.jsx("div", __assign({}, menuProps, { className: "timepicker__menu" }, { children: timeItems.map(function (item, index) {
                            var itemValue = item.value;
                            var isSelected = (selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.value) === itemValue;
                            return (jsxRuntime.jsx(MemoizedSelectOption, { getItemProps: getItemProps, isFocused: highlightedIndex === index, isSelected: isSelected, item: item, itemIndex: index, level: 0, size: size, useDataValue: true }, itemValue));
                        }) })) }))] })) })));
}
...
})(exports.DateTimeFieldType || (exports.DateTimeFieldType = {}));
function useDateTimeValidation(value) {
    ...
    var field = exports.DateTimeFieldType.EndDate, isInvalid = false, errorMessage = '';
    if (start && end && end.compare(start) < 0) {
        isInvalid = true;
        errorMessage = translateValidation('endAfterStart');
        if (date.isSameDay(start, end)) {
            field = exports.DateTimeFieldType.EndTime;
        }
    }
    return {
        errorMessage: errorMessage,
...
function DateTimeRangeFields(_a) {
    var className = _a.className, changeCallback = _a.changeCallback, changeParams = _a.changeParams, fields = _a.fields, ref = _a.ref, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b, value = _a.value, props = __rest(_a, ["className", "changeCallback", "changeParams", "fields", "ref", "size", "value"]);
    var _c = react.useState(getDateTimeRangeValue(value)), selectedValue = _c[0], setSelectedValue = _c[1];
    var dateTimeValidation = useDateTimeValidation(selectedValue);
    var hasTimesOnly = fields.filter(function (_a) {
        var type = _a.type;
        return type === exports.DateTimeFieldType.EndDate || type === exports.DateTimeFieldType.StartDate;
    }).length ===
        0;
    var onChange = function (newValue) {
        var _a, _b, _c, _d;
    ...
    var onStartDateChange = function (date$1) {
        var _a = selectedValue !== null && selectedValue !== void 0 ? selectedValue : {}, start = _a.start, end = _a.end;
        var endTime = end ? date.toTime(end) : undefined;
        var newStart = date$1 ? date.toCalendarDateTime(date$1, start ? date.toTime(start) : endTime) : null;
    ...
    var onEndDateChange = function (date$1) {
        var _a = selectedValue !== null && selectedValue !== void 0 ? selectedValue : {}, start = _a.start, end = _a.end;
        var startTime = start ? date.toTime(start) : undefined;
        var newEnd = date$1 ? date.toCalendarDateTime(date$1, end ? date.toTime(end) : startTime) : null;
    ...
    for (var i = 0, len = fields.length; i < len; i++) {
        ...
        if (type === exports.DateTimeFieldType.StartDate || type === exports.DateTimeFieldType.EndDate) {
            var isStart = type === exports.DateTimeFieldType.StartDate;
            ...
            pickers.push(react.createElement(DatePicker, __assign({}, fieldProps, { helpText: errorMessage, isInvalid: isInvalid, key: type, onChange: isStart ? onStartDateChange : onEndDateChange, relatedValue: isStart ? selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.end : selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.start, size: size, value: dateTime ? date.toCalendarDate(dateTime).toString() : null })));
        }
        else if (type === exports.DateTimeFieldType.StartTime || type === exports.DateTimeFieldType.EndTime) {
            var isStart = type === exports.DateTimeFieldType.StartTime;
            var dateTime = isStart ? selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.start : selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.end;
            var relatedValue = void 0;
            if (!isStart &&
                (selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.start) &&
                (!dateTime || hasTimesOnly || date.isSameDay(selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.start, dateTime))) {
                relatedValue = selectedValue === null || selectedValue === void 0 ? void 0 : selectedValue.start;
            }
            pickers.push(react.createElement(TimePicker, __assign({}, fieldProps, { helpText: errorMessage, isInvalid: isInvalid, key: type, onChange: isStart ? onStartTimeChange : onEndTimeChange, relatedValue: relatedValue, size: size, value: dateTime ? dateTime.toString() : null })));
        }
    }
    return (jsxRuntime.jsx("div", __assign({ className: classNames('datetime-range-fields', className), ref: ref }, { children: pickerRows.map(function (pickers, i) { return (jsxRuntime.jsx("div", __assign({ className: "datetime-range-fields__row" }, { children: pickers }), i)); }) })));
}

var FileTrigger = reactAriaComponents.FileTrigger;

function SkeletonFileUploadArea(_a) {
    var ariaHidden = _a["aria-hidden"], className = _a.className, ref = _a.ref;
    return (jsxRuntime.jsx("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-file-upload-area', className), ref: ref }, { children: jsxRuntime.jsxs("div", __assign({ className: "skeleton-file-upload-area__inner" }, { children: [jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 48, shape: exports.SkeletonShape.Circle, width: 48 }), jsxRuntime.jsxs("div", __assign({ className: "skeleton-file-upload-area__texts" }, { children: [jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.lg, type: exports.SkeletonTextType.Label }), jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.sm, type: exports.SkeletonTextType.Body, width: "50%" })] }))] })) })));
}
...
function FileUploadArea(_a) {
    ...
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonFileUploadArea, {});
    }
    return (jsxRuntime.jsxs("div", __assign({ className: "file-upload-area-wrapper", ref: ref }, { children: [jsxRuntime.jsx(reactAriaComponents.DropZone, __assign({}, props, { className: classNames('file-upload-area', className), getDropOperation: function (types) {
                    var op = 'copy';
                    ...
                    onDrop(e);
                } }, { children: jsxRuntime.jsxs("div", __assign({ className: "file-upload-area__inner" }, { children: [jsxRuntime.jsx(Icon, { className: "file-upload-area__icon", name: iconName, size: exports.IconSize.XXL }), jsxRuntime.jsxs("div", __assign({ className: "file-upload-area__content" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "file-upload-area__texts" }, { children: [jsxRuntime.jsx(reactAriaComponents.Text, __assign({ className: "".concat(LABEL_SIZE_LG_CSS_CLASS, " file-upload-area__main-text"), elementType: exports.HTMLElementType.Div, slot: "label" }, { children: jsxRuntime.jsx("strong", { children: mainText }) })), jsxRuntime.jsx(BodyText, __assign({ className: "file-upload-area__description-text", elementType: exports.HTMLElementType.Div, size: exports.Size.sm }, { children: descriptionText }))] })), jsxRuntime.jsx(FileTrigger, __assign({ acceptedFileTypes: acceptedFileTypes, allowsMultiple: allowsMultiple, onSelect: function (files) {
                                        safeCall(onSelect, files ? Array.from(files) : []);
                                    } }, { children: jsxRuntime.jsx(Button, __assign({ isDisabled: isDisabled, size: exports.Size.md, startIconName: iconNames.Upload, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('upload') })) }))] }))] })) })), helpTextProps && (jsxRuntime.jsx(HelpText, __assign({}, helpTextProps, { className: classNames('file-upload-area__help-text', helpTextProps.className) })))] })));
}

exports.FilterBarStyle = void 0;
(function (FilterBarStyle) {
    FilterBarStyle["Card"] = "card";
    FilterBarStyle["Plain"] = "plain";
})(exports.FilterBarStyle || (exports.FilterBarStyle = {}));
function FilterBar(_a) {
    var activeFiltersCount = _a.activeFiltersCount, className = _a.className, children = _a.children, nonVisibleActiveFiltersCount = _a.nonVisibleActiveFiltersCount, onClearAll = _a.onClearAll, onPressFilters = _a.onPressFilters, ref = _a.ref, _b = _a.style, style = _b === void 0 ? exports.FilterBarStyle.Card : _b;
    var translateCommon = useTranslateCommon();
    var filterAreaRef = react.useRef(null);
    var _c = react.useState(false), isScrollable = _c[0], setIsScrollable = _c[1];
    var _d = react.useState({ scrollLeft: 0, scrollWidth: 0, offsetWidth: 0 }), scrollParams = _d[0], setScrollParams = _d[1];
    var actionSize = style === exports.FilterBarStyle.Card ? exports.Size.md : exports.Size.sm;
    ...
    utils.useResizeObserver({ ref: filterAreaRef, onResize: onResize });
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("filter-bar filter-bar--".concat(style), className), ref: ref }, { children: [jsxRuntime.jsxs("div", __assign({ className: "filter-bar__filters-wrapper" }, { children: [isScrollable && scrollParams.scrollLeft > 0 && (jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('scrollLeft'), className: "filter-bar__scroll-btn filter-bar__scroll-btn--left", iconName: iconNames.ChevronLeft, onPress: function () {
                            scrollFilterArea(-1);
                        }, style: exports.ButtonStyle.Fill, variant: exports.ButtonVariant.Neutral })), jsxRuntime.jsx("div", __assign({ className: "filter-bar__filters", ref: filterAreaRef }, { children: children })), isScrollable && scrollParams.scrollLeft < scrollParams.scrollWidth - scrollParams.offsetWidth && (jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('scrollRight'), className: "filter-bar__scroll-btn filter-bar__scroll-btn--right", iconName: iconNames.ChevronRight, onPress: function () {
                            scrollFilterArea(1);
                        }, style: exports.ButtonStyle.Fill, variant: exports.ButtonVariant.Neutral }))] })), jsxRuntime.jsxs("div", __assign({ className: "filter-bar__actions" }, { children: [jsxRuntime.jsxs(Button, __assign({ className: "filters-button", onPress: onPressFilters, size: actionSize, startIconName: iconNames.Tune, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: [!!nonVisibleActiveFiltersCount && (jsxRuntime.jsx(Icon, { ariaLabel: translateCommon('additionalFilters', { count: nonVisibleActiveFiltersCount }), className: "filters-button__icon", name: iconNames.StatusLightFilled, size: exports.IconSize.SM })), jsxRuntime.jsxs("strong", { children: [translateCommon('filters'), !!activeFiltersCount && " (".concat(activeFiltersCount, ")")] })] })), jsxRuntime.jsx(Button, __assign({ isDisabled: !activeFiltersCount, onPress: onClearAll, size: actionSize, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Danger }, { children: translateCommon('clearAll') }))] }))] })));
}

function FilterButton(_a) {
    var children = _a.children, className = _a.className, clearButtonProps = _a.clearButtonProps, helpText = _a.helpText, isActive = _a.isActive, isDisabled = _a.isDisabled, _b = _a.isFocusable, isFocusable = _b === void 0 ? true : _b, isOpen = _a.isOpen, isSkeleton = _a.isSkeleton, label = _a.label, labelProps = _a.labelProps, onOpenChange = _a.onOpenChange, ref = _a.ref, showClearButton = _a.showClearButton, showHelpTextIcon = _a.showHelpTextIcon, _c = _a.size, size = _c === void 0 ? exports.Size.md : _c, startIconName = _a.startIconName, toggleButtonProps = _a.toggleButtonProps;
    ...
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonField, { className: "skeleton-filter-button", hasHelpText: !!helpText, size: size });
    }
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("filter-button filter-button--".concat(size), className), "data-clearable": !!isClearable || undefined, ref: ref }, { children: [jsxRuntime.jsx(Label, __assign({}, labelProps, { className: "visually-hidden", size: exports.Size.lg }, { children: label })), jsxRuntime.jsxs("div", __assign({ className: classNames('filter-toggle-button-wrapper', className) }, { children: [jsxRuntime.jsx(reactAriaComponents.Button, __assign({}, fieldProps, toggleButtonProps, { className: "filter-toggle-button filter-toggle-button--".concat(size), "data-active": !!isActive || undefined, "data-focusable": !!isFocusable || undefined, excludeFromTabOrder: !isFocusable, isDisabled: isDisabled, onKeyDown: function (e) {
                            var _a;
                            var eventKey = e.key;
                            if (eventKey === exports.KeyboardEventKey.ArrowDown) {
                                e.preventDefault();
                                onOpenChange === null || onOpenChange === void 0 ? void 0 : onOpenChange(true);
                            }
                            else if (eventKey === exports.KeyboardEventKey.Escape) {
                        ...
                        }, preventFocusOnPress: !isFocusable }, { children: jsxRuntime.jsxs("span", __assign({ className: "filter-toggle-button__content" }, { children: [startIconName && (jsxRuntime.jsx(Icon, { ariaHidden: true, className: "filter-toggle-button__start-icon", name: startIconName })), jsxRuntime.jsx(Label, __assign({ className: "filter-toggle-button__label", size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: children })), isFocusable && (jsxRuntime.jsx(Icon, { className: classNames("filter-toggle-button__expand-icon filter-toggle-button__expand-icon--".concat(size), {
                                        'filter-toggle-button__expand-icon--disabled': isDisabled
                                    }), name: isOpen ? iconNames.ExpandLessFilled : iconNames.ExpandMoreFilled }))] })) })), isClearable && (jsxRuntime.jsx(ClearButton, __assign({ className: "filter-clear-button filter-clear-button--".concat(size), isDisabled: isDisabled }, clearButtonProps)))] })), helpText && (jsxRuntime.jsx(HelpText, __assign({}, helpTextProps, { showIcon: showHelpTextIcon, variant: isDisabled ? exports.HelpTextVariant.Disabled : exports.HelpTextVariant.Neutral }, { children: helpText })))] })));
}

function SearchField(_a) {
    var className = _a.className, helpText = _a.helpText, isSkeleton = _a.isSkeleton, placeholder = _a.placeholder, showHelpTextIcon = _a.showHelpTextIcon, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b, props = __rest(_a, ["className", "helpText", "isSkeleton", "placeholder", "showHelpTextIcon", "size"]);
    var _c = reactAria.useFocusRing({ within: true, isTextInput: false }), focusProps = _c.focusProps, isFocused = _c.isFocused, isFocusVisible = _c.isFocusVisible;
    var _d = reactAria.useHover(props), hoverProps = _d.hoverProps, isHovered = _d.isHovered;
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonField, { className: "skeleton-search-field", hasHelpText: !!helpText, size: size });
    }
    return (jsxRuntime.jsxs(reactAriaComponents.SearchField, __assign({}, props, { className: classNames("search-field search-field--".concat(size), className) }, { children: [jsxRuntime.jsxs("div", __assign({}, hoverProps, focusProps, { className: "search-field__content", "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-hovered": isHovered || undefined }, { children: [jsxRuntime.jsx(Icon, { className: "search-field__search-icon", name: iconNames.MagnifyingGlass }), jsxRuntime.jsx(reactAriaComponents.Input, { className: classNames('search-field__input', size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS), placeholder: placeholder }), jsxRuntime.jsx(ClearButton, { className: "search-field__clear-button" })] })), helpText && jsxRuntime.jsx(HelpText, __assign({ showIcon: showHelpTextIcon }, { children: helpText }))] })));
}
...
function MultiSelectHeader(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({}, props, { className: classNames('multiselect-header', className), "data-disabled": !!isDisabled || undefined, "data-focused": !!isFocused || undefined, "data-selected": !!isSelected || undefined }, { children: children })));
}
    ...
    var renderItems = function (itemArr, level) {
        ...
        var _loop_1 = function (i, len) {
            ...
            if (subItems) {
                ...
                itemNodes.push(react.createElement(MultiSelectHeader, __assign({}, getItemProps({ item: item, index: itemIndex }), { isDisabled: disabledKeys === null || disabledKeys === void 0 ? void 0 : disabledKeys.includes(value), isFocused: highlightedIndex === itemIndex, isSelected: isSelected, key: value }),
                    jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: text })),
                    isSelected && (jsxRuntime.jsx(Icon, { "aria-hidden": true, className: "multiselect-header__check", name: iconNames.InputCheck, size: exports.IconSize.MD }))));
                itemIndex++;
            ...
            else if (value === exports.SpecialSelectItemKey.CREATABLE) {
                itemNodes.push(jsxRuntime.jsx(MemoizedSelectOption, { getItemProps: getItemProps, isFocused: highlightedIndex === itemIndex, item: item, itemIndex: itemIndex, level: level, renderItemContent: function (optionContentProps) { return (jsxRuntime.jsx(SelectOptionContent, __assign({}, optionContentProps, { bodyPrefix: jsxRuntime.jsx(Icon, { className: "select-option__start-icon", name: iconNames.AddCircleFilled }), label: jsxRuntime.jsx(Label, __assign({ size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: isFunction(createText) ? createText(text) : createText })) }))); }, size: size }, value));
                itemIndex++;
            }
            else {
                itemNodes.push(renderItem(item, level));
            ...
            if (hasSeparator) {
                itemNodes.push(jsxRuntime.jsx(Divider, { size: exports.Size.sm }, "".concat(value, "--separator")));
            }
        };
        for (var i = 0, len = itemArr.length; i < len; i++) {
            _loop_1(i);
...
function FilterMultiSelect(_a) {
    ...
    var _j = react.useState(null), tempSelectedItems = _j[0], setTempSelectedItems = _j[1];
    var _k = react.useState(propsSelectedItems ? __spreadArray([], propsSelectedItems, true) : []), selectedItems = _k[0], setSelectedItems = _k[1];
    var _l = react.useState(null), filteredItems = _l[0], setFilteredItems = _l[1];
    ...
    var onInputChange = function (val) {
        setInputValue(val);
        safeCall(propsOnInputChange, val, exports.InputChangeTriggerAction.Input);
    ...
    var _m = downshift.useCombobox({
        ...
        onIsOpenChange: function (_a) {
            ...
            if (newIsOpen) {
                ...
                safeCall(propsOnInputChange, '', exports.InputChangeTriggerAction.Focus);
                setInputValue('');
                setFilteredItems(null);
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(FilterButton, __assign({ className: classNames('filter-multiselect', className), clearButtonProps: { onPress: clearSelectedItems }, helpText: helpText, isActive: selectedCount > 0, isDisabled: isDisabled, isFocusable: isSelectable, isOpen: isOpen, isSkeleton: isSkeleton, label: label, labelProps: __assign(__assign({}, labelProps), { htmlFor: [labelProps.htmlFor, toggleButtonProps.id].join(' ') }), onOpenChange: function (newIsOpen) { return (newIsOpen ? openMenu() : closeMenu()); }, ref: ref, showClearButton: isClearable, showHelpTextIcon: showHelpTextIcon, size: size, startIconName: startIconName, toggleButtonProps: __assign(__assign({}, toggleButtonProps), { ref: triggerRef }) }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label, selectedItemsText] }) })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "filter-select__popover", isOpen: isOpen, maxHeight: 375, onOpenChange: closeMenu, placement: "bottom start", shouldFlip: true, style: { width: menuWidth !== null && menuWidth !== void 0 ? menuWidth : defaultMenuWidth[size] }, triggerRef: triggerRef }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ "aria-label": label, className: "filter-select__dialog" }, { children: jsxRuntime.jsxs("div", __assign({ className: "filter-select__menu" }, { children: [jsxRuntime.jsx("div", __assign({ className: "filter-select__menu-header" }, { children: jsxRuntime.jsx(SearchField, __assign({}, inputProps, { "aria-label": translateCommon('search'), autoFocus: true, onChange: onInputChange, onFocusChange: onSearchFocusChange, placeholder: searchPlaceholder !== null && searchPlaceholder !== void 0 ? searchPlaceholder : translateCommon('search'), size: size })) })), jsxRuntime.jsxs("div", __assign({}, menuProps, { className: "filter-select__menu-body", tabIndex: -1 }, { children: [itemsToRender.length === 0 && !isLoading && (jsxRuntime.jsx(SelectOptionsEmptyState, { size: size }, "empty")), renderMultiSelectItems({
                                        createText: '',
                                        disabledKeys: disabledKeys,
                                        expandedKeys: expandedKeys,
                                        getItemProps: getItemProps,
                                        ...
                                        size: size
                                    }), isLoading && jsxRuntime.jsx(LoadingItem, { size: size }, "loading"), onBottomLoaderVisible && jsxRuntime.jsx(BottomLoader, { onVisible: onBottomLoaderVisible }, "loader")] })), jsxRuntime.jsxs("div", __assign({ className: "filter-select__menu-footer" }, { children: [isClearable && (jsxRuntime.jsx(Button, __assign({ onPress: clearTempSelectedItems, size: footerButtonSize[size], style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Danger }, { children: translateCommon('reset') }))), jsxRuntime.jsx("div", __assign({ className: "filter-select__menu-footer-btn-group" }, { children: jsxRuntime.jsxs(Button, __assign({ isDisabled: !isClearable && tempSelectedCount === 0, onPress: confirmTempSelectedItems, size: footerButtonSize[size], style: exports.ButtonStyle.Fill, variant: exports.ButtonVariant.Accent }, { children: [translateCommon('apply'), tempSelectedCount ? " (".concat(tempSelectedCount, ")") : ''] })) }))] }))] })) })) }))] }));
}

function FilterSelect(_a) {
    var changeCallback = _a.changeCallback, changeParams = _a.changeParams, className = _a.className, disabledKeys = _a.disabledKeys, expandedKeys = _a.expandedKeys, helpText = _a.helpText, _b = _a.isClearable, isClearable = _b === void 0 ? true : _b, isDisabled = _a.isDisabled, isLoading = _a.isLoading, _c = _a.isSelectable, isSelectable = _c === void 0 ? true : _c, isSkeleton = _a.isSkeleton, itemClassName = _a.itemClassName, items = _a.items, label = _a.label, menuWidth = _a.menuWidth, onBottomLoaderVisible = _a.onBottomLoaderVisible, propsOnInputChange = _a.onInputChange, ref = _a.ref, renderItemContent = _a.renderItemContent, searchPlaceholder = _a.searchPlaceholder, showHelpTextIcon = _a.showHelpTextIcon, _d = _a.size, size = _d === void 0 ? exports.Size.md : _d, startIconName = _a.startIconName, text = _a.text, value = _a.value;
    var translateCommon = useTranslateCommon();
    var localFilter = reactAria.useFilter({ sensitivity: 'base' });
    var triggerRef = react.useRef(null);
    var menuRef = react.useRef(null);
    var _e = react.useState(value && text ? { value: value, text: text } : null), selectedItem = _e[0], setSelectedItem = _e[1];
    var _f = react.useState(''), inputValue = _f[0], setInputValue = _f[1];
    var _g = react.useState(false), isOpen = _g[0], setIsOpen = _g[1];
    ...
    var _j = react.useState(null), filteredItems = _j[0], setFilteredItems = _j[1];
    var itemsToRender = (filteredItems !== null && filteredItems !== void 0 ? filteredItems : items).slice();
    ...
    var menuProps = getMenuProps({ ref: menuRef }, { suppressRefError: true });
    var labelProps = getLabelProps();
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(FilterButton, __assign({ className: classNames('filter-select', className), clearButtonProps: { onPress: function () { return selectItem(null); } }, helpText: helpText, isActive: !!selectedItem, isDisabled: isDisabled, isFocusable: isSelectable, isOpen: isOpen, isSkeleton: isSkeleton, label: label, labelProps: __assign(__assign({}, labelProps), { htmlFor: [labelProps.htmlFor, toggleButtonProps.id].join(' ') }), onOpenChange: function (newIsOpen) { return (newIsOpen ? openMenu() : closeMenu()); }, ref: ref, showClearButton: isClearable, showHelpTextIcon: showHelpTextIcon, size: size, startIconName: startIconName, toggleButtonProps: __assign(__assign({}, toggleButtonProps), { ref: triggerRef }) }, { children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [label, selectedItem && ": ".concat(selectedItem.text)] }) })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "filter-select__popover", isOpen: isOpen, maxHeight: 375, onOpenChange: closeMenu, placement: "bottom start", shouldFlip: true, style: { width: menuWidth !== null && menuWidth !== void 0 ? menuWidth : '250px' }, triggerRef: triggerRef }, { children: jsxRuntime.jsx(reactAriaComponents.Dialog, __assign({ "aria-label": label, className: "filter-select__dialog" }, { children: jsxRuntime.jsxs("div", __assign({ className: "filter-select__menu" }, { children: [jsxRuntime.jsx("div", __assign({ className: "filter-select__menu-header" }, { children: jsxRuntime.jsx(SearchField, __assign({}, inputProps, { "aria-label": translateCommon('search'), autoFocus: true, onChange: onInputChange, placeholder: searchPlaceholder !== null && searchPlaceholder !== void 0 ? searchPlaceholder : translateCommon('search'), size: size })) })), jsxRuntime.jsxs("div", __assign({}, menuProps, { className: "filter-select__menu-body" }, { children: [itemsToRender.length === 0 && !isLoading && (jsxRuntime.jsx(SelectOptionsEmptyState, { size: size }, "empty")), renderSelectItems({
                                        createText: '',
                                        disabledKeys: disabledKeys,
                                        expandedKeys: expandedKeys,
                                        getItemProps: getItemProps,
...
exports.SelectedItemStyle = void 0;
(function (SelectedItemStyle) {
    SelectedItemStyle["tag"] = "tag";
    SelectedItemStyle["text"] = "text";
})(exports.SelectedItemStyle || (exports.SelectedItemStyle = {}));
function MultiSelectChip(_a) {
    var children = _a.children, className = _a.className, _b = _a.displayStyle, displayStyle = _b === void 0 ? exports.SelectedItemStyle.text : _b, props = __rest(_a, ["children", "className", "displayStyle"]);
    return (jsxRuntime.jsx("span", __assign({}, props, { className: classNames("multiselect__chip multiselect__chip--".concat(displayStyle), className) }, { children: children })));
}
...
var _a$4, _b$1, _c;
var labelSize = (_a$4 = {},
    _a$4[exports.Size.xs] = exports.Size.sm,
    _a$4[exports.Size.sm] = exports.Size.md,
    _a$4[exports.Size.md] = exports.Size.lg,
    _a$4[exports.Size.lg] = exports.Size.lg,
    _a$4);
var descriptionSize = (_b$1 = {},
    _b$1[exports.Size.xs] = exports.Size.xs,
    _b$1[exports.Size.sm] = exports.Size.xs,
    _b$1[exports.Size.md] = exports.Size.sm,
    _b$1[exports.Size.lg] = exports.Size.sm,
    _b$1);
var iconSize = (_c = {},
    _c[exports.Size.xs] = exports.IconSize.XS,
    _c[exports.Size.sm] = exports.IconSize.SM,
    _c[exports.Size.md] = exports.IconSize.MD,
    _c[exports.Size.lg] = exports.IconSize.LG,
    _c);
function Avatar(props) {
    var alt = props.alt, className = props.className, description = props.description, _a = props.iconName, iconName = _a === void 0 ? iconNames.GhostFilled : _a, isDisabled = props.isDisabled, isInteractive = props.isInteractive, label = props.label, labelMaxWidth = props.labelMaxWidth, onPress = props.onPress, ref = props.ref, _b = props.size, size = _b === void 0 ? exports.Size.md : _b, src = props.src, style = props.style, text = props.text;
    var hasImage = !!src;
    var image;
    if (hasImage) {
        image = jsxRuntime.jsx("img", { alt: alt, className: "avatar__image", src: src, title: alt });
    }
    else if (text) {
        image = (jsxRuntime.jsx("span", __assign({ className: "avatar__image", title: alt }, { children: text })));
    }
    else {
        image = (jsxRuntime.jsx("span", __assign({ className: "avatar__image", title: alt }, { children: jsxRuntime.jsx(Icon, { className: "avatar__icon", name: iconName, size: iconSize[size] }) })));
    }
    if (isInteractive && !isDisabled) {
        image = (jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(reactAria.FocusRing, __assign({ focusRingClass: "avatar__trigger-element--focused" }, { children: jsxRuntime.jsxs(TriggerElement, __assign({ className: "avatar__trigger-element", onPress: onPress, role: onPress ? 'button' : undefined }, { children: [image, jsxRuntime.jsx("span", { className: "avatar__scrim" })] })) })), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: alt }))] }));
    }
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("avatar avatar--".concat(size), className, {
            'avatar--disabled': isDisabled,
            'avatar--interactive': isInteractive,
            'avatar--pressable': !!onPress
        }), ref: ref, style: style }, { children: [image, (!!label || !!description) && (jsxRuntime.jsxs("div", __assign({ className: "avatar__label-wrapper", style: { maxWidth: labelMaxWidth } }, { children: [label && (jsxRuntime.jsx(Label, __assign({ className: "avatar__label", size: labelSize[size] }, { children: label }))), description && (jsxRuntime.jsx(Label, __assign({ className: "avatar__description", size: descriptionSize[size] }, { children: description })))] })))] })));
}

exports.AvatarGroupLayout = void 0;
(function (AvatarGroupLayout) {
    AvatarGroupLayout["Grid"] = "grid";
    AvatarGroupLayout["Stack"] = "stack";
})(exports.AvatarGroupLayout || (exports.AvatarGroupLayout = {}));
var STACK_MAX_VISIBLE_COUNT = 5;
var GRID_MAX_VISIBLE_COUNT = 10;
function AvatarGroup(_a) {
    var propsChildren = _a.children, className = _a.className, _b = _a.layout, layout = _b === void 0 ? exports.AvatarGroupLayout.Stack : _b, maxVisibleCount = _a.maxVisibleCount, ref = _a.ref, size = _a.size;
    var children = react.Children.toArray(propsChildren);
    var childCount = children.length;
    var hasStackLayout = layout === exports.AvatarGroupLayout.Stack;
        ...
        var menuItems = children.slice(maxCount, childCount).map(function (child, i) {
            ...
            var item = {
                ...
                props: {
                    ...
                    prefix: react.cloneElement(avatarElement, {
                        // always ignore label and description
                        description: undefined,
                        isInteractive: false,
                        label: undefined,
                        onPress: undefined,
                        size: exports.Size.xs
                    })
                }
            };
            return item;
        });
        content.push(jsxRuntime.jsx(Menu, __assign({ items: menuItems }, { children: jsxRuntime.jsx(reactAriaComponents.Button, __assign({ className: "avatar-group__more-button avatar-group__more-button--".concat(size), style: hasStackLayout ? { zIndex: 0 } : undefined }, { children: jsxRuntime.jsx(Label, __assign({ size: size === exports.Size.lg ? exports.Size.sm : exports.Size.xs }, { children: "+".concat(childCount - maxCount) })) })) }), "more"));
    }
    return (jsxRuntime.jsx("div", __assign({ className: classNames("avatar-group avatar-group--".concat(layout, " avatar-group--").concat(size), className), ref: ref }, { children: content })));
}
...
function Breadcrumbs(_a) {
    ...
    var itemsWithMore = react.useMemo(function () {
        var arr = items.slice();
        arr.splice(items.length - 1, 0, { id: MORE_ELEMENT_ID, label: '...' });
        return arr;
    }, [items]);
    var _b = react.useState([]), hiddenItems = _b[0], setHiddenItems = _b[1];
    var _c = react.useState(false), currentHasTooltip = _c[0], setCurrentHasTooltip = _c[1];
    ...
    utils.useResizeObserver({ ref: wrapperRef, onResize: onResize });
    return (jsxRuntime.jsx(reactAriaComponents.Breadcrumbs, __assign({}, props, { className: classNames('breadcrumbs', className), onAction: onAction, ref: wrapperRef }, { children: itemsWithMore.map(function (_a, i) {
            var id = _a.id, label = _a.label, isDisabled = _a.isDisabled;
            var hasTooltip = i === itemsWithMore.length - 1 && currentHasTooltip;
            var link = (jsxRuntime.jsx(reactAriaComponents.Link, __assign({ className: "breadcrumb-link ".concat(LABEL_SIZE_MD_CSS_CLASS), 
                // Link with tooltip should be focusable so cannot disable.
                isDisabled: hasTooltip ? false : isDisabled }, { children: label })));
            if (hasTooltip) {
                link = (jsxRuntime.jsxs(TooltipTrigger, { children: [link, jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: label }))] }));
            }
            if (id === MORE_ELEMENT_ID) {
                link = (jsxRuntime.jsx(Menu, __assign({ items: hiddenItems.map(function (item) { return ({ id: item.id, name: item.label }); }), onAction: onAction }, { children: link })));
            }
            return (jsxRuntime.jsx(reactAriaComponents.Breadcrumb, __assign({ className: "breadcrumb", "data-id": id, id: id }, { children: link }), id));
        }) })));
}

exports.LinkRole = void 0;
(function (LinkRole) {
    LinkRole["Button"] = "button";
    // eslint-disable-next-line @typescript-eslint/no-shadow
    LinkRole["Link"] = "link";
})(exports.LinkRole || (exports.LinkRole = {}));
function Link(_a) {
    var _b;
    var className = _a.className, isVisited = _a.isVisited, ref = _a.ref, _c = _a.role, role = _c === void 0 ? exports.LinkRole.Link : _c, size = _a.size, props = __rest(_a, ["className", "isVisited", "ref", "role", "size"]);
    var cssClassName = classNames('link', className, (_b = {}, _b["link--".concat(size)] = size, _b));
    if (role === exports.LinkRole.Button) {
        return (jsxRuntime.jsx(reactAriaComponents.Button, __assign({}, props, { className: cssClassName, "data-visited": isVisited, ref: ref })));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Link, __assign({}, props, { className: cssClassName, "data-visited": isVisited, ref: ref })));
}
...
function PageButton(_a) {
    ...
    return (jsxRuntime.jsx(reactAriaComponents.Button, __assign({}, props, { className: classNames('page-button', className), "data-active": !!isActive || undefined }, { children: jsxRuntime.jsx(Label, __assign({ className: "page-button__label", size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: children }) })) })));
}

function PageEllipsis(_a) {
    var items = _a.items, onAction = _a.onAction;
    return (jsxRuntime.jsx(Menu, __assign({ items: items, onAction: onAction }, { children: jsxRuntime.jsx(reactAriaComponents.Button, __assign({ className: "page-button" }, { children: jsxRuntime.jsx(Label, __assign({ className: "page-button__label", size: exports.Size.sm }, { children: "..." })) })) })));
}
...
function Pagination(_a) {
    ...
    var pageSizeItems = react.useMemo(function () { return createPageSizeItems(pageSizes !== null && pageSizes !== void 0 ? pageSizes : DEFAULT_PAGE_SIZES); }, [pageSizes]);
    ...
    var _b = react.useState(initialPage), page = _b[0], setPage = _b[1];
    var _c = react.useState(initialRowsPerPage), rowsPerPage = _c[0], setRowsPerPage = _c[1];
    ...
    var itemsPerPageSelect = isNullOrUndefined(pageSize) || !itemsPerPageOptions.isVisible ?
        null
        : jsxRuntime.jsxs("div", __assign({ className: "pagination__items-per-page" }, { children: [itemsPerPageOptions.showLabel && jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: translateCommon('itemsPerPage') })), jsxRuntime.jsx(Select, { "aria-label": translateCommon('itemsPerPage'), className: "pagination__select", isPlain: isMinimized, isSearchable: false, items: pageSizeItems, menuWidth: "5rem", onSelectionChange: onRowsPagePageChange, size: isMinimized ? exports.Size.xs : exports.Size.md, text: rowsPerPage.toString(), value: rowsPerPage })] }), "items-per-page");
    var itemRangeLabel = itemRange ?
        jsxRuntime.jsx(Label, __assign({ className: "pagination__item-range", size: exports.Size.md }, { children: translatePager('resultsOf', { start: itemRange.start, end: itemRange.end, total: totalRowCount }) }), "item-rang")
        : null;
    var pageNavigation = (jsxRuntime.jsxs("div", __assign({ className: classNames('pagination__pages', {
            'pagination__pages--minimized': isMinimized
        }) }, { children: [jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('previousPage'), className: "pagination__prev-btn", iconName: iconNames.ChevronLeft, isDisabled: page === 1, onPress: prevPage, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }), isMinimized ? null : (getPageItems(pageCount, page).map(function (value, index, array) {
                if (isString(value) && value.includes('ellipsis')) {
                    return (jsxRuntime.jsx(PageEllipsis, { items: getEllipsisItems(index, array), onAction: function (pageId) { return onPageChange(pageId); } }, value));
                }
                return (jsxRuntime.jsx(PageButton, __assign({ isActive: page === value, onPress: function () { return onPageChange(value); } }, { children: value }), value));
            })), jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('nextPage'), className: "pagination__next-btn", iconName: iconNames.ChevronRight, isDisabled: page === pageCount, onPress: nextPage, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })] }), "pages"));
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('pagination', className, {
            'pagination--minimized': isMinimized,
            'pagination--reversed': showPagesFirst
        }), ref: ref }, { children: [(!!itemsPerPageSelect || !!itemRangeLabel) && (jsxRuntime.jsxs("div", __assign({ className: classNames('pagination__row-count-info', {
                    'pagination__row-count-info--minimized': isMinimized
                }) }, { children: [itemsPerPageSelect, itemRangeLabel] }))), pageNavigation] })));
}

var headingIcon = (jsxRuntime.jsx("svg", __assign({ fill: "none", viewBox: "0 0 18 16" }, { children: jsxRuntime.jsx("path", { d: "M6.5 7C6.5 6.17157 7.17157 5.5 8 5.5H10C10.8284 5.5 11.5 6.17157 11.5 7V9C11.5 9.82843 10.8284 10.5 10 10.5H8C7.17157 10.5 6.5 9.82843 6.5 9V7Z", stroke: "currentColor" }) })));
function MenuDecorLine(_a) {
    var inverted = _a.inverted, isActive = _a.isActive, isHeading = _a.isHeading, showLine = _a.showLine;
    return (jsxRuntime.jsx("div", __assign({ className: classNames('menu-decor-line', {
...
function NavItemBadge(_a) {
    ...
    return (jsxRuntime.jsx(Icon, { ariaLabel: ariaLabel, className: classNames('nav-item__badge', { 'nav-item__badge--visible': isVisible }), name: iconName, size: exports.IconSize.XS }));
}
...
function NavItem(_a) {
    ...
    var role = hasChildren ? exports.AriaRole.button : exports.AriaRole.link;
    var isHeading = type === NavItemType.GroupHeading;
    if (isHeading) {
        return (jsxRuntime.jsxs("div", __assign({ "aria-current": isActive ? 'page' : undefined, className: classNames("nav-item nav-item--type-".concat(type)), id: domId }, { children: [useDecorLine && (jsxRuntime.jsx(MenuDecorLine, { inverted: inverted, isActive: isActive, isHeading: isHeading, showLine: showLine })), jsxRuntime.jsx(MenuGroupHeader, __assign({ className: classNames('nav-item__menu-group-header', {
    ...
    if (badge) {
        suffix.push(react.createElement(NavItemBadge, __assign({}, badge, { key: "badge" })));
    }
    if (!expanderIcon && showExpanderPlaceholder) {
        suffix.push(jsxRuntime.jsx("div", { className: "nav-item__expander-placeholder" }, "exp-ph"));
    }
    return (jsxRuntime.jsxs(TriggerElement, __assign({ "aria-current": isActive ? 'page' : undefined, "aria-expanded": hasChildren ? isExpanded : undefined, className: classNames("nav-item nav-item--type-".concat(type), {
            'nav-item--inverted': inverted,
            'nav-item--active': isActive && !hasChildren,
            'nav-item--with-decor-line': useDecorLine
        }), elementType: exports.HTMLElementType.A, id: domId, onPress: function () { return onPress === null || onPress === void 0 ? void 0 : onPress(id); }, role: role }, { children: [useDecorLine && (jsxRuntime.jsx(MenuDecorLine, { inverted: inverted, isActive: isActive, isHeading: isHeading, showLine: showLine })), jsxRuntime.jsx("div", __assign({ className: classNames("nav-item__action-item nav-item--indentation-level-".concat(level), {
                    'nav-item__action-item--indented': type === NavItemType.Indented,
                    'nav-item__action-item--inverted': inverted
                }) }, { children: jsxRuntime.jsx(ActionItemContent, { label: label, leftIconName: hasChildren ? icon : getInvertedIconName(icon, isActive), rightIconName: expanderIcon, suffix: suffix }) }))] })));
}

exports.SideNavMode = void 0;
(function (SideNavMode) {
    SideNavMode["Default"] = "default";
    SideNavMode["Inverted"] = "inverted";
})(exports.SideNavMode || (exports.SideNavMode = {}));
...
function SideNav(_a) {
    var _b = _a.canShrink, canShrink = _b === void 0 ? true : _b, propsExpandedKeys = _a.expandedKeys, header = _a.header, _c = _a.isExpanded, isExpanded = _c === void 0 ? true : _c, items = _a.items, _d = _a.mode, mode = _d === void 0 ? exports.SideNavMode.Default : _d, onExpandedKeysChange = _a.onExpandedKeysChange, ref = _a.ref, toggleCallback = _a.toggleCallback, props = __rest(_a, ["canShrink", "expandedKeys", "header", "isExpanded", "items", "mode", "onExpandedKeysChange", "ref", "toggleCallback"]);
    var domIdPrefix = react.useId();
    var _e = react.useState(canShrink ? isExpanded : true), isSideNavExpanded = _e[0], setIsSideNavExpanded = _e[1];
    var translateCommon = useTranslateCommon();
    var _f = react.useState(propsExpandedKeys !== null && propsExpandedKeys !== void 0 ? propsExpandedKeys : new Set()), expandedKeys = _f[0], setExpandedKeys = _f[1];
    ...
    var hasExpandableItems = react.useMemo(function () { return containsExpandableItems(items); }, [items]);
    ...
    var renderItem = function (item, level) {
        ...
        if (isSideNavExpanded) {
            return (jsxRuntime.jsx(NavItem, { domId: isHeading ? getDomId(id) : undefined, inverted: mode === exports.SideNavMode.Inverted, isActive: isActive, isExpanded: isItemExpanded, item: item, level: level, showExpanderPlaceholder: showExpanderPlaceholder, type: type }));
        }
        return (jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsxs("div", __assign({ className: "side-nav__icon-button-wrapper" }, { children: [jsxRuntime.jsx(IconButton, { "aria-current": isActive ? 'page' : undefined, "aria-label": label, className: "side-nav__icon-button", iconName: getInvertedIconName(icon, isActive), inverted: mode === exports.SideNavMode.Inverted, onPress: function () { return onPress === null || onPress === void 0 ? void 0 : onPress(id); }, size: exports.Size.sm, style: isActive ? exports.ButtonStyle.Fill : exports.ButtonStyle.Plain, variant: isActive ? exports.ButtonVariant.Accent : exports.ButtonVariant.Neutral }), badge && jsxRuntime.jsx(NavItemBadge, __assign({}, badge))] })), jsxRuntime.jsx(Tooltip, __assign({ position: exports.Position.Right, type: exports.TooltipType.Plain }, { children: label }))] }));
    };
    ...
    var renderItems = function (itemArr, level) {
        ...
        for (var i = 0, len = itemArr.length; i < len; i++) {
            ...
            if (subItems) {
                if (item.isHeading) {
                    itemNodes.push(jsxRuntime.jsxs("li", __assign({ className: "side-nav__nav-list-item" }, { children: [renderItem(item, level), jsxRuntime.jsx("ul", __assign({ "aria-labelledby": getDomId(item.id), className: "side-nav__nav-list side-nav__nav-section" }, { children: renderItems(subItems, level) }))] }), item.id));
                }
                else {
                    itemNodes.push(jsxRuntime.jsxs("li", __assign({ className: "side-nav__nav-list-item" }, { children: [renderItem(itemToRender, level), expandedKeys.has(item.id) && (jsxRuntime.jsx("ul", __assign({ className: "side-nav__nav-list side-nav__sub-nav-list" }, { children: renderItems(subItems, level + 1) })))] }), item.id));
                }
            }
            else {
                itemNodes.push(jsxRuntime.jsx("li", __assign({ className: "side-nav__nav-list-item" }, { children: renderItem(item, level) }), item.id));
            }
        }
        return itemNodes;
    };
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("side-nav side-nav--mode-".concat(mode), { 'side-nav--expanded': isSideNavExpanded }), ref: ref }, { children: [(canShrink || header) && (jsxRuntime.jsxs("div", __assign({ className: "side-nav__header" }, { children: [isFunction(header) ? header(isSideNavExpanded) : header, canShrink && (jsxRuntime.jsx(IconButton, { "aria-expanded": isSideNavExpanded, "aria-label": translateCommon(isSideNavExpanded ? 'collapse' : 'expand'), className: "side-nav__toggle", iconName: iconNames.Menu, inverted: mode === exports.SideNavMode.Inverted, onPress: toggleItems, size: isSideNavExpanded ? exports.Size.md : exports.Size.sm, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })), jsxRuntime.jsx(Divider, { alignment: exports.Alignment.center, className: "side-nav__divider", size: exports.Size.sm })] }))), jsxRuntime.jsx("nav", __assign({ "aria-label": props['aria-label'], className: "side-nav__content" }, { children: jsxRuntime.jsx("ul", __assign({ className: "side-nav__nav-list" }, { children: renderItems(items, 0) })) }))] })));
}

function Steps(_a) {
    var activeStep = _a.activeStep, className = _a.className, children = _a.children, _b = _a.orientation, orientation = _b === void 0 ? exports.Orientation.horizontal : _b, ref = _a.ref, _c = _a.stepAlignment, stepAlignment = _c === void 0 ? exports.Alignment.start : _c;
    var mappedChildren = react.Children.map(children, function (child, index) {
        return react.cloneElement(child, {
            alignment: orientation === exports.Orientation.horizontal ? stepAlignment : exports.Alignment.start,
            index: index,
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames("steps steps--".concat(orientation), className), ref: ref }, { children: mappedChildren })));
}

function StepIndicator(_a) {
    var isActive = _a.isActive, isCompleted = _a.isCompleted, isDisabled = _a.isDisabled, text = _a.text;
    return (jsxRuntime.jsx("div", __assign({ className: classNames('step-indicator', {
            'step-indicator--completed': isCompleted,
            'step-indicator--active': isActive,
            'step-indicator--disabled': isDisabled
        }) }, { children: isCompleted ?
            jsxRuntime.jsx(Icon, { name: iconNames.CheckFilled, size: exports.IconSize.SM })
            : jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: text }) })) })));
}

function StepProgressBar(_a) {
    var _b = _a.orientation, orientation = _b === void 0 ? exports.Orientation.horizontal : _b, value = _a.value;
    var isVertical = orientation === exports.Orientation.vertical;
    var translateProject = useTranslateProject();
    return (jsxRuntime.jsx(reactAriaComponents.ProgressBar, __assign({ "aria-label": translateProject('progress'), className: "step-progress-bar step-progress-bar--".concat(orientation), value: value }, { children: function (_a) {
            var percentage = _a.percentage;
            return (jsxRuntime.jsx("div", __assign({ className: "step-progress-bar__bar" }, { children: jsxRuntime.jsx("div", { className: "step-progress-bar__fill", style: {
...
function StepItem(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.start : _b, _c = _a.index, index = _c === void 0 ? 0 : _c, isActive = _a.isActive, isCompleted = _a.isCompleted, isDisabled = _a.isDisabled, _d = _a.orientation, orientation = _d === void 0 ? exports.Orientation.horizontal : _d, progressValue = _a.progressValue, ref = _a.ref, supportText = _a.supportText, title = _a.title;
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames("step-item step-item--".concat(alignment, "-aligned"), {
                    'step-item--active': isActive,
                    'step-item--completed': isCompleted
                }), ref: ref }, { children: [jsxRuntime.jsx(StepIndicator, { isActive: isActive, isCompleted: isCompleted, isDisabled: isDisabled, text: index + 1 }), jsxRuntime.jsxs("div", __assign({ className: "step-item__texts" }, { children: [jsxRuntime.jsx(BodyText, __assign({ className: "step-item__title", elementType: exports.HTMLElementType.Div, size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: title }) })), jsxRuntime.jsx(BodyText, __assign({ className: "step-item__support-text", elementType: exports.HTMLElementType.Div, size: exports.Size.xs }, { children: supportText }))] }))] })), !isNullOrUndefined(progressValue) && jsxRuntime.jsx(StepProgressBar, { orientation: orientation, value: progressValue })] }));
}

exports.TabsType = void 0;
(function (TabsType) {
    TabsType["Card"] = "card";
    TabsType["Underline"] = "underline";
})(exports.TabsType || (exports.TabsType = {}));
function Tabs(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.center : _b, _c = _a.orientation, orientation = _c === void 0 ? exports.Orientation.horizontal : _c, panelItems = _a.panelItems, tabItems = _a.tabItems, _d = _a.type, type = _d === void 0 ? exports.TabsType.Underline : _d, props = __rest(_a, ["alignment", "orientation", "panelItems", "tabItems", "type"]);
    var disabledKeys = tabItems.filter(function (item) { return item.isDisabled; }).map(function (item) { return item.id; });
    var effectiveOrientation = type === exports.TabsType.Underline ? orientation : exports.Orientation.horizontal;
    return (jsxRuntime.jsxs(reactAriaComponents.Tabs, __assign({}, props, { className: "tabs", disabledKeys: disabledKeys, orientation: effectiveOrientation }, { children: [jsxRuntime.jsx(reactAriaComponents.TabList, __assign({ className: "tab-list tab-list--".concat(alignment) }, { children: tabItems.map(function (item) { return (jsxRuntime.jsx(reactAriaComponents.Tab, __assign({ className: "tab tab--".concat(type, " tab--").concat(alignment), "data-orientation": effectiveOrientation, id: item.id }, { children: function (_a) {
                        var isSelected = _a.isSelected;
                        return (jsxRuntime.jsxs("div", __assign({ className: "tab__container tab__container--".concat(type, " tab__container--").concat(alignment), "data-orientation": effectiveOrientation, "data-selected": isSelected || undefined }, { children: [item.iconName && jsxRuntime.jsx(Icon, { name: item.iconName, size: exports.IconSize.MD }), jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: item.name })), item.badgeText && (jsxRuntime.jsx(Badge, __assign({ isDisabled: !!props.isDisabled || item.isDisabled, style: exports.BadgeStyle.Outline, variant: exports.BadgeVariant.Neutral }, { children: item.badgeText })))] })));
                    } }), "tab".concat(item.id))); }) })), jsxRuntime.jsx(Divider, { alignment: exports.Alignment.center, className: "tab__divider tab__divider--".concat(type), orientation: effectiveOrientation, size: type === exports.TabsType.Underline ? exports.Size.md : exports.Size.sm }), panelItems.map(function (item) { return (jsxRuntime.jsx(reactAriaComponents.TabPanel, __assign({ className: "panel panel--".concat(type), id: item.id }, { children: item.content }), "panel".concat(item.id))); })] })));
}
...
})(exports.TagStyle || (exports.TagStyle = {}));
function Tag(_a) {
    var children = _a.children, className = _a.className, iconName = _a.iconName, isDisabled = _a.isDisabled, onPress = _a.onPress, onRemove = _a.onRemove, ref = _a.ref, removeButtonProps = _a.removeButtonProps, role = _a.role, _b = _a.size, size = _b === void 0 ? exports.Size.md : _b, _c = _a.style, style = _c === void 0 ? exports.TagStyle.Outline : _c, triggerRole = _a.triggerRole;
    var labelRef = react.useRef(null);
    ...
    return (jsxRuntime.jsxs("span", __assign({ className: classNames("tag tag--".concat(size, " ").concat(style, "-tag"), className, {
            'tag--interactive': isInteractive,
            'tag--pressable': isPressable,
            'tag--disabled': isDisabled
        }), ref: ref, role: role }, { children: [jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !isTruncated }, { children: [jsxRuntime.jsxs(TriggerElement, __assign({ className: "tag__content", excludeFromTabOrder: !isInteractive, onPress: onPress, role: triggerRole }, { children: [iconName && jsxRuntime.jsx(Icon, { className: "tag__icon", name: iconName, size: exports.IconSize.SM }), jsxRuntime.jsx(Label, __assign({ className: "tag__label", ref: labelRef, size: size === exports.Size.xs ? exports.Size.sm : size }, { children: children }))] })), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: children }))] })), onRemove && (jsxRuntime.jsx(IconButton, __assign({ "aria-label": "".concat(isString(children) ? children : '', " ").concat(translateCommon('remove')), className: "tag__remove-button", iconName: iconNames.Close, isDisabled: isDisabled, onPress: onRemove, size: size === exports.Size.xs ? exports.Size.sm : size, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, removeButtonProps)))] })));
}
...
function TagGroup(_a) {
    var propsChildren = _a.children, className = _a.className, _b = _a.maxVisibleRows, maxVisibleRows = _b === void 0 ? DEFAULT_MAX_VISIBLE_ROWS : _b, ref = _a.ref, _c = _a.size, size = _c === void 0 ? exports.Size.md : _c, _d = _a.style, style = _d === void 0 ? exports.TagStyle.Outline : _d;
    var children = react.Children.toArray(propsChildren);
    ...
    var tagListRef = react.useRef(null);
    var _e = react.useState(0), hiddenCount = _e[0], setHiddenCount = _e[1];
    var _f = react.useState(false), isExpanded = _f[0], setIsExpanded = _f[1];
    var translateCommon = useTranslateCommon();
    var tagListId = react.useId();
    var onResize = react.useCallback(function () {
    ...
    utils.useResizeObserver({ ref: tagListRef, onResize: onResize });
    react.useEffect(function () {
        document.fonts.ready.then(onResize);
    }, []);
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("tag-group tag-group--".concat(size), className), ref: ref }, { children: [jsxRuntime.jsx("div", __assign({ className: "tag-group__tags", id: tagListId, ref: tagListRef, role: "list" }, { children: content })), hiddenCount > 0 && (jsxRuntime.jsx(Button, __assign({ "aria-controls": tagListId, "aria-expanded": isExpanded, onPress: function () { return setIsExpanded(!isExpanded); }, size: size === exports.Size.xs ? exports.Size.sm : size, style: style === exports.TagStyle.Outline ? exports.ButtonStyle.Fill : exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }, { children: isExpanded ? translateCommon('showLess') : "".concat(translateCommon('show'), " +").concat(hiddenCount) })))] })));
}
...
function TopNav(_a) {
    ...
    var renderItems = function (items) {
        return items.map(function (_a) {
            ...
            return (jsxRuntime.jsx("li", __assign({ "aria-hidden": ariaHidden, className: classNames('top-nav__item', itemClassName), style: style }, { children: itemChildren }), id));
        });
    };
    return (jsxRuntime.jsxs("nav", __assign({ "aria-label": ariaLabel, className: classNames('top-nav', className), ref: ref }, { children: [jsxRuntime.jsx("ul", __assign({ className: "top-nav__left-list" }, { children: renderItems(leftItems) })), jsxRuntime.jsx("ul", __assign({ className: "top-nav__right-list" }, { children: renderItems(rightItems) })), showLoadingIndicator && jsxRuntime.jsx(LoadingIndicatorProgressBar, {})] })));
}

var HIDDEN_CHIP_CSS_CLASS = 'multiselect__chip--hidden';
// eslint-disable-next-line complexity,max-statements
function MultiSelect(_a) {
    var changeCallback = _a.changeCallback, changeParams = _a.changeParams, className = _a.className, createOptions = _a.createOptions, dataState = _a.dataState, disabledKeys = _a.disabledKeys, expandedKeys = _a.expandedKeys, helpText = _a.helpText, isLoading = _a.isLoading, isRequired = _a.isRequired, isSkeleton = _a.isSkeleton, itemClassName = _a.itemClassName, items = _a.items, label = _a.label, menuWidth = _a.menuWidth, onBottomLoaderVisible = _a.onBottomLoaderVisible, onOpenChange = _a.onOpenChange, ref = _a.ref, renderItemContent = _a.renderItemContent, _b = _a.selectedItemStyle, selectedItemStyle = _b === void 0 ? exports.SelectedItemStyle.text : _b, showHelpTextIcon = _a.showHelpTextIcon, _c = _a.size, size = _c === void 0 ? exports.Size.md : _c, tooltipContent = _a.tooltipContent, props = __rest(_a, ["changeCallback", "changeParams", "className", "createOptions", "dataState", "disabledKeys", "expandedKeys", "helpText", "isLoading", "isRequired", "isSkeleton", "itemClassName", "items", "label", "menuWidth", "onBottomLoaderVisible", "onOpenChange", "ref", "renderItemContent", "selectedItemStyle", "showHelpTextIcon", "size", "tooltipContent"]);
    var _d = reactAria.useFocusRing({ within: true, isTextInput: false }), focusProps = _d.focusProps, isFocused = _d.isFocused, isFocusVisible = _d.isFocusVisible;
    var _e = reactAria.useHover(props), hoverProps = _e.hoverProps, isHovered = _e.isHovered;
    var isDisabled = props.isDisabled;
    ...
    var _g = react.useState(0), dynamicMenuWidth = _g[0], setDynamicMenuWidth = _g[1];
    var _h = react.useState(''), inputValue = _h[0], setInputValue = _h[1];
    var _j = react.useState(selectedItemsFromProps ? __spreadArray([], selectedItemsFromProps, true) : []), selectedItems = _j[0], setSelectedItems = _j[1];
    var _k = react.useState(0), hiddenSelectedItemsCount = _k[0], setHiddenSelectedItemsCount = _k[1];
    ...
    var prevSelectedCountRef = react.useRef(selectedItems.length);
    var listBoxRef = react.useRef(null);
    var boxRef = react.useRef(null);
    var chipsRef = react.useRef(null);
    var otherSelectCountRef = react.useRef(null);
    var inputRef = react.useRef(null);
    var popoverRef = react.useRef(null);
    var localFilter = reactAria.useFilter({ sensitivity: 'base' });
    var translateCommon = useTranslateCommon();
    var _o = react.useState(null), filteredItems = _o[0], setFilteredItems = _o[1];
    var itemsToRender = (filteredItems !== null && filteredItems !== void 0 ? filteredItems : items).slice();
    if (inputValue &&
        createOptions &&
        ...
        itemsToRender.push({ value: exports.SpecialSelectItemKey.CREATABLE, text: inputValue });
    }
    var flatItems = createFlatSelectItemList(itemsToRender, true, expandedKeys);
    ...
    var _p = downshift.useMultipleSelection({
        ...
        onStateChange: function (changes) {
            ...
            switch (type) {
                ...
                case downshift.useMultipleSelection.stateChangeTypes.FunctionRemoveSelectedItem:
                    setSelectedItems(newSelectedItems);
                    if (type === downshift.useMultipleSelection.stateChangeTypes.FunctionRemoveSelectedItem) {
                        triggerChange(newSelectedItems);
                    }
                    break;
                case downshift.useMultipleSelection.stateChangeTypes.SelectedItemKeyDownNavigationPrevious:
                case downshift.useMultipleSelection.stateChangeTypes.SelectedItemKeyDownNavigationNext:
    ...
    var _q = downshift.useCombobox({
            ...
            switch (changeType) {
                ...
                case downshift.useCombobox.stateChangeTypes.ItemClick:
                    if (newSelectedItem) {
                        ...
                        if (newSelectedItem.value === exports.SpecialSelectItemKey.CREATABLE) {
                            onInputChange('', exports.InputChangeTriggerAction.Input);
                            safeCall(createOptions === null || createOptions === void 0 ? void 0 : createOptions.onCreate, newSelectedItem);
                        }
                    }
                    break;
                case downshift.useCombobox.stateChangeTypes.InputChange:
                    onInputChange(newInputValue, exports.InputChangeTriggerAction.Input);
                    break;
                case downshift.useCombobox.stateChangeTypes.InputKeyDownEscape:
                case downshift.useCombobox.stateChangeTypes.InputBlur:
        ...
        onIsOpenChange: function (changes) {
            ...
            if (isMenuOpen) {
                onInputChange('', exports.InputChangeTriggerAction.Focus);
                updateMenuWidth();
            }
            else {
                setFilteredItems(null);
    ...
    var _loop_1 = function (i) {
        var item = selectedItems[i];
        var content = void 0;
        if (selectedItemStyle === exports.SelectedItemStyle.tag) {
            content = (jsxRuntime.jsx(Tag, __assign({ isDisabled: isReadOnly || isDisabled, onRemove: function () {
                ...
                }, size: size === exports.Size.md ? exports.Size.sm : size, style: exports.TagStyle.Fill }, { children: item.text })));
        }
        else {
            content = jsxRuntime.jsx(Label, __assign({ size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: item.text }));
        }
        ...
        selectedItemNodes.push(react.createElement(MultiSelectChip, __assign({}, chipProps, { displayStyle: selectedItemStyle, key: item.value }), content));
    };
    ...
    utils.useResizeObserver({ ref: boxRef, onResize: onResize });
    ...
    var inputProps = getInputProps(__assign(__assign({}, getDropdownProps({ preventKeyAction: false, ref: inputRef }, { suppressRefError: true })), { disabled: isReadOnly || isDisabled, 
        // Workaround to cursor jump issue: https://github.com/downshift-js/downshift/issues/1108
        onChange: function (e) {
            onInputChange(e.target.value, exports.InputChangeTriggerAction.Input);
        } }), { suppressRefError: true });
    ...
    var renderCreateText = function (itemText) {
        ...
        return getTextNode ?
            ...
            : jsxRuntime.jsxs(jsxRuntime.Fragment, { children: ["".concat(translateCommon('create'), " "), "\"", jsxRuntime.jsx("strong", { children: itemText }), "\""] });
    };
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-multiselect", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Provider, __assign({ values: [
            [reactAriaComponents.LabelContext, __assign({}, labelProps)],
            [reactAriaComponents.TextContext, { slots: { description: helpTextProps } }]
        ] }, { children: jsxRuntime.jsxs("div", __assign({ className: classNames('multiselect', className), ref: ref }, { children: [jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: size === exports.Size.xs ? exports.Size.sm : exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsxs("div", __assign({}, hoverProps, { className: "multiselect__box multiselect__box--".concat(size), "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-hovered": isHovered || undefined, "data-invalid": hasError || undefined, "data-readonly": isReadOnly || undefined, ref: boxRef }, { children: [jsxRuntime.jsxs("div", __assign({ className: "multiselect__box-start" }, { children: [isFocused && !isReadOnly && (jsxRuntime.jsx(Icon, { className: "multiselect__search-icon", name: iconNames.MagnifyingGlass })), selectedItemsLen > 0 && (jsxRuntime.jsx("div", __assign({}, (isFocused && focusProps), { className: "multiselect__chips", ref: chipsRef }, { children: selectedItemNodes }))), (!isFocused || isReadOnly) && (jsxRuntime.jsx(Label, __assign({ className: "multiselect__other-selected-count", ref: otherSelectCountRef, size: size === exports.Size.xs ? exports.Size.md : exports.Size.lg }, { children: hiddenSelectedItemsCount > 0 && "+".concat(hiddenSelectedItemsCount) }))), jsxRuntime.jsx("input", __assign({}, focusProps, inputProps, fieldProps, { "aria-label": props['aria-label'], className: classNames('multiselect__input', size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS), disabled: isDisabled, onBlur: reactAria.chain(focusProps.onBlur, inputProps.onBlur), onKeyDown: onKeyDown, placeholder: placeholder, readOnly: isReadOnly, size: 2 }))] })), jsxRuntime.jsxs("div", __assign({ className: "multiselect__action-buttons" }, { children: [!isOpen && !isDisabled && !isReadOnly && selectedItemsLen > 0 && (jsxRuntime.jsx(ClearButton, __assign({}, focusProps, { className: "multiselect__clear-button", onPress: clearSelectedItems }))), jsxRuntime.jsx("button", __assign({}, toggleButtonProps, { "aria-label": translateCommon('toggleMenu'), className: "multiselect__button" }, { children: jsxRuntime.jsx(Icon, { className: "multiselect__button-icon", name: isOpen ? iconNames.ExpandLessFilled : iconNames.ExpandMoreFilled }) }))] }))] })) })), jsxRuntime.jsx(reactAriaComponents.Popover, __assign({ className: "multiselect__popover", isNonModal: true, isOpen: isOpen, maxHeight: 280, placement: "bottom left", ref: popoverRef, shouldFlip: true, style: { width: menuWidth !== null && menuWidth !== void 0 ? menuWidth : dynamicMenuWidth }, triggerRef: boxRef }, { children: jsxRuntime.jsxs("div", __assign({}, listBoxProps, { className: "multiselect__listbox" }, { children: [(itemsToRender.length === 0 || itemsToRender[0].value === exports.SpecialSelectItemKey.CREATABLE) &&
                                !isLoading && jsxRuntime.jsx(SelectOptionsEmptyState, { size: size }, "empty"), renderMultiSelectItems({
                                createText: renderCreateText,
                                disabledKeys: disabledKeys,
                                expandedKeys: expandedKeys,
                                getItemProps: getItemProps,
...
function TextFieldUnit(_a) {
    var children = _a.children, id = _a.id, ref = _a.ref, _b = _a.size, size = _b === void 0 ? exports.Size.lg : _b;
    return (jsxRuntime.jsx(Label, __assign({ className: "text-field__unit", id: id, ref: ref, size: size }, { children: children })));
}
...
function TextField(_a) {
    ...
    var inputRef = react.useRef(null);
    var _h = react.useState(value), stateValue = _h[0], setStateValue = _h[1];
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var currentValue = isControlled ? value : stateValue;
    var prefixId = react.useId();
    var suffixId = react.useId();
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-text-field", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.TextField, __assign({}, props, { "aria-labelledby": ariaLabelledBy, className: classNames('text-field', className), isInvalid: hasError, isReadOnly: isReadOnly, onBlur: reactAria.chain(onBlur, changeParamsCb), onChange: onChangeInner, value: currentValue }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: size === exports.Size.xs ? exports.Size.sm : exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsxs("div", __assign({}, hoverProps, { className: classNames("text-field__content text-field__content--".concat(size), {
                    'text-field__content--filled': !isEmptyString(currentValue),
                    'text-field__content--plain': isPlain
                }), "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-hovered": isHovered || undefined, "data-invalid": !!hasError || undefined, "data-readonly": !!isReadOnly || undefined }, { children: [jsxRuntime.jsx(Part, { content: prefix, id: prefixId, inputRef: inputRef, isDisabled: isDisabled, isReadOnly: isReadOnly, size: size }), jsxRuntime.jsxs("div", __assign({ className: "text-field__input" }, { children: [startIconName && jsxRuntime.jsx(Icon, { className: "text-field__icon", name: startIconName }), jsxRuntime.jsx(reactAriaComponents.Input, __assign({}, focusProps, { className: classNames('text-field__input-field', size === exports.Size.xs ? LABEL_SIZE_MD_CSS_CLASS : LABEL_SIZE_LG_CSS_CLASS, {
                                    'text-field__input-field--right-aligned': textAlign === exports.Alignment.end
                                }, {
                                    'text-field__input-field--center-aligned': textAlign === exports.Alignment.center
                                }), "data-testid": dataTestId, max: maxValue, min: minValue, placeholder: placeholder, ref: inputRef, size: inputSize })), endIconName && jsxRuntime.jsx(Icon, { className: "text-field__icon", name: endIconName })] })), jsxRuntime.jsx(Part, { content: suffix, id: suffixId, inputRef: inputRef, isDisabled: isDisabled, isReadOnly: isReadOnly, size: size })] })) })) })));
}
...
function PhoneNumberField(_a) {
    ...
    var items = react.useMemo(function () { return getCountryCallingCodeItems(favoriteCountryCodes); }, [favoriteCountryCodes]);
    ...
    var onPrefixChange = react.useCallback(function (changedValue) {
    ...
    var onPhoneNumberChange = react.useCallback(function (args) {
        changeCallback(__assign(__assign({}, args), { value: prefix + args.value }));
    }, [prefix]);
    return (jsxRuntime.jsxs("div", __assign({ className: "phone-number-field", ref: ref }, { children: [jsxRuntime.jsx(Select, { dataState: dataState, isDisabled: isDisabled, isReadOnly: isReadOnly, isRequired: isRequired, isSkeleton: isSkeleton, items: items, label: prefixLabel, onSelectionChange: onPrefixChange, text: text, value: val }), jsxRuntime.jsx(TextField, { changeCallback: onPhoneNumberChange, changeParams: changeParams, dataState: dataState, isDisabled: isDisabled, isReadOnly: isReadOnly, isRequired: isRequired, isSkeleton: isSkeleton, label: label, size: exports.Size.md, type: "tel", value: phoneNumberValue })] })));
}

function Radio(_a) {
    var className = _a.className, helpText = _a.helpText, isSkeleton = _a.isSkeleton, label = _a.label, _b = _a.labelPlacement, labelPlacement = _b === void 0 ? exports.LabelPlacement.End : _b, _c = _a.size, size = _c === void 0 ? exports.Size.sm : _c, props = __rest(_a, ["className", "helpText", "isSkeleton", "label", "labelPlacement", "size"]);
    var radioGroupState = react.useContext(reactAriaComponents.RadioGroupStateContext);
    var labelSize = size === exports.Size.md ? exports.Size.lg : exports.Size.md;
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonCheckbox, { className: "skeleton-radio", hasHelpText: !!helpText, size: size });
    }
    var content = [];
    var button = jsxRuntime.jsx("div", { className: "radio__button radio__button--".concat(size) }, "button");
    if (label) {
        var buttonAndLabels = [];
        var labelNode = (jsxRuntime.jsx(Label, __assign({ className: "radio__label", size: labelSize }, { children: label }), "label"));
        ...
        if (helpText) {
            ...
            if (labelPlacement === exports.LabelPlacement.End) {
                // needed to align the label and helpText in grid
                buttonAndLabels.push(jsxRuntime.jsx("div", {}, "buttonPlaceholder"));
            }
            buttonAndLabels.push(jsxRuntime.jsx(HelpText, __assign({ variant: helpVariant }, { children: helpContent }), "helpText"));
        }
        content.push(jsxRuntime.jsx("div", __assign({ className: wrapperClass }, { children: buttonAndLabels }), "buttonAndLabel"));
    }
    else {
        content.push(button);
    }
    return (jsxRuntime.jsx(reactAriaComponents.Radio, __assign({}, props, { className: classNames('radio', className, {
            'radio--labeled': !!label,
            'radio--reversed': !!label && labelPlacement === exports.LabelPlacement.Start
        }) }, { children: content })));
}
...
function RadioGroup(_a) {
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-radio-group", hasHelpText: hasAnyHelpText, hasLabel: !!label, inputRectHeight: size === exports.Size.md ? '5.5rem' : '4.75rem', size: fieldSize }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.RadioGroup, __assign({}, props, { className: classNames('radio-group', className), isDisabled: isDisabled, isInvalid: hasError, isReadOnly: isReadOnly, isRequired: isRequired, onChange: onChange !== null && onChange !== void 0 ? onChange : changeParamsCb }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: isInvalid, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: fieldSize, tooltipContent: tooltipContent }, { children: mappedChildren })) })));
}
...
var HeadingExtension = BaseHeading.configure({
    ...
    renderHTML: function (_a) {
        ...
        return ["h".concat(level), react$1.mergeAttributes(this.options.HTMLAttributes, HTMLAttributes), 0];
    }
});
...
function TextFieldVisibilityToggle(_a) {
    ...
    react.useImperativeHandle(outerRef, function () { return ref.current; }, []);
    return (jsxRuntime.jsxs("div", __assign({}, buttonProps, { className: "text-field__action", ref: ref }, { children: [jsxRuntime.jsx(Icon, { name: isVisible ? iconNames.VisibilityOff : iconNames.Visibility }), jsxRuntime.jsx(Label, __assign({ size: exports.Size.lg }, { children: translateCommon(isVisible ? 'hide' : 'show') }))] })));
}

function PasswordField(_a) {
    var showVisibilityToggle = _a.showVisibilityToggle, props = __rest(_a, ["showVisibilityToggle"]);
    var _b = react.useState(exports.InputType.password), type = _b[0], setType = _b[1];
    var onToggle = function () {
        setType(type === exports.InputType.password ? exports.InputType.text : exports.InputType.password);
    };
    var suffix = showVisibilityToggle ?
        function () { return jsxRuntime.jsx(TextFieldVisibilityToggle, { isVisible: type !== exports.InputType.password, onPress: onToggle }); }
        : undefined;
    return jsxRuntime.jsx(TextField, __assign({}, props, { suffix: suffix, type: type }));
}
...
function TextFieldCopy(_a) {
    ...
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isOpen: showTooltip }, { children: [jsxRuntime.jsxs(TriggerElement, __assign({ className: "text-field__action", elementType: exports.HTMLElementType.Div, onPress: onPress, ref: ref }, { children: [jsxRuntime.jsx(Icon, { name: iconNames.CopyAll }), jsxRuntime.jsx(Label, __assign({ size: exports.Size.lg }, { children: translateCommon('copy') }))] })), jsxRuntime.jsx(Tooltip, __assign({ position: exports.Position.Bottom, showArrow: false, type: exports.TooltipType.Plain }, { children: translateCommon('copied') }))] })));
}

function TextFieldSelect(props) {
    return jsxRuntime.jsx(Select, __assign({}, props, { className: "text-field__select", isPlain: true, isSearchable: false, menuWidth: "auto" }));
}

function InlineTextField(_a) {
    var dataState = _a.dataState, outerRef = _a.ref, _b = _a.size, size = _b === void 0 ? exports.Size.xs : _b, validate = _a.validate, value = _a.value, props = __rest(_a, ["dataState", "ref", "size", "validate", "value"]);
    ...
    var _d = react.useState(value), stateValue = _d[0], setStateValue = _d[1];
    var _e = react.useState(false), isFocused = _e[0], setIsFocused = _e[1];
    var _f = react.useState({ isInvalid: hasError, errorText: errorMessage }), validationState = _f[0], setValidationState = _f[1];
    ...
    return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isOpen: isInvalid && isFocused }, { children: [jsxRuntime.jsx(TextField, __assign({}, props, { className: classNames(props.className, 'inline-text-field'), helpText: errorText, isInvalid: isInvalid, isPlain: true, isReadOnly: isReadOnly, onChange: onChange, onFocusChange: reactAria.chain(setIsFocused, props.onFocusChange), ref: ref, size: size, value: stateValue })), jsxRuntime.jsx(Tooltip, __assign({ className: "inline-text-field__error-tooltip", headerIconName: iconNames.EmergencyHomeFilled, headerText: translateCommon('error'), offset: 2, position: exports.Position.Left, triggerRef: ref, type: exports.TooltipType.Rich }, { children: errorText }))] })));
}

function RichTextEditorLinkDialog(_a) {
    var children = _a.children, onOpenChange = _a.onOpenChange;
    var editor = react$1.useCurrentEditor().editor;
    var _b = react.useState(''), selectedLinkText = _b[0], setSelectedLinkText = _b[1];
    var _c = react.useState(''), selectedLinkUrl = _c[0], setSelectedLinkUrl = _c[1];
    var translateCommon = useTranslateCommon();
    if (!editor) {
        return null;
    }
    return (jsxRuntime.jsxs(DialogTrigger, __assign({ onOpenChange: function (isOpen) {
            if (isOpen) {
            ...
            safeCall(onOpenChange, isOpen);
        } }, { children: [children, jsxRuntime.jsx(AlertModal, __assign({ primaryAction: {
                ...
                }, size: exports.Size.sm, title: translateCommon('addLink') }, { children: jsxRuntime.jsxs("div", __assign({ className: "link-modal__body" }, { children: [jsxRuntime.jsx(TextField, { autoFocus: !selectedLinkText, label: translateCommon('textToDisplay'), onChange: setSelectedLinkText, placeholder: translateCommon('enterDisplayText'), value: selectedLinkText }), jsxRuntime.jsx(TextField, { autoFocus: !!selectedLinkText, label: "URL", onChange: setSelectedLinkUrl, placeholder: "https://example.com/", value: selectedLinkUrl })] })) }))] })));
}
...
function ToolbarButton(_a) {
    ...
    return (jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(IconButton, { "aria-label": label, iconName: iconName, isDisabled: isDisabled, onPress: onPress, size: exports.Size.sm, style: isActive ? exports.ButtonStyle.Fill : exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: label }))] }));
}
...
function RichTextEditorToolbar(_a) {
    ...
    var variableMenuItems = react.useMemo(function () { return (variables ? variables.map(function (_a) {
    ...
    if (heading) {
        ...
        actionNodes.push(jsxRuntime.jsx(Select, { "aria-label": translateFormatting('textStyle'), className: "text-editor-toolbar__heading-select", isDisabled: isDisabled, isPlain: true, isSearchable: false, items: headingItems, menuWidth: '14rem', onSelectionChange: function (value) {
                if (!value) {
                    return;
                }
                editor
                ...
                return (jsxRuntime.jsx(SelectOptionContent, __assign({}, optionContentProps, { label: jsxRuntime.jsx("span", __assign({ className: headingClass ? headingClass : LABEL_SIZE_LG_CSS_CLASS }, { children: text })) })));
            }, size: exports.Size.xs, text: activeHeadingItem_1.text, value: activeHeadingItem_1.value }, "h"));
    }
    if (actionNodes.length > 0 && (bold || italic || underline)) {
        actionNodes.push(jsxRuntime.jsx(Divider, { orientation: exports.Orientation.vertical, size: exports.Size.sm }, "d1"));
    }
    if (bold) {
        actionNodes.push(jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.TextB, isActive: editor.isActive('bold'), isDisabled: isDisabled, label: translateFormatting('bold'), onPress: function () { return editor.chain().focus().toggleBold().run(); } }, "b"));
    }
    if (italic) {
        actionNodes.push(jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.TextItalic, isActive: editor.isActive('italic'), isDisabled: isDisabled, label: translateFormatting('italic'), onPress: function () { return editor.chain().focus().toggleItalic().run(); } }, "i"));
    }
    if (underline) {
        actionNodes.push(jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.TextUnderline, isActive: editor.isActive('underline'), isDisabled: isDisabled, label: translateFormatting('underline'), onPress: function () { return editor.chain().focus().toggleUnderline().run(); } }, "u"));
    }
    if (actionNodes.length > 0 && (orderedList || bulletList)) {
        actionNodes.push(jsxRuntime.jsx(Divider, { orientation: exports.Orientation.vertical, size: exports.Size.sm }, "d2"));
    }
    if (orderedList) {
        actionNodes.push(jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.FormatListNumbers, isActive: editor.isActive('orderedList'), isDisabled: isDisabled, label: translateFormatting('numberedList'), onPress: function () { return editor.chain().focus().toggleOrderedList().run(); } }, "ol"));
    }
    if (bulletList) {
        actionNodes.push(jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.FormatListBullets, isActive: editor.isActive('bulletList'), isDisabled: isDisabled, label: translateFormatting('bulletList'), onPress: function () { return editor.chain().focus().toggleBulletList().run(); } }, "ul"));
    }
    if (actionNodes.length > 0 && link) {
        actionNodes.push(jsxRuntime.jsx(Divider, { orientation: exports.Orientation.vertical, size: exports.Size.sm }, "d3"));
    }
    if (link) {
        actionNodes.push(jsxRuntime.jsx(RichTextEditorLinkDialog, __assign({ onOpenChange: onModalOpenChange }, { children: jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.LinkAlt, isActive: editor.isActive('link'), isDisabled: isDisabled, label: translateFormatting('link') }) }), "a"));
    }
    if (actionNodes.length > 0 && (variableMenuItems === null || variableMenuItems === void 0 ? void 0 : variableMenuItems.length)) {
        actionNodes.push(jsxRuntime.jsx(Divider, { orientation: exports.Orientation.vertical, size: exports.Size.sm }, "d4"));
    }
    if (variableMenuItems === null || variableMenuItems === void 0 ? void 0 : variableMenuItems.length) {
        actionNodes.push(jsxRuntime.jsx(Menu, __assign({ items: variableMenuItems, onAction: function (key) {
            ...
            } }, { children: jsxRuntime.jsx(ToolbarButton, { iconName: iconNames.Variables, isDisabled: isDisabled, label: translateCommon('variable') }) }), "var"));
    }
    return (jsxRuntime.jsx("div", __assign({ "aria-controls": editor.view.dom.id, "aria-label": translateFormatting('textFormatting'), className: "text-editor-toolbar", role: "toolbar" }, { children: actionNodes })));
}
...
function RichTextEditorLinkPreview(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "text-editor__link-preview" }, { children: [jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: translateCommon('visitURL') })), jsxRuntime.jsx("a", __assign({ className: "text-editor__link ".concat(LABEL_SIZE_MD_CSS_CLASS), href: url, rel: "noopener noreferrer nofollow", target: "_blank", title: url }, { children: url })), jsxRuntime.jsx(RichTextEditorLinkDialog, __assign({ onOpenChange: onOpenChange }, { children: jsxRuntime.jsx(Button, __assign({ size: exports.Size.md, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('edit') })) })), jsxRuntime.jsx(Divider, { orientation: exports.Orientation.vertical, size: exports.Size.sm }), jsxRuntime.jsx(Button, __assign({ onPress: function () {
                    editor.chain().focus().extendMarkRange('link').unsetLink().run();
                }, size: exports.Size.md, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Danger }, { children: translateCommon('remove') }))] })));
}

function Variable(props) {
    return (jsxRuntime.jsxs(react$1.NodeViewWrapper, __assign({ as: exports.HTMLElementType.Span, className: "text-editor-variable" }, { children: [jsxRuntime.jsx(Icon, { name: iconNames.Variables, size: exports.IconSize.SM }), jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: props.node.attrs['data-label'] }) }))] })));
}
...
var VariableExtension = core.Node.create({
    ...
    addNodeView: function () {
        ...
        return react$1.ReactNodeViewRenderer(Variable, { className: 'text-editor-variable-wrapper' });
    },
    addOptions: function () {
        return {
            HTMLAttributes: {}
    ...
    renderHTML: function (_a) {
        ...
        return ['span', core.mergeAttributes({ 'data-type': this.name }, this.options.HTMLAttributes, HTMLAttributes)];
    },
...
function RichTextEditor(_a) {
    ...
    var _b = reactAria.useFocusRing({ within: true, isTextInput: false }), focusProps = _b.focusProps, isFocused = _b.isFocused, isFocusVisible = _b.isFocusVisible;
    var prevIsFocusedRef = react.useRef(false);
    ...
    var toolbarConfig = react.useMemo(function () { return (__assign(__assign({}, DEFAULT_TOOLBAR_CONFIG), propsToolbarConfig)); }, [propsToolbarConfig]);
    var showToolbar = react.useMemo(function () { return isToolbarVisible(toolbarConfig); }, [toolbarConfig]);
    var _e = reactAria.useLabel({ label: label, 'aria-label': props['aria-label'] }), fieldProps = _e.fieldProps, labelProps = _e.labelProps;
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-text-editor", hasHelpText: hasAnyHelpText, hasLabel: !!label, inputRectHeight: 148, size: exports.Size.md, style: { minWidth: '21rem' } }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.Provider, __assign({ values: [
            [reactAriaComponents.LabelContext, labelProps],
            [reactAriaComponents.TextContext, { slots: { description: helpTextProps } }]
        ] }, { children: jsxRuntime.jsx("div", __assign({ className: classNames('text-editor-field', className), ref: ref }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsx("div", __assign({}, focusProps, { className: "text-editor-wrapper", "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-invalid": !!hasError || undefined, "data-readonly": !!isReadOnly || undefined }, { children: jsxRuntime.jsx(react$1.EditorProvider, __assign({ editable: isEditable, editorProps: {
                            ...
                            Link$1.extend({ inclusive: false }).configure({
                                openOnClick: false,
                            ...
                            jsxRuntime.jsxs("div", __assign({ className: "text-editor-toolbar-wrapper" }, { children: [jsxRuntime.jsx(RichTextEditorToolbar, { config: toolbarConfig, isDisabled: !isEditable, onModalOpenChange: onModalOpenChange }), jsxRuntime.jsx(Divider, { size: exports.Size.sm })] }))
                            : null }, { children: jsxRuntime.jsx(react$1.BubbleMenu, __assign({ className: "text-editor__link-menu", editor: null, shouldShow: function (_a) {
                                var editor = _a.editor;
                                return !!editor.getAttributes('link').href && editor.isFocused;
                            }, tippyOptions: {
                                maxWidth: 400,
                                placement: 'bottom'
                            }, updateDelay: 50 }, { children: jsxRuntime.jsx(RichTextEditorLinkPreview, { onOpenChange: onModalOpenChange }) })) })) })) })) })) })));
}

exports.SliderValueDisplayMode = void 0;
...
})(exports.SliderValueDisplayMode || (exports.SliderValueDisplayMode = {}));
...
function Slider(_a) {
    var changeCallback = _a.changeCallback, changeParams = _a.changeParams, className = _a.className, helpText = _a.helpText, isDisabled = _a.isDisabled, isSkeleton = _a.isSkeleton, label = _a.label, _b = _a.labelPosition, labelPosition = _b === void 0 ? exports.Position.Top : _b, _c = _a.maxValue, maxValue = _c === void 0 ? DEFAULT_MAX_VALUE : _c, _d = _a.minDistance, minDistance = _d === void 0 ? DEFAULT_MIN_DISTANCE : _d, _e = _a.minValue, minValue = _e === void 0 ? DEFAULT_MIN_VALUE : _e, onChange = _a.onChange, showFill = _a.showFill, showHelpTextIcon = _a.showHelpTextIcon, textFieldAriaLabels = _a.textFieldAriaLabels, _f = _a.tooltipPosition, tooltipPosition = _f === void 0 ? exports.Position.Top : _f, value = _a.value, _g = _a.valueDisplayMode, valueDisplayMode = _g === void 0 ? exports.SliderValueDisplayMode.Label : _g, _h = _a.valueTextFieldWidth, valueTextFieldWidth = _h === void 0 ? DEFAULT_TEXT_FIELD_WIDTH : _h, props = __rest(_a, ["changeCallback", "changeParams", "className", "helpText", "isDisabled", "isSkeleton", "label", "labelPosition", "maxValue", "minDistance", "minValue", "onChange", "showFill", "showHelpTextIcon", "textFieldAriaLabels", "tooltipPosition", "value", "valueDisplayMode", "valueTextFieldWidth"]);
    var _j = react.useState({
        focusedIndex: -1,
        focusedValue: ''
    }), focusedTextFieldValueAndIndex = _j[0], setFocusedTextFieldValueAndIndex = _j[1];
    var _k = react.useState(false), hasSliderTrackHover = _k[0], setHasSliderTrackHover = _k[1];
    var _l = react.useState(false), hasSliderThumbHoverOrFocus = _l[0], setHasSliderThumbHoverOrFocus = _l[1];
    var _m = react.useState(value !== null && value !== void 0 ? value : 0), sliderValue = _m[0], setSliderValue = _m[1];
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var onChangeEnd = reactAria.chain(props.onChangeEnd, changeParamsCb);
    var higherValueThumbRef = react.useRef(null);
    var lowerValueThumbRef = react.useRef(null);
    var sliderTrackRef = react.useRef(null);
    var isRangeSlider = isArray(sliderValue);
    var hasValueRight = valueDisplayMode === exports.SliderValueDisplayMode.TextField ||
        (labelPosition === exports.Position.Left && valueDisplayMode === exports.SliderValueDisplayMode.Label);
    react.useEffect(function () {
    ...
    var onTextFieldKeyUp = function (index, event) {
        if (event.key === exports.KeyboardEventKey.Enter) {
    ...
    var renderTextFields = function (state) {
        ...
        return values.map(function (_, index) { return (jsxRuntime.jsx(TextField, { "aria-label": ariaLabels.length > index ? ariaLabels[index] : props['aria-label'], changeCallback: function (changeArgs) {
                onTextFieldValueChange(index, changeArgs, true, true);
                resetFocusedTextFieldValueAndIndex();
            }, className: classNames('slider__text-field', { 'slider__second-text-input-label': index !== 0 }), isControlled: true, isDisabled: isDisabled, onChange: function (val) { return onTextFieldValueChange(index, { value: val }, !isRangeSlider); }, onFocus: function (event) { return onTextFieldFocused(index, event); }, onKeyUp: function (event) { return onTextFieldKeyUp(index, event); }, size: exports.Size.xs, style: { width: valueTextFieldWidth }, textAlign: exports.Alignment.center, type: exports.InputType.number, value: focusedIndex === index ? focusedValue : (state.getFormattedValue(state.getThumbValue(index)).replace(',', '')) }, index)); });
    };
    var renderValue = function () {
        if (valueDisplayMode === exports.SliderValueDisplayMode.TextField) {
            return (jsxRuntime.jsx(reactAriaComponents.SliderOutput, { children: function (_a) {
                    var state = _a.state;
                    return (jsxRuntime.jsx("div", __assign({ className: "slider__value_label_container" }, { children: renderTextFields(state) })));
                } }));
        }
        return (jsxRuntime.jsx(reactAriaComponents.SliderOutput, __assign({ className: "slider__value-label" }, { children: function (_a) {
                var state = _a.state;
                return jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: getValueLabel(state) }));
            } })));
    };
    if (isSkeleton) {
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-slider", hasHelpText: !!helpText, hasLabel: !!label, inputRectHeight: 20, size: exports.Size.md }));
    }
    return (jsxRuntime.jsxs(reactAriaComponents.Slider, __assign({}, props, { className: classNames('slider', className), isDisabled: isDisabled, maxValue: maxValue, minValue: minValue, onChange: onSliderThumbValueChange, onChangeEnd: onChangeEnd, orientation: "horizontal", value: sliderValue }, { children: [labelPosition === exports.Position.Top && (jsxRuntime.jsxs("div", __assign({ className: "slider__top-content" }, { children: [jsxRuntime.jsx(Label, __assign({ className: "slider__label", size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: label }) })), valueDisplayMode === exports.SliderValueDisplayMode.Label && renderValue()] }))), jsxRuntime.jsxs("div", __assign({ className: "slider__content" }, { children: [labelPosition === exports.Position.Left && (jsxRuntime.jsx(Label, __assign({ className: "slider__label", size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: label }) }))), jsxRuntime.jsx("div", __assign({ className: "slider__track-wrapper" }, { children: jsxRuntime.jsx(reactAriaComponents.SliderTrack, __assign({ className: "slider__track-content", onHoverChange: setHasSliderTrackHover, ref: sliderTrackRef }, { children: function (_a) {
                                var state = _a.state;
                                return (jsxRuntime.jsxs("div", __assign({ className: "slider__track-container" }, { children: [jsxRuntime.jsx("div", { className: "slider__track" }), jsxRuntime.jsx("div", { className: "slider__track-fill", style: getTrackFillWidthAndPositionStyle(state) }), state.values.map(function (_, index) { return (jsxRuntime.jsxs(TooltipTrigger, __assign({ isOpen: hasSliderTrackHover ||
                                                hasSliderThumbHoverOrFocus ||
                                                state.values.some(function (__, i) { return state.isThumbDragging(i); }) }, { children: [jsxRuntime.jsx(reactAriaComponents.SliderThumb, __assign({ className: "slider__track-thumb", index: index, onFocusChange: setHasSliderThumbHoverOrFocus, onHoverChange: setHasSliderThumbHoverOrFocus, ref: index === 0 ? lowerValueThumbRef : higherValueThumbRef, style: getThumbZIndexStyle(state, index) }, { children: jsxRuntime.jsx("div", { className: "slider__track-thumb-inner-circle" }) }), index), valueDisplayMode === exports.SliderValueDisplayMode.Tooltip && (jsxRuntime.jsx(Tooltip, __assign({ position: tooltipPosition, triggerRef: index === 0 ? lowerValueThumbRef : higherValueThumbRef, type: exports.TooltipType.Plain }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: state.getThumbValue(index) }) })) })))] }), index)); })] })));
                            } })) })), hasValueRight && renderValue()] })), helpText && (jsxRuntime.jsx(HelpText, __assign({ showIcon: showHelpTextIcon, variant: isDisabled ? exports.HelpTextVariant.Disabled : undefined }, { children: helpText })))] })));
}
...
function TextArea(_a) {
    ...
    var _f = react.useState(value), stateValue = _f[0], setStateValue = _f[1];
    var inputRef = react.useRef(null);
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var currentValue = isControlled ? value : stateValue;
    var onChangeInner = function (val) {
    ...
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-textarea-field", hasHelpText: hasAnyHelpText, hasLabel: !!label, inputRectHeight: minHeight !== null && minHeight !== void 0 ? minHeight : '134px', size: exports.Size.md, style: { minWidth: '225px' } }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.TextField, __assign({}, props, { className: classNames('textarea-field', className), "data-testid": dataTestId, isInvalid: hasError, isReadOnly: isReadOnly, onBlur: reactAria.chain(onBlur, changeParamsCb), onChange: onChangeInner, value: currentValue }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: hasError, isRequired: isRequired, label: label, labelSuffix: isNullOrUndefined(maxLength) ? null : (jsxRuntime.jsx(BodyText, __assign({ className: "textarea-field__letter-count", size: exports.Size.xs }, { children: "".concat(currentValue.length, "/").concat(maxLength) }))), showHelpTextIcon: showHelpTextIcon, size: exports.Size.md, tooltipContent: tooltipContent }, { children: jsxRuntime.jsx("div", __assign({}, hoverProps, { className: "textarea-field__content", "data-disabled": !!isDisabled || undefined, "data-focus-visible": isFocusVisible || undefined, "data-focused": isFocused || undefined, "data-hovered": isHovered || undefined, "data-invalid": !!hasError || undefined, "data-readonly": !!isReadOnly || undefined }, { children: jsxRuntime.jsx("div", __assign({ className: "textarea-field__textarea-wrap" }, { children: jsxRuntime.jsx(reactAriaComponents.TextArea, __assign({}, focusProps, { className: classNames('textarea-field__textarea', LABEL_SIZE_LG_CSS_CLASS), placeholder: placeholder, ref: inputRef, rows: rows, style: { minHeight: minHeight } })) })) })) })) })));
}

function ToggleButton(_a) {
    var changeCallback = _a.changeCallback, changeParams = _a.changeParams, className = _a.className, dataState = _a.dataState, helpText = _a.helpText, helpTextSuccess = _a.helpTextSuccess, isDisabled = _a.isDisabled, isInvalid = _a.isInvalid, isRequired = _a.isRequired, isSkeleton = _a.isSkeleton, items = _a.items, label = _a.label, onChange = _a.onChange, showHelpTextIcon = _a.showHelpTextIcon, _b = _a.size, size = _b === void 0 ? exports.Size.sm : _b, tooltipContent = _a.tooltipContent, props = __rest(_a, ["changeCallback", "changeParams", "className", "dataState", "helpText", "helpTextSuccess", "isDisabled", "isInvalid", "isRequired", "isSkeleton", "items", "label", "onChange", "showHelpTextIcon", "size", "tooltipContent"]);
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var _c = useDataState(dataState, isInvalid, props.isReadOnly), hasError = _c.hasError, isReadOnly = _c.isReadOnly, errorMessage = _c.errorMessage;
    var labelSize = size === exports.Size.xs ? exports.Size.sm : exports.Size.md;
    if (isSkeleton) {
        var hasAnyHelpText = !!errorMessage || !!helpTextSuccess || !!helpText;
        return (jsxRuntime.jsx(SkeletonField, { className: "skeleton-toggle-button", hasHelpText: hasAnyHelpText, hasLabel: !!label, size: size }));
    }
    return (jsxRuntime.jsx(reactAriaComponents.RadioGroup, __assign({}, props, { className: classNames("toggle-button toggle-button--".concat(size), className), isDisabled: isDisabled, isInvalid: hasError, isReadOnly: isReadOnly, isRequired: isRequired, onChange: reactAria.chain(onChange, changeParamsCb) }, { children: jsxRuntime.jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: isInvalid, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: labelSize, tooltipContent: tooltipContent }, { children: jsxRuntime.jsx("div", __assign({ className: "toggle-button__options" }, { children: items.map(function (_a) {
                    var isItemDisabled = _a.isDisabled, value = _a.value, text = _a.text;
                    return (jsxRuntime.jsx(reactAriaComponents.Radio, __assign({ className: "toggle-button__option", isDisabled: isItemDisabled, value: value }, { children: jsxRuntime.jsx(Label, __assign({ size: labelSize }, { children: text })) }), value));
                }) })) })) })));
}
...
function SwitchNob(_a) {
    ...
    var iconSize = size === exports.Size.sm ? SM_SIZE : MD_SIZE;
    return (jsxRuntime.jsx("svg", __assign({ "aria-hidden": true, className: className, fill: "none", height: iconSize, viewBox: "0 0 ".concat(iconSize, " ").concat(iconSize), width: iconSize }, { children: jsxRuntime.jsx("circle", { cx: iconSize / 2, cy: iconSize / 2, fill: "currentColor", r: iconSize / 2 }) })));
}

function ToggleSwitch(_a) {
    var changeCallback = _a.changeCallback, changeParams = _a.changeParams, className = _a.className, dataState = _a.dataState, dataTestId = _a.dataTestId, helpText = _a.helpText, isDisabled = _a.isDisabled, isInvalid = _a.isInvalid, isRequired = _a.isRequired, isSelected = _a.isSelected, isSkeleton = _a.isSkeleton, label = _a.label, _b = _a.labelPlacement, labelPlacement = _b === void 0 ? exports.LabelPlacement.End : _b, onChange = _a.onChange, _c = _a.size, size = _c === void 0 ? exports.Size.sm : _c, props = __rest(_a, ["changeCallback", "changeParams", "className", "dataState", "dataTestId", "helpText", "isDisabled", "isInvalid", "isRequired", "isSelected", "isSkeleton", "label", "labelPlacement", "onChange", "size"]);
    var _d = useDataState(dataState, isInvalid, props.isReadOnly), hasError = _d.hasError, isReadOnly = _d.isReadOnly, errorMessage = _d.errorMessage;
    var changeParamsCb = useChangeParamsCallback(changeParams, changeCallback);
    var helpTextId = react.useId();
    var labelSize = exports.Size.md;
    ...
    if (isSkeleton) {
        return (jsxRuntime.jsx(SkeletonCheckbox, { className: "skeleton-toggle-switch", hasHelpText: !!helpText || !!errorMessage, size: size }));
    }
    var content = [];
    if (isRequired) {
        content.push(jsxRuntime.jsx(RequiredIndicator, {}, "required"));
    }
    var toggleItem = (jsxRuntime.jsxs("div", __assign({ className: classNames("toggle-switch__toggle-item toggle-switch__toggle-item--".concat(size)) }, { children: [jsxRuntime.jsx(Icon, { "aria-hidden": true, className: "toggle-switch__check-icon", name: iconNames.InputCheck }), jsxRuntime.jsx(SwitchNob, { className: "toggle-switch__switch-nob-icon", size: size })] }), "toggleItem"));
    if (label) {
        var toggleItemAndLabels = [];
        var labelNode = (jsxRuntime.jsx(Label, __assign({ className: "toggle-switch__label", size: labelSize }, { children: label }), "label"));
        ...
        if (helpText || errorMessage) {
            ...
            if (labelPlacement === exports.LabelPlacement.End) {
                // needed to align the label and helpText in grid
                toggleItemAndLabels.push(jsxRuntime.jsx("div", {}, "toggleItemPlaceholder"));
            }
            toggleItemAndLabels.push(jsxRuntime.jsx(HelpText, __assign({ id: helpTextId, variant: helpVariant }, { children: helpContent }), "helpText"));
        }
        content.push(jsxRuntime.jsx("div", __assign({ className: wrapperClass }, { children: toggleItemAndLabels }), "toggleItemAndLabel"));
    }
    else {
        content.push(toggleItem);
    }
    return (jsxRuntime.jsx(reactAriaComponents.Switch, __assign({}, props, { "aria-describedby": mergeStrings(' ', helpTextId, props['aria-describedby']), className: classNames('toggle-switch', className, {
            'toggle-switch--invalid': hasError,
            'toggle-switch--labeled': !!label,
            'toggle-switch--reversed': !!label && labelPlacement === exports.LabelPlacement.Start
...
function useTreeSelect(_a) {
    ...
    var _c = react.useState((_b = propsExpandedKeys !== null && propsExpandedKeys !== void 0 ? propsExpandedKeys : defaultExpandedKeys) !== null && _b !== void 0 ? _b : new Set()), expandedKeys = _c[0], setExpandedKeys = _c[1];
    var _d = react.useState(new Set()), loadingKeys = _d[0], setLoadingKeys = _d[1];
    var _e = react.useState(null), filteredItems = _e[0], setFilteredItems = _e[1];
    ...
    var onToggleItem = react.useCallback(function (item) {
        var _a;
    ...
    var onKeyDown = react.useCallback(function (e, highlightedItem) {
        var continueFlow = safeCall(options.onKeyDown, e, highlightedItem);
        if (continueFlow === false) {
            return false;
        }
        switch (e.key) {
            case exports.KeyboardEventKey.ArrowLeft:
                if (highlightedItem) {
                    e.preventDefault();
                }
                ...
                return false;
            case exports.KeyboardEventKey.ArrowRight:
                if (highlightedItem) {
                    e.preventDefault();
                }
                if ((highlightedItem === null || highlightedItem === void 0 ? void 0 : highlightedItem.children) && !expandedKeys.has(highlightedItem.value)) {
    ...
    var onInputChange = react.useCallback(function (inputValue, inputChangeTrigger) {
        ...
        if (!options.onInputChange) {
            ...
            if (inputChangeTrigger === exports.InputChangeTriggerAction.Input) {
...
function TreeMultiSelect(_a) {
    ...
    var renderItemContent = function (optionContentProps) {
        ...
        return jsxRuntime.jsx(SelectOptionContent, __assign({}, treeOptionContentProps));
    };
    return (jsxRuntime.jsx(MultiSelect, __assign({}, props, { expandedKeys: expandedKeys, items: items, onInputChange: onInputChange, onKeyDown: onKeyDown, renderItemContent: renderItemContent })));
}
...
function TreeSelect(_a) {
    ...
    return (jsxRuntime.jsx(Select, __assign({}, props, { expandedKeys: expandedKeys, items: items, onInputChange: onInputChange, onKeyDown: onKeyDown, renderItemContent: renderItemContent })));
}

exports.UploadItemStyle = void 0;
(function (UploadItemStyle) {
    UploadItemStyle["Card"] = "card";
    UploadItemStyle["Plain"] = "plain";
})(exports.UploadItemStyle || (exports.UploadItemStyle = {}));
function UploadItem(props) {
    ...
    var translateProject = useTranslateProject();
    return (jsxRuntime.jsxs("div", __assign({ className: classNames("upload-item upload-item--".concat(style), className, {
            'upload-item--invalid': hasError,
            'upload-item--disabled': isDisabled
        }), ref: ref }, { children: [jsxRuntime.jsxs("div", __assign({ className: "upload-item__top" }, { children: [jsxRuntime.jsx(Icon, { className: "upload-item__icon", name: iconName, size: exports.IconSize.LG }), jsxRuntime.jsxs("div", __assign({ className: "upload-item__content" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "upload-item__heading" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "upload-item__texts" }, { children: [jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !tooltipText }, { children: [jsxRuntime.jsx(Button, __assign({ className: "upload-item__name", isDisabled: isDisabled, onPress: onNamePress, size: exports.Size.md, style: exports.ButtonStyle.Link, variant: hasError ? exports.ButtonVariant.Danger : exports.ButtonVariant.Neutral }, { children: name })), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: tooltipText }))] })), jsxRuntime.jsx(BodyText, __assign({ className: "upload-item__description", elementType: exports.HTMLElementType.Div, size: exports.Size.xs }, { children: description }))] })), isFunction(actions) ? actions(props) : actions] })), !isNullOrUndefined(uploadProgress) && (jsxRuntime.jsx(ProgressBar, { "aria-label": translateProject('progress'), value: uploadProgress, valueLabelPosition: exports.Position.Right }))] }))] })), showErrorMessage && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Divider, { size: exports.Size.sm }), jsxRuntime.jsx(HelpText, __assign({ variant: exports.HelpTextVariant.Danger }, { children: errorMsg }))] }))] })));
}

function DragHandle(_a) {
    var ariaLabel = _a["aria-label"], className = _a.className, props = __rest(_a, ['aria-label', "className"]);
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsx("button", __assign({}, props, { "aria-label": ariaLabel !== null && ariaLabel !== void 0 ? ariaLabel : translateCommon('move'), className: classNames('drag-handle', className) }, { children: jsxRuntime.jsx(Icon, { name: iconNames.DragIndicator, size: exports.IconSize.LG }) })));
}
...
function ColumnItem(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "column-item", ref: setNodeRef, style: style }, { children: [jsxRuntime.jsx(DragHandle, __assign({}, attributes, listeners, { disabled: !isDraggable })), jsxRuntime.jsx(Checkbox, { "aria-label": translateCommon('show'), isDisabled: isSelectable === false, isSelected: isSelected, onChange: onSelectedChange }), jsxRuntime.jsx(Label, __assign({ className: "column-item__label", size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: name }) }))] })));
}
...
exports.EmptyStateLayoutVariant = void 0;
...
})(exports.EmptyStateLayoutVariant || (exports.EmptyStateLayoutVariant = {}));
function EmptyState(_a) {
    var bodyText = _a.bodyText, buttonProps = _a.buttonProps, className = _a.className, iconName = _a.iconName, _b = _a.iconSize, iconSize = _b === void 0 ? exports.IconSize.XXL : _b, _c = _a.layout, layout = _c === void 0 ? exports.EmptyStateLayoutVariant.SideBySide : _c, ref = _a.ref, title = _a.title;
    var isLayoutCentered = layout === exports.EmptyStateLayoutVariant.Centered;
    var isLayoutSideBySide = layout === exports.EmptyStateLayoutVariant.SideBySide;
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('empty-state', className), ref: ref }, { children: [iconName && isLayoutSideBySide && (jsxRuntime.jsx(Icon, { className: "empty-state__icon empty-state__icon--side-by-side", name: iconName, size: iconSize })), jsxRuntime.jsxs("div", __assign({ className: classNames('empty-state__main-content', {
                    'empty-state__main-content--centered': isLayoutCentered
                }) }, { children: [iconName && !isLayoutSideBySide && (jsxRuntime.jsx(Icon, { className: "empty-state__icon", name: iconName, size: iconSize })), jsxRuntime.jsxs("div", __assign({ className: classNames('empty-state__text-content', {
                            'empty-state__text-content--centered': isLayoutCentered
                        }) }, { children: [jsxRuntime.jsx(Label, __assign({ className: "empty-state__title-text", size: exports.Size.lg }, { children: jsxRuntime.jsx("strong", { children: title }) })), jsxRuntime.jsx(BodyText, __assign({ className: classNames('empty-state__body-text', {
                                    'empty-state__body-text--centered': isLayoutCentered
                                }), size: exports.Size.sm }, { children: bodyText }))] })), (buttonProps === null || buttonProps === void 0 ? void 0 : buttonProps.onPress) && (buttonProps === null || buttonProps === void 0 ? void 0 : buttonProps.children) && (jsxRuntime.jsx(Button, __assign({}, buttonProps, { size: exports.Size.md }, { children: buttonProps.children })))] }))] })));
}

exports.ColumnConfiguratorVariant = void 0;
(function (ColumnConfiguratorVariant) {
    ColumnConfiguratorVariant["Basic"] = "basic";
    ColumnConfiguratorVariant["Extended"] = "extended";
})(exports.ColumnConfiguratorVariant || (exports.ColumnConfiguratorVariant = {}));
...
function ColumnConfigurator(_a) {
    var actions = _a.actions, columns = _a.columns, propsColumnOrder = _a.columnOrder, propsColumnVisibility = _a.columnVisibility, children = _a.children, onColumnOrderChange = _a.onColumnOrderChange, onColumnVisibilityChange = _a.onColumnVisibilityChange, _b = _a.variant, variant = _b === void 0 ? exports.ColumnConfiguratorVariant.Basic : _b;
    var _c = react.useState(false), isOpen = _c[0], setIsOpen = _c[1];
    var _d = react.useState(function () { return propsColumnOrder !== null && propsColumnOrder !== void 0 ? propsColumnOrder : columns.map(function (col) { return col.id; }); }), columnOrder = _d[0], setColumnOrder = _d[1];
    var _e = react.useState(propsColumnVisibility !== null && propsColumnVisibility !== void 0 ? propsColumnVisibility : {}), columnVisibility = _e[0], setColumnVisibility = _e[1];
    var columnsById = react.useMemo(function () {
        return columns.reduce(function (map, col) {
            map[col.id] = col;
            return map;
        }, {});
    }, [columns]);
    var selectedCount = react.useMemo(function () { return columnOrder.reduce(function (count, id) { return count + (isColumnSelected(id, columnVisibility) ? 1 : 0); }, 0); }, [columnVisibility, columnOrder]);
    var hiddenCount = react.useMemo(function () { return columns.reduce(function (count, col) { return count + (col.isHidden ? 1 : 0); }, 0); }, [columns]);
    var _f = react.useState(''), searchText = _f[0], setSearchText = _f[1];
    var filter = reactAria.useFilter({ sensitivity: 'base' });
    var translateCommon = useTranslateCommon();
    ...
    var onDragEnd = function (event) {
        ...
        if (activeId && overId && activeId !== overId) {
            ...
            var newColumnOrder = sortable.arrayMove(columnOrder, oldIndex, newIndex);
            setColumnOrder(newColumnOrder);
            safeCall(onColumnOrderChange, newColumnOrder);
        }
    };
    var onSearch = react.useCallback(debounce(setSearchText, SEARCH_DELAY), []);
    var sensors = core$1.useSensors(core$1.useSensor(core$1.MouseSensor, {}), core$1.useSensor(core$1.TouchSensor, {}), core$1.useSensor(core$1.KeyboardSensor, {
        coordinateGetter: sortable.sortableKeyboardCoordinates
    }));
    var filteredColumnOrder = react.useMemo(function () {
    ...
    var renderItems = function () {
        var columnItems = filteredColumnOrder.map(function (id) {
            var item = columnsById[id];
            return (jsxRuntime.jsx(ColumnItem, { isDraggable: !searchText, isSelected: isColumnSelected(id, columnVisibility), item: item, onSelectedChange: function (isSelected) {
                    var _a;
        ...
        if (columnItems.length === 0) {
            return (jsxRuntime.jsx(EmptyState, { bodyText: translateCommon('noColumnsFoundInfo'), title: translateCommon('noColumnsFound') }));
        }
        return (jsxRuntime.jsx(core$1.DndContext, __assign({ accessibility: {
                announcements: {
            ...
            }, collisionDetection: core$1.closestCenter, modifiers: [modifiers.restrictToParentElement, modifiers.restrictToVerticalAxis], onDragEnd: onDragEnd, sensors: sensors }, { children: jsxRuntime.jsx(sortable.SortableContext, __assign({ items: columnOrder, strategy: sortable.verticalListSortingStrategy }, { children: columnItems })) })));
    };
    react.useEffect(function () {
    ...
    react.useEffect(function () {
        if (isOpen) {
            liveAnnouncer.announce(translateCommon('columnsAvailable', { count: filteredColumnCount }));
        }
    ...
    var overlay;
    if (variant === exports.ColumnConfiguratorVariant.Extended) {
        overlay = (jsxRuntime.jsxs(Drawer, __assign({}, actions, { className: "column-configurator-drawer", headerDetails: jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: visibilityStatusText })), title: translateCommon('customizeColumns') }, { children: [jsxRuntime.jsx(SearchField, { "aria-label": translateCommon('searchColumnTitle'), autoFocus: true, onChange: onSearch, placeholder: translateCommon('searchColumnTitle'), size: exports.Size.sm }), jsxRuntime.jsx("div", __assign({ className: "column-configurator-drawer__items" }, { children: renderItems() }))] })));
    }
    else {
        overlay = (jsxRuntime.jsx(Popover, __assign({ className: "column-configurator-popover", maxHeight: 280, padding: 0, placement: "bottom left" }, { children: jsxRuntime.jsxs("div", __assign({ className: "column-configurator-dialog-content" }, { children: [jsxRuntime.jsx(reactAriaComponents.Header, __assign({ className: "column-configurator-dialog__header" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: visibilityStatusText }) })) })), jsxRuntime.jsx("div", __assign({ className: "column-configurator-dialog__body" }, { children: renderItems() }))] })) })));
    }
    return (jsxRuntime.jsxs(DialogTrigger, __assign({ onOpenChange: setIsOpen }, { children: [children, overlay] })));
}

exports.DataCardStyle = void 0;
(function (DataCardStyle) {
    DataCardStyle["Card"] = "card";
    DataCardStyle["Plain"] = "plain";
})(exports.DataCardStyle || (exports.DataCardStyle = {}));
exports.DataCardActionElement = void 0;
...
})(exports.DataCardActionElement || (exports.DataCardActionElement = {}));
exports.DataCardAlertLevel = void 0;
(function (DataCardAlertLevel) {
    DataCardAlertLevel["Warning"] = "warning";
    DataCardAlertLevel["Danger"] = "danger";
})(exports.DataCardAlertLevel || (exports.DataCardAlertLevel = {}));

var _a$3;
var valueSize$1 = (_a$3 = {},
    _a$3[exports.Size.sm] = exports.Size.xs,
    _a$3[exports.Size.md] = exports.Size.sm,
    _a$3[exports.Size.lg] = exports.Size.md,
    _a$3);
function SkeletonDataCard(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames("skeleton-data-card skeleton-data-card--".concat(style, " skeleton-data-card--").concat(size), className), ref: ref, style: { minWidth: minWidth } }, { children: [hasHeaderText && (jsxRuntime.jsxs("div", __assign({ className: "skeleton-data-card__header" }, { children: [hasHeaderIcon && (jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 16, shape: exports.SkeletonShape.Rectangle, style: { flexShrink: 0 }, width: 16 })), jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label, width: "60%" })] }))), jsxRuntime.jsxs("div", __assign({ className: "skeleton-data-card__body" }, { children: [jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: valueSize$1[size], type: exports.SkeletonTextType.Title }), jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label, width: "50%" })] })), hasVisualization && (jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 128, shape: exports.SkeletonShape.Rectangle, width: "100%" }))] }), "".concat(hasHeaderText, "-").concat(hasHeaderIcon, "-").concat(hasVisualization)));
}

var _a$2, _b;
var valueSize = (_a$2 = {},
    _a$2[exports.Size.sm] = exports.Size.xs,
    _a$2[exports.Size.md] = exports.Size.sm,
    _a$2[exports.Size.lg] = exports.Size.md,
    _a$2);
var headerIconSize = (_b = {},
    _b[exports.Size.sm] = exports.IconSize.XS,
    _b[exports.Size.md] = exports.IconSize.SM,
    _b[exports.Size.lg] = exports.IconSize.MD,
    _b);
function DataCard(_a) {
    ...
    var translateCommon = useTranslateCommon();
    if (isSkeleton) {
        return (jsxRuntime.jsx(SkeletonDataCard, { hasHeaderIcon: !!headerIconName, hasHeaderText: !!headerText, hasVisualization: !!visualization, minWidth: minWidth, size: size, style: style }));
    }
    var showHeader = !!headerText || !!badgeProps;
    var alertLevel = alert === null || alert === void 0 ? void 0 : alert.level;
    var content = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [showHeader && (jsxRuntime.jsxs("div", __assign({ className: "data-card__header" }, { children: [headerText && (jsxRuntime.jsxs("div", __assign({ className: "data-card__header-left" }, { children: [headerIconName && (jsxRuntime.jsx(Icon, { className: "data-card__header-icon", name: headerIconName, size: headerIconSize[size] })), jsxRuntime.jsx(Label, __assign({ className: "data-card__header-text", size: exports.Size.md }, { children: headerText }))] }))), badgeProps && (jsxRuntime.jsx(Badge, __assign({ className: "data-card__badge", isDisabled: isDisabled && style === exports.DataCardStyle.Card }, badgeProps)))] }))), jsxRuntime.jsxs("div", __assign({ className: "data-card__body" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "data-card__value-wrapper" }, { children: [jsxRuntime.jsx(Title, __assign({ className: "data-card__value", size: valueSize[size] }, { children: jsxRuntime.jsx("strong", { children: value }) }), "value"), alert && alertLevel && (jsxRuntime.jsx(Icon, { ariaLabel: (_b = alert.ariaLabel) !== null && _b !== void 0 ? _b : translateCommon(alertLevel), className: "data-card__alert-icon--".concat(alertLevel), name: alertLevel === exports.DataCardAlertLevel.Danger ?
                                    iconNames.EmergencyHomeFilled
                                    : iconNames.MinusCircleFilled, size: exports.IconSize.SM }))] })), jsxRuntime.jsx(Label, __assign({ className: "data-card__description", size: exports.Size.md }, { children: description }))] })), action && action.element === exports.DataCardActionElement.Button && (jsxRuntime.jsx(Button, __assign({ isDisabled: isDisabled, size: exports.Size.sm, style: exports.ButtonStyle.Fill, variant: exports.ButtonVariant.Neutral }, { children: action.text }))), visualization && jsxRuntime.jsx("div", __assign({ className: "data-card__visualization" }, { children: visualization }))] }));
    ...
    if (style === exports.DataCardStyle.Card && action && action.element === exports.DataCardActionElement.Self && !isDisabled) {
        return (jsxRuntime.jsx(reactAria.FocusRing, __assign({ focusRingClass: "data-card--focused" }, { children: jsxRuntime.jsx(TriggerElement, __assign({ className: cssClassName, elementType: exports.HTMLElementType.Div, onPress: action.onPress, ref: ref }, { children: content })) })));
    }
    return (jsxRuntime.jsx("div", __assign({ className: cssClassName, ref: ref, style: { minWidth: minWidth } }, { children: content })));
}
...
function DayOfMonth(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('day-of-month', className), "data-completed": !!isCompleted || undefined, "data-disabled": !!isDisabled || undefined, "data-focused": !!isFocused || undefined, "data-interactive": !!isInteractive || undefined, "data-selected": !!isSelected || undefined, "data-today": !!isToday || undefined, "data-unavailable": !!isUnavailable || undefined }, props, { children: [customContent, jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: children }))] })));
}

function DateTile(_a) {
    var _b;
    var propsAriaLabel = _a.ariaLabel, className = _a.className, _c = _a.completedIconName, completedIconName = _c === void 0 ? iconNames.CheckFilled : _c, date$1 = _a.date, isCompleted = _a.isCompleted, isLocked = _a.isLocked, isSelected = _a.isSelected, isToday = _a.isToday, menuProps = _a.menuProps, onPress = _a.onPress, propsRenderDayOfMonth = _a.renderDayOfMonth, secondaryText = _a.secondaryText, tooltipProps = _a.tooltipProps;
    var timeZone = useLocales().timeZone;
    var languageDay = useLanguageDay();
    var translateCommon = useTranslateCommon();
    var dayObj = languageDay(date$1);
    var isDateToday = isToday !== null && isToday !== void 0 ? isToday : date.isToday(date.parseDate(dayObj.format('YYYY-MM-DD')), timeZone);
    ...
    var renderDayOfMonth = function (_a) {
        ...
        return jsxRuntime.jsx(DayOfMonth, __assign({}, dayOfMonthProps));
    };
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('date-tile', className), "data-completed": !!isCompleted || undefined, "data-interactive": !!onPress || undefined, "data-locked": !!isLocked || undefined, "data-selected": !!isSelected || undefined, "data-today": isDateToday || undefined }, { children: [jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !tooltipContent }, { children: [jsxRuntime.jsx(TriggerElement, __assign({ "aria-label": ariaLabel, className: "date-tile__start", excludeFromTabOrder: !isFocusable, onPress: function () {
                            safeCall(onPress, date$1);
                        } }, { children: function (renderProps) { return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", __assign({ className: "date-tile__date-area" }, { children: renderDayOfMonth(renderProps) })), jsxRuntime.jsxs("div", __assign({ className: "date-tile__texts" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "date-tile__primary-text-row" }, { children: [jsxRuntime.jsx(Label, __assign({ className: "date-tile__weekday", size: exports.Size.sm }, { children: capitalizeFirstLetter(dayObj.format('ddd')) })), isCompleted && (jsxRuntime.jsx(Icon, { className: "date-tile__primary-icon", name: completedIconName, size: exports.IconSize.SM }))] })), (!!secondaryText || !!isLocked) && (jsxRuntime.jsxs("div", __assign({ className: "date-tile__secondary-text-row" }, { children: [secondaryText && (jsxRuntime.jsx(Label, __assign({ className: "date-tile__secondary-text", size: exports.Size.sm }, { children: secondaryText }))), isLocked && (jsxRuntime.jsx(Icon, { className: "date-tile__secondary-icon", name: iconNames.Lock, size: exports.IconSize.XS }))] })))] }))] })); } })), jsxRuntime.jsx(Tooltip, __assign({ headerText: tooltipProps === null || tooltipProps === void 0 ? void 0 : tooltipProps.headerText, type: (_b = tooltipProps === null || tooltipProps === void 0 ? void 0 : tooltipProps.type) !== null && _b !== void 0 ? _b : exports.TooltipType.Plain }, { children: tooltipContent }))] })), menuProps && (jsxRuntime.jsx(Menu, __assign({}, menuProps, { children: jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('actions'), iconName: iconNames.MoreVert, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }) }))), isSelected && jsxRuntime.jsx(Divider, { className: "date-tile__divider", size: exports.Size.md })] })));
}

function DataTableCellContent(_a) {
    var _b = _a.alignment, alignment = _b === void 0 ? exports.Alignment.start : _b, children = _a.children, className = _a.className;
    return (jsxRuntime.jsx("div", __assign({ className: classNames('data-table__cell-content', "data-table__cell-content--align-".concat(alignment), className) }, { children: children })));
}
...
function DataTableRow(_a) {
    var _b, _c;
    var draggedRowData = _a.draggedRowData, isDraggable = _a.isDraggable, row = _a.row, _d = _a.rowDragMode, rowDragMode = _d === void 0 ? exports.DataTableRowDragMode.Flat : _d, table = _a.table;
    var rowId = row.id;
    var _e = sortable.useSortable({
        id: rowId,
        data: {
            row: row
        }
    ...
    var isGhost = isDragging && rowDragMode === exports.DataTableRowDragMode.Nested;
    var rowDropCSSClass = getRowDropCSSClass(rowId, draggedRowData);
    var style;
    if (isDraggable && rowDragMode === exports.DataTableRowDragMode.Flat) {
        style = {
    ...
    return (jsxRuntime.jsx("tr", __assign({}, rowProps, { "aria-disabled": isDisabled, "aria-selected": isSelected, className: classNames('data-table__row', rowDropCSSClass, rowProps === null || rowProps === void 0 ? void 0 : rowProps.className, {
            ...
            return (jsxRuntime.jsx("td", __assign({ className: classNames('data-table__cell', cellClassName), colSpan: colSpan, style: __assign(__assign({}, getColumnPinningStyles(cell.column)), cellStyle) }, cellProps, { children: jsxRuntime.jsx(DataTableCellContent, __assign({ alignment: (_d = columnDef.meta) === null || _d === void 0 ? void 0 : _d.alignment }, { children: reactTable.flexRender(columnDef.cell, context) })) }), cell.id));
        }) })));
}
...
function DataTableHeaderCell(_a) {
    ...
    var _e = (_c = column.columnDef.meta) !== null && _c !== void 0 ? _c : {}, _f = _e.alignment, alignment = _f === void 0 ? exports.Alignment.start : _f, isEditable = _e.isEditable, headerStyle = _e.headerStyle;
    var sortHandler = isSortable ? column.getToggleSortingHandler() : undefined;
    var content = showContent ? reactTable.flexRender(column.columnDef.header, header.getContext()) : null, sortIcon = null;
    if (isString(content)) {
        content = (jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: content }) })));
    }
    if (isSortable) {
        var sortDirection = column.getIsSorted();
        var iconName = void 0;
        switch (sortDirection) {
            case exports.SortDirection.Ascending:
                iconName = iconNames.ArrowUpward;
                break;
            case exports.SortDirection.Descending:
        ...
        sortIcon = jsxRuntime.jsx(Icon, { className: "data-table__sort-icon", name: iconName, size: exports.IconSize.MD });
    }
    return (jsxRuntime.jsx("th", __assign({}, props, { className: classNames('data-table__header-cell', className, (_b = {
            ...
            function (e) {
                var key = e.key;
                if (key === exports.KeyboardEventKey.Enter || key === exports.KeyboardEventKey.Space) {
                    sortHandler(e);
                }
            }
            : undefined, role: "columnheader", rowSpan: rowSpan, scope: "col", style: __assign(__assign({}, getColumnPinningStyles(header.column)), headerStyle), tabIndex: isSortable ? 0 : undefined }, { children: jsxRuntime.jsxs(DataTableCellContent, __assign({ alignment: alignment }, { children: [content, sortIcon] })) })));
}

exports.DataTableDisplayColumnID = void 0;
...
})(exports.DataTableDisplayColumnID || (exports.DataTableDisplayColumnID = {}));
...
function SkeletonDataTable(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-data-table', className), ref: ref, style: { gridTemplate: "".concat(templateRows, " / ").concat(templateCols) } }, { children: [Array.from({ length: columnCount }, function (_, colIdx) { return (jsxRuntime.jsx("div", __assign({ className: "skeleton-data-table__th" }, { children: colIdx === 0 && hasRowSelection ?
                    jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 16, shape: exports.SkeletonShape.Rectangle, width: 16 })
                    : jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.sm, type: exports.SkeletonTextType.Label }) }), "th".concat(colIdx))); }), Array.from({ length: rowCount }, function (_x, rowIdx) {
                return Array.from({ length: columnCount }, function (_y, colIdx) { return (jsxRuntime.jsx("div", __assign({ className: "skeleton-data-table__td" }, { children: colIdx === 0 && hasRowSelection ?
                        jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: 16, shape: exports.SkeletonShape.Rectangle, width: 16 })
                        : jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label }) }), "td".concat(rowIdx, "-").concat(colIdx))); });
...
function DataTableRowDragOverlay(_a) {
    ...
    for (var i = 0, len = cells.length; i < len; i++) {
        ...
        var isDragHandle = column.id === exports.DataTableDisplayColumnID.DragHandle;
        ...
        if (isDragHandle || isRowTitle) {
            var cellNode = (jsxRuntime.jsx("td", __assign({ className: classNames('data-table__cell', cellClassName), style: cellStyle }, cellProps, { children: jsxRuntime.jsx(DataTableCellContent, __assign({ alignment: (_g = columnDef.meta) === null || _g === void 0 ? void 0 : _g.alignment }, { children: reactTable.flexRender(columnDef.cell, context) })) }), cell.id));
            if (isDragHandle) {
    ...
    return (jsxRuntime.jsx("table", __assign({ className: "data-table__row-drag-overlay" }, { children: jsxRuntime.jsx("tbody", { children: jsxRuntime.jsx("tr", __assign({ className: "data-table__row" }, { children: cellsToRender })) }) })));
}

var eventKeys$1 = [exports.KeyboardEventKey.ArrowDown, exports.KeyboardEventKey.ArrowUp];
var Direction$1;
(function (Direction) {
...
function detectTableFeatures(table) {
    ...
    for (var i = 0, len = allColumns.length; i < len; i++) {
        ...
        if (col.id === exports.DataTableDisplayColumnID.DragHandle) {
...
function DataTable(_a) {
    var bottomPaginationProps = _a.bottomPaginationProps, className = _a.className, columnConfiguratorOptions = _a.columnConfiguratorOptions, initialColumnOrder = _a.columnOrder, initialColumnPinning = _a.columnPinning, columns = _a.columns, initialColumnVisibility = _a.columnVisibility, data = _a.data, enableParentRowSelectionSync = _a.enableParentRowSelectionSync, _b = _a.enableRowSelection, enableRowSelection = _b === void 0 ? true : _b, initialExpanded = _a.expanded, getRowCanExpand = _a.getRowCanExpand, getRowId = _a.getRowId, getRowProps = _a.getRowProps, getRowTitleFn = _a.getRowTitle, getSubRows = _a.getSubRows, initialGrouping = _a.grouping, isRowDisabled = _a.isRowDisabled, isRowLoading = _a.isRowLoading, isSkeleton = _a.isSkeleton, onColumnOrderChange = _a.onColumnOrderChange, onColumnVisibilityChange = _a.onColumnVisibilityChange, onExpandedChange = _a.onExpandedChange, onDataEdit = _a.onDataEdit, onPaginationChange = _a.onPaginationChange, onRowSelectionChange = _a.onRowSelectionChange, onSortingChange = _a.onSortingChange, pageSizes = _a.pageSizes, initialPagination = _a.pagination, initialRowSelection = _a.rowSelection, ref = _a.ref, reorderableColumns = _a.reorderableColumns, _c = _a.rowDragMode, rowDragMode = _c === void 0 ? exports.DataTableRowDragMode.Flat : _c, skeletonProps = _a.skeletonProps, initialSorting = _a.sorting, sortingColumnSelectionPriority = _a.sortingColumnSelectionPriority, sortingStrategy = _a.sortingStrategy, topPaginationProps = _a.topPaginationProps, totalRowCount = _a.totalRowCount, wrapperClassName = _a.wrapperClassName, props = __rest(_a, ["bottomPaginationProps", "className", "columnConfiguratorOptions", "columnOrder", "columnPinning", "columns", "columnVisibility", "data", "enableParentRowSelectionSync", "enableRowSelection", "expanded", "getRowCanExpand", "getRowId", "getRowProps", "getRowTitle", "getSubRows", "grouping", "isRowDisabled", "isRowLoading", "isSkeleton", "onColumnOrderChange", "onColumnVisibilityChange", "onExpandedChange", "onDataEdit", "onPaginationChange", "onRowSelectionChange", "onSortingChange", "pageSizes", "pagination", "rowSelection", "ref", "reorderableColumns", "rowDragMode", "skeletonProps", "sorting", "sortingColumnSelectionPriority", "sortingStrategy", "topPaginationProps", "totalRowCount", "wrapperClassName"]);
    var _d = react.useState(initialSorting !== null && initialSorting !== void 0 ? initialSorting : []), sorting = _d[0], setSorting = _d[1];
    var _e = react.useState(initialRowSelection !== null && initialRowSelection !== void 0 ? initialRowSelection : {}), rowSelection = _e[0], setRowSelection = _e[1];
    var _f = react.useState(initialPagination !== null && initialPagination !== void 0 ? initialPagination : { pageIndex: 0, pageSize: 0 }), pagination = _f[0], setPagination = _f[1];
    var _g = react.useState(initialExpanded !== null && initialExpanded !== void 0 ? initialExpanded : {}), expanded = _g[0], setExpanded = _g[1];
    var grouping = react.useMemo(function () { return initialGrouping !== null && initialGrouping !== void 0 ? initialGrouping : []; }, [initialGrouping]);
    var columnPinning = react.useMemo(function () { return initialColumnPinning !== null && initialColumnPinning !== void 0 ? initialColumnPinning : {}; }, [initialColumnPinning]);
    var _h = react.useState(initialColumnOrder !== null && initialColumnOrder !== void 0 ? initialColumnOrder : []), columnOrder = _h[0], setColumnOrder = _h[1];
    var _j = react.useState(initialColumnVisibility !== null && initialColumnVisibility !== void 0 ? initialColumnVisibility : {}), columnVisibility = _j[0], setColumnVisibility = _j[1];
    var _k = react.useState(null), draggedRowData = _k[0], setDraggedRowData = _k[1];
    var rowDropPositionRef = react.useRef(null);
    var a11yContainerRef = react.useRef(null);
    ...
    var rowIds = [];
    var columnConfiguratorColumns = react.useMemo(function () {
        if (reorderableColumns) {
            return columnOrder.map(function (id) {
                var isDragHandleColumn = id === exports.DataTableDisplayColumnID.DragHandle;
                return {
                    id: id,
    ...
    var hasNestedRowDrag = rowDragMode === exports.DataTableRowDragMode.Nested;
    ...
    var syncScroll = react.useCallback(throttle(function () {
    ...
    var rowDragSensors = core$1.useSensors(core$1.useSensor(core$1.MouseSensor, {}), core$1.useSensor(core$1.TouchSensor, {}), core$1.useSensor(core$1.KeyboardSensor, {
        coordinateGetter: hasNestedRowDrag ? nestedDataTableKeyboardCoordinateGetter : sortable.sortableKeyboardCoordinates
    }));
    react.useEffect(function () {
    ...
    if (isSkeleton) {
        return jsxRuntime.jsx(SkeletonDataTable, __assign({}, skeletonProps));
    }
    var visitedHeaderPlaceholderColumns = new Set();
    var headerRows = table.getHeaderGroups().map(function (headerGroup, idx, headerGroups) { return (jsxRuntime.jsx("tr", __assign({ className: classNames('data-table__header-row', {
            ...
            return jsxRuntime.jsx(DataTableHeaderCell, { header: header, rowSpan: rowSpan, showContent: showContent }, id);
        }) }), headerGroup.id)); });
    var bodyRows = table.getRowModel().rows.map(function (row) {
        var rowId = row.id;
        rowIds.push(rowId);
        return (jsxRuntime.jsx(DataTableRow, { draggedRowData: draggedRowData, isDraggable: hasDraggableRows, row: row, rowDragMode: rowDragMode, table: table }, rowId));
    });
    var footerRows = hasFooter ?
        table.getFooterGroups().map(function (footerGroup) { return (jsxRuntime.jsx("tr", __assign({ className: "data-table__footer-row" }, { children: footerGroup.headers.map(function (header) {
                var _a;
                var content = header.isPlaceholder ? null : (reactTable.flexRender(header.column.columnDef.footer, header.getContext()));
                if (isString(content)) {
                    content = (jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: jsxRuntime.jsx("strong", { children: content }) })));
                }
                return (jsxRuntime.jsx("td", __assign({ className: "data-table__footer-cell" }, { children: jsxRuntime.jsx(DataTableCellContent, __assign({ alignment: (_a = header.column.columnDef.meta) === null || _a === void 0 ? void 0 : _a.alignment }, { children: content })) }), header.id));
            }) }), footerGroup.id)); })
        : null;
    var renderTable = function (hasRowDrag) { return (jsxRuntime.jsxs("table", __assign({ className: classNames('data-table', className) }, { children: [jsxRuntime.jsx("thead", __assign({ className: "data-table__header" }, { children: headerRows })), jsxRuntime.jsx("tbody", __assign({ className: "data-table__body" }, { children: hasRowDrag ?
                    jsxRuntime.jsxs(core$1.DndContext, __assign({ accessibility: {
                        ...
                        }, collisionDetection: core$1.closestCenter, modifiers: hasNestedRowDrag ? undefined : [modifiers.restrictToParentElement], onDragCancel: onRowDragCancel, onDragEnd: onRowDragEnd, onDragMove: hasNestedRowDrag ? onRowDragMove : undefined, onDragOver: hasNestedRowDrag ? onRowDragOver : undefined, onDragStart: onRowDragStart, sensors: rowDragSensors }, { children: [jsxRuntime.jsx(sortable.SortableContext, __assign({ items: rowIds, strategy: sortingStrategy !== null && sortingStrategy !== void 0 ? sortingStrategy : sortable.verticalListSortingStrategy }, { children: bodyRows })), hasNestedRowDrag &&
                                reactDom.createPortal(jsxRuntime.jsx(core$1.DragOverlay, { children: draggedRowData && jsxRuntime.jsx(DataTableRowDragOverlay, { draggedRowData: draggedRowData }) }), document.body)] }))
                    : bodyRows })), footerRows && jsxRuntime.jsx("tfoot", __assign({ className: "data-table__footer" }, { children: footerRows }))] }))); };
    var renderBefore = function () {
        var customContent = safeCall(props.renderBefore);
        var pager, columnConfigurator;
        if (showPagination) {
            pager = (jsxRuntime.jsx(Pagination, __assign({}, topPaginationProps, { className: "data-table__top-pagination", isMinimized: true, onPageIndexChange: onPageIndexChange, onPageSizeChange: onPageSizeChange, pageIndex: pageIndex, pageSize: pageSize, pageSizes: pageSizes, totalRowCount: totalRowCount })));
        }
        if (reorderableColumns) {
            ...
            columnConfigurator = (jsxRuntime.jsx(ColumnConfigurator, __assign({ columnOrder: columnOrder, columnVisibility: columnVisibility, columns: columnConfiguratorColumns, onColumnOrderChange: function (colOrder) {
                    ...
                    jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('customizeColumns'), iconName: iconNames.ViewKanban, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral })
                    : jsxRuntime.jsx(Button, __assign({ size: exports.Size.md, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('customizeColumns') })) })));
        }
        if (pager || columnConfigurator || customContent) {
            return (jsxRuntime.jsxs("div", __assign({ className: "data-table-before" }, { children: [customContent, jsxRuntime.jsxs("div", __assign({ className: "data-table-before__right" }, { children: [pager, columnConfigurator] }))] })));
        }
        return null;
    };
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('data-table-wrapper', wrapperClassName), ref: ref }, { children: [jsxRuntime.jsx("div", { className: "data-table-a11y-container", ref: a11yContainerRef }), renderBefore(), jsxRuntime.jsx("div", __assign({ className: "data-table-sticky-container", ref: stickyContainerRef }, { children: renderTable() })), jsxRuntime.jsx("div", __assign({ className: "data-table-scrollable-container", onScroll: syncScroll, ref: scrollableContainerRef, tabIndex: -1 }, { children: renderTable(hasDraggableRows) })), showPagination && (jsxRuntime.jsx(Pagination, __assign({}, bottomPaginationProps, { className: "data-table__bottom-pagination", onPageIndexChange: onPageIndexChange, onPageSizeChange: onPageSizeChange, pageIndex: pageIndex, pageSize: pageSize, pageSizes: pageSizes, totalRowCount: totalRowCount })))] })));
}
...
function DataTableCheckboxHeader(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsx(Checkbox, __assign({}, props, { "aria-label": (_b = props['aria-label']) !== null && _b !== void 0 ? _b : translateCommon('selectAllRows'), isIndeterminate: table.getIsSomeRowsSelected(), isSelected: table.getIsAllRowsSelected(), onChange: function (val) { return table.toggleAllRowsSelected(val); } })));
}
...
function syncParentRowSelection(row, selection, table) {
    ...
    var selected = reactTable.isRowSelected(parentRow, selection);
    var isAllSubRowsSelected = reactTable.isSubRowSelected(parentRow, selection, table) === 'all';
...
function DataTableTextCell(_a) {
    ...
    return (jsxRuntime.jsx(Label, __assign({ className: classNames('data-table__text-cell', className, {
        ...
        }), ref: ref, size: exports.Size.md, style: style }, { children: children !== null && children !== void 0 ? children : getValue() })));
}
...
function DataTableExpanderCell(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsxs("div", __assign({ className: "data-table__indent-wrapper", ref: ref, style: style }, { children: [prefix, jsxRuntime.jsx(interactions.Pressable, __assign({ onPress: !isLoading && canExpand ? row.getToggleExpandedHandler() : undefined }, { children: jsxRuntime.jsx("div", __assign({ "aria-expanded": isExpanded, "aria-label": translateCommon(isExpanded ? 'collapse' : 'expand'), className: classNames('data-table__expander', {
                        ...
                        jsxRuntime.jsx(Spinner, { size: exports.Size.md, variant: exports.SpinnerVariant.Neutral })
                        : jsxRuntime.jsx(Icon, { name: isExpanded ? iconNames.ExpandMore : iconNames.ChevronRight, size: exports.IconSize.LG }) })) })), suffix] })));
}
...
function DataTableToolbar(_a) {
    ...
    var translateCommon = useTranslateCommon();
    return (jsxRuntime.jsxs("div", __assign({ "aria-label": translateCommon('actionsForSelectedRows'), className: classNames('data-table-toolbar', className), ref: ref, role: "toolbar" }, { children: [jsxRuntime.jsx(Label, __assign({ className: "data-table-toolbar__selected-text", size: exports.Size.sm, style: { minWidth: selectedTextMinWidth } }, { children: "".concat(selectedCount, " ").concat(translateCommon('selected').toLowerCase()) })), jsxRuntime.jsx(reactAriaComponents.Provider, __assign({ values: [[reactAriaComponents.ButtonContext, { isDisabled: !selectedCount }]] }, { children: actions }))] })));
}
...
function DataTableActionButtonCell(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('data-table__action-button-cell', className), ref: ref }, { children: [jsxRuntime.jsx("div", __assign({ className: "data-table__action-button-cell-content", onClick: stopChildrenClickPropagation ? stopPropagation : undefined }, { children: children })), jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !tooltipProps }, { children: [jsxRuntime.jsx(ActionButton, __assign({ className: classNames('data-table__action-button', {
                            'data-table__action-button--visible': isTouchDevice
                        }), size: exports.Size.md, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }, buttonProps)), tooltipProps && jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, tooltipProps))] }))] })));
}
...
function KanbanColumnBody(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames('kanban-column__body', {
            'kanban-column__body--droppable-over': isDroppableOver
        }), ref: utils.mergeRefs(bodyProps.ref, ref), role: "list" }, { children: children })));
}
...
function KanbanColumn(_a) {
    ...
    var _f = react.useState(false), isLoadingMoreCards = _f[0], setIsLoadingMoreCards = _f[1];
    ...
    var isTruncated = useIsTextTruncated({
        ref: titleRef,
        overflowDirection: isCollapsed ? exports.Orientation.vertical : exports.Orientation.horizontal
    });
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-labelledby": titleId, className: classNames('kanban-column', {
            'kanban-column--overlay': isOverlay,
            'kanban-column--dragging': isDragging,
            'kanban-column--collapsed': isCollapsed
        }), ref: utils.mergeRefs(setNodeRef, ref), role: "region", style: style }, { children: [jsxRuntime.jsxs("div", __assign({ className: "kanban-column__header" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "kanban-column__header-start" }, { children: [isDraggable && jsxRuntime.jsx(DragHandle, __assign({}, attributes, listeners)), jsxRuntime.jsxs("div", __assign({ className: "kanban-column__title-wrapper" }, { children: [jsxRuntime.jsx(IconButton, { "aria-expanded": !isCollapsed, "aria-label": translateCommon(isCollapsed ? 'expand' : 'collapse'), iconName: isCollapsed ? iconNames.ChevronRight : iconNames.ExpandMore, onPress: function () { return onCollapsedChange === null || onCollapsedChange === void 0 ? void 0 : onCollapsedChange({ id: id, isCollapsed: !isCollapsed }); }, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }), jsxRuntime.jsxs("div", __assign({ className: "kanban-column__title-texts", id: titleId }, { children: [jsxRuntime.jsxs(TooltipTrigger, __assign({ isDisabled: !isTruncated }, { children: [jsxRuntime.jsx(TriggerElement, __assign({ className: "kanban-column__title-trigger", excludeFromTabOrder: !isTruncated }, { children: jsxRuntime.jsx(Label, __assign({ className: "kanban-column__title", ref: titleRef, size: exports.Size.md }, { children: jsxRuntime.jsx("strong", { children: title }) })) })), jsxRuntime.jsx(Tooltip, __assign({ position: isCollapsed ? exports.Position.Right : undefined, type: exports.TooltipType.Plain }, { children: title }))] })), !isCollapsed && description && (jsxRuntime.jsx(Label, __assign({ className: "kanban-column__description", size: exports.Size.sm }, { children: description })))] }))] }))] })), jsxRuntime.jsxs("div", __assign({ className: "kanban-column__header-end" }, { children: [!isCollapsed && (jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(TriggerElement, __assign({ className: "kanban-colum__total" }, { children: jsxRuntime.jsx(Label, __assign({ size: exports.Size.sm }, { children: (_b = total === null || total === void 0 ? void 0 : total.value) !== null && _b !== void 0 ? _b : cards.length })) })), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: (_c = total === null || total === void 0 ? void 0 : total.tooltipContent) !== null && _c !== void 0 ? _c : translateCommon('itemsInList', { count: (_d = total === null || total === void 0 ? void 0 : total.value) !== null && _d !== void 0 ? _d : cards.length }) }))] })), menuProps && (jsxRuntime.jsx(Menu, __assign({}, menuProps, { onAction: function (actionKey) { return onMenuAction === null || onMenuAction === void 0 ? void 0 : onMenuAction({ actionKey: actionKey, columnId: id }); }, onSelectionChange: function (selectedKeys) { return onMenuSelectionChange === null || onMenuSelectionChange === void 0 ? void 0 : onMenuSelectionChange({ columnId: id, selectedKeys: selectedKeys }); }, placement: "bottom right" }, { children: jsxRuntime.jsxs(TooltipTrigger, { children: [jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('moreActions'), iconName: iconNames.MoreVert, size: exports.Size.sm, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }), jsxRuntime.jsx(Tooltip, __assign({ type: exports.TooltipType.Plain }, { children: translateCommon('moreActions') }))] }) })))] }))] })), !isCollapsed && (jsxRuntime.jsxs(KanbanColumnBody, __assign({ column: data, isDisabled: ((_e = active === null || active === void 0 ? void 0 : active.data.current) === null || _e === void 0 ? void 0 : _e.type) === KanbanElementType.Column }, { children: [cards.map(function (card) { return renderCard({ columnId: id, data: card }); }), hasMoreCards && (jsxRuntime.jsx(Button, __assign({ className: "kanban-column__show-more-button", isLoading: isLoadingMoreCards, isPending: isLoadingMoreCards, onPress: onShowMore, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('showMore') })))] }))), !isCollapsed && (jsxRuntime.jsx("div", __assign({ className: "kanban-column__footer" }, { children: addCardOptions && (jsxRuntime.jsx(Button, __assign({ onPress: function () { var _a; return (_a = addCardOptions === null || addCardOptions === void 0 ? void 0 : addCardOptions.onAdd) === null || _a === void 0 ? void 0 : _a.call(addCardOptions, { columnId: id }); }, startIconName: iconNames.Add, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: addCardOptions.label }))) })))] })));
}
...
var eventKeys = [
    exports.KeyboardEventKey.ArrowDown,
    exports.KeyboardEventKey.ArrowUp,
    exports.KeyboardEventKey.ArrowLeft,
    exports.KeyboardEventKey.ArrowRight
];
var Direction;
(function (Direction) {
...
var kanbanColumnKeyboardCoordinateGetter = function (event, args) {
    ...
    if (nextId) {
        ...
        var sortedItems = sortable.arrayMove(items, activeIdx, overIdx);
...
function Kanban(_a) {
    ...
    var _c = react.useState(propsCollapsedColumnKeys !== null && propsCollapsedColumnKeys !== void 0 ? propsCollapsedColumnKeys : new Set()), collapsedColumnKeys = _c[0], setCollapsedColumnKeys = _c[1];
    var columnIds = react.useMemo(function () { return data.map(function (col) { return col.id; }); }, [data]);
    var _d = react.useState(null), activeColumnDragData = _d[0], setActiveColumnDragData = _d[1];
    var _e = react.useState(null), activeCardDragData = _e[0], setActiveCardDragData = _e[1];
    var translateKanbanDragAndDrop = useTranslateKanbanDragAndDrop();
    var isFirstAnnouncementRef = react.useRef(true);
    var sensors = core$1.useSensors(core$1.useSensor(core$1.MouseSensor, {}), core$1.useSensor(core$1.TouchSensor, {}), core$1.useSensor(core$1.KeyboardSensor, {
    ...
    return (jsxRuntime.jsxs(core$1.DndContext, __assign({ accessibility: {
            screenReaderInstructions: {
        ...
        }, collisionDetection: activeColumnDragData ? horizontalSortableListCollisionDetection : core$1.closestCorners, measuring: {
            droppable: {
                strategy: core$1.MeasuringStrategy.Always
            }
        }, onDragCancel: onDragCancel, onDragEnd: onDragEnd, onDragStart: onDragStart, sensors: sensors }, { children: [jsxRuntime.jsxs("div", __assign({ "aria-label": ariaLabel, className: classNames('kanban', className), ref: ref, role: "region", style: {
                    alignItems: columnHeightMode === KanbanColumnHeightMode.Auto ? 'flex-start' : undefined,
                    height: height
                } }, { children: [jsxRuntime.jsx(sortable.SortableContext, __assign({ items: columnIds, strategy: sortable.horizontalListSortingStrategy }, { children: data.map(function (col) { return (jsxRuntime.jsx(KanbanColumn, { addCardOptions: addCardOptions, data: col, isCollapsed: collapsedColumnKeys.has(col.id), isDraggable: enableColumnReordering, onCollapsedChange: onColumnCollapsedChange, onMenuAction: onColumnMenuAction, onMenuSelectionChange: onColumnMenuSelectionChange, onShowMoreCards: onShowMoreCards, renderCard: renderCard, width: columnWidth }, col.id)); }) })), renderAfterColumns === null || renderAfterColumns === void 0 ? void 0 : renderAfterColumns({ isDraggingColumn: !!activeColumnDragData }), addColumnOptions && (
                    // Button will handle the press events and focus.
                    // eslint-disable-next-line
                    jsxRuntime.jsx("li", __assign({ className: "kanban__new-column", onClick: addColumnOptions.onAdd }, { children: addColumnOptions.showIconOnly ?
                            jsxRuntime.jsx(IconButton, { "aria-label": addColumnOptions.label, iconName: iconNames.Add, onPress: addColumnOptions.onAdd, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral })
                            : jsxRuntime.jsx(Button, __assign({ onPress: addColumnOptions.onAdd, startIconName: iconNames.Add, style: exports.ButtonStyle.Plain, variant: exports.ButtonVariant.Neutral }, { children: addColumnOptions.label })) })))] })), reactDom.createPortal(jsxRuntime.jsxs(core$1.DragOverlay, { children: [activeColumnDragData && (jsxRuntime.jsx(KanbanColumn, { addCardOptions: addCardOptions, data: activeColumnDragData.column, isCollapsed: collapsedColumnKeys === null || collapsedColumnKeys === void 0 ? void 0 : collapsedColumnKeys.has(activeColumnDragData.column.id), isDraggable: true, isOverlay: true, renderCard: renderCard })), activeCardDragData &&
                        renderCard({
...
var _a$1;
exports.KanbanCardFooterAlertLevel = void 0;
...
function KanbanCardFooter(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "kanban-card__footer" }, { children: [jsxRuntime.jsx(Divider, { size: exports.Size.sm }), jsxRuntime.jsxs("div", __assign({ className: "kanban-card__disclosure" }, { children: [jsxRuntime.jsxs("button", __assign({}, reactAria.mergeProps(buttonProps, focusProps), { className: "kanban-card__disclosure-btn", "data-focus-visible": isFocusVisible || undefined, ref: triggerRef }, { children: [jsxRuntime.jsx("div", __assign({ className: "kanban-card__disclosure-icon" }, { children: jsxRuntime.jsx(Icon, { name: isExpanded ? iconNames.ExpandMore : iconNames.ChevronRight, size: exports.IconSize.SM }) })), jsxRuntime.jsx(Label, __assign({ className: "kanban-card__disclosure-title", size: exports.Size.md }, { children: title })), alertLevel && jsxRuntime.jsx(Icon, __assign({}, alertLevelIconProps[alertLevel], { size: exports.IconSize.MD }))] })), jsxRuntime.jsx("div", __assign({}, reactAria.mergeProps(panelProps, panelProps2), { className: "kanban-card__disclosure-panel", ref: panelRef }, { children: (isExpanded || isLoaded) && (jsxRuntime.jsx("div", __assign({ className: "kanban-card__disclosure-panel-content" }, { children: children }))) }))] }))] })));
}
...
function KanbanCard(_a) {
    ...
    var translateCommon = useTranslateCommon();
    var titleId = react.useId();
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('kanban-card', className, {
            'kanban-card--overlay': isOverlay,
            'kanban-card--dragging': isDragging
        }), ref: utils.mergeRefs(setNodeRef, ref), role: "listitem" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "kanban-card__header" }, { children: [jsxRuntime.jsx(DragHandle, __assign({}, attributes, listeners, { "aria-labelledby": titleId })), (!!menuProps || !!headerContent) && (jsxRuntime.jsxs("div", __assign({ className: "kanban-card__header-right" }, { children: [headerContent, menuProps && (jsxRuntime.jsx(Menu, __assign({}, menuProps, { placement: "bottom right" }, { children: jsxRuntime.jsx(IconButton, { "aria-label": translateCommon('moreActions'), iconName: iconNames.MoreVert, isDisabled: menuProps.isDisabled, size: exports.Size.sm, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }) })))] })))] })), jsxRuntime.jsxs("div", __assign({ className: "kanban-card__body" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "kanban-card__title-wrapper", id: titleId }, { children: [jsxRuntime.jsx(Title, __assign({ size: exports.Size.xxs }, { children: jsxRuntime.jsx("strong", { children: title }) })), subTitle && jsxRuntime.jsx(Label, __assign({ size: exports.Size.md }, { children: subTitle }))] })), bodyContent] })), detailsContent && jsxRuntime.jsx("div", __assign({ className: "kanban-card__details" }, { children: detailsContent })), footerProps && jsxRuntime.jsx(KanbanCardFooter, __assign({}, footerProps))] })));
}

exports.ListItemStyle = void 0;
...
function ListItem(_a) {
    var children = _a.children, className = _a.className, footer = _a.footer, ref = _a.ref, showFooterSeparator = _a.showFooterSeparator, _b = _a.style, style = _b === void 0 ? exports.ListItemStyle.Card : _b;
    return (jsxRuntime.jsxs("li", __assign({ className: classNames("list-item list-item--".concat(style), className), ref: ref }, { children: [children, footer && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [showFooterSeparator && jsxRuntime.jsx(Divider, { className: "list-item__divider", size: exports.Size.sm }), footer] }))] })));
}

function List(_a) {
    var children = _a.children, className = _a.className, data = _a.data, idAccessor = _a.idAccessor, ref = _a.ref, showItemFooterSeparator = _a.showItemFooterSeparator, spacing = _a.spacing, _b = _a.style, style = _b === void 0 ? exports.ListItemStyle.Card : _b;
    var defaultSpacing = style === exports.ListItemStyle.Plain ? 0 : dTokens.coreTokens.dimension.spaceSm.value;
    ...
    if (isFunction(children)) {
        ...
        listItems = data.map(function (item) {
            ...
            if (react.isValidElement(element) && element.type === ListItem) {
                return react.cloneElement(element, __assign({ key: key }, commonListItemProps));
            }
            return (jsxRuntime.jsx(ListItem, __assign({}, commonListItemProps, { children: element }), key));
        });
    }
    else {
        var childrenArr = react.Children.toArray(children);
        listItems = childrenArr.map(function (child) {
            return react.cloneElement(child, __assign({}, commonListItemProps));
        });
    }
    return (jsxRuntime.jsx("ul", __assign({ className: classNames('list', className), ref: ref, style: { gap: spacing !== null && spacing !== void 0 ? spacing : defaultSpacing } }, { children: listItems })));
}
...
function getChartTokenValues(size) {
    ...
    var _a = dTokens.coreTokens.dimension, 
...
var chartMinWidth = (_a = {},
    _a[exports.Size.xxs] = 0,
    _a[exports.Size.xs] = 150,
    _a[exports.Size.sm] = 384,
    _a[exports.Size.md] = 768,
    _a[exports.Size.lg] = 1250,
    _a);
...
function getChartBaseOptions(_a) {
    ...
    if (series && series.length > 0) {
        ...
        if (firstSeries.type === exports.ChartType.Pie) {
...
function getChartForcedOptions(_a) {
    ...
    if (size) {
        ...
        var sizes = [exports.Size.xxs, exports.Size.xs, exports.Size.sm, exports.Size.md, exports.Size.lg];
        out = merge(out, {
            responsive: {
    ...
    chart: {
        ...
        events: {
            render: function () {
                ...
                if (chartType === exports.ChartType.Donut) {
...
function Chart(props) {
    ...
    return (react.createElement(highchartsReactOfficial.HighchartsReact, __assign({}, otherProps, { containerProps: __assign(__assign({ 
...
function ContentBlock(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('content-block', className, {
            'content-block--nested': isNested
        }) }, { children: [jsxRuntime.jsxs("div", __assign({ className: "content-block__header", style: headerStyle }, { children: [title, headerContent] })), jsxRuntime.jsx("div", __assign({ className: "content-block__body", style: bodyStyle }, { children: children }))] })));
}

exports.LayoutGridColumnSpacing = void 0;
...
})(exports.LayoutGridColumnSpacing || (exports.LayoutGridColumnSpacing = {}));
...
function LayoutGrid(_a) {
    var children = _a.children, className = _a.className, _b = _a.columnSpacing, columnSpacing = _b === void 0 ? exports.LayoutGridColumnSpacing.Default : _b, ref = _a.ref, _c = _a.rowSpacing, rowSpacing = _c === void 0 ? dTokens.coreTokens.dimension.spaceMd.value : _c;
    var rowGapProperties = getGapProperties('row', rowSpacing);
    var columnGapProperties = getGapProperties('column', columnSpacing);
    return (jsxRuntime.jsx("div", __assign({ className: classNames.apply(void 0, __spreadArray(__spreadArray(__spreadArray(['layout-grid'], rowGapProperties.cssClassNames, false), columnGapProperties.cssClassNames, false), [className], false)), ref: ref, style: __assign(__assign({}, rowGapProperties.cssVariables), columnGapProperties.cssVariables) }, { children: children })));
}
...
function LayoutGridItem(_a) {
    ...
    var sanitizedSize = react.useMemo(function () { return sanitizeSize(size); }, [size]);
    var spanProperties = getPlacementProperties('span', sanitizedSize);
    var startProperties = getPlacementProperties('start', start);
    return (jsxRuntime.jsx("div", __assign({ className: classNames.apply(void 0, __spreadArray(__spreadArray(__spreadArray(['layout-grid-item'], spanProperties.cssClassNames, false), startProperties.cssClassNames, false), [className], false)), ref: ref, style: __assign(__assign({}, spanProperties.cssVariables), startProperties.cssVariables) }, { children: children })));
}
...
function SkeletonPageHeader(_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ "aria-hidden": ariaHidden === false ? undefined : true, className: classNames('skeleton-page-header', className), ref: ref }, { children: [hasBreadcrumbs && (jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label, width: "30%" })), jsxRuntime.jsxs("div", __assign({ className: "skeleton-page-header__title" }, { children: [hasIcon && (jsxRuntime.jsx(Skeleton, { "aria-hidden": false, height: iconSize, shape: exports.SkeletonShape.Rectangle, style: { flexShrink: 0 }, width: iconSize })), jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: level > 1 ? exports.Size.sm : exports.Size.md, type: exports.SkeletonTextType.Heading, width: "35%" })] })), hasDetails && (jsxRuntime.jsx(SkeletonText, { "aria-hidden": false, size: exports.Size.md, type: exports.SkeletonTextType.Label, width: "30%" }))] }), "".concat(hasBreadcrumbs, "-").concat(hasDetails, "-").concat(hasIcon, "-").concat(level)));
}
...
function PageHeader(_a) {
    ...
    if (isSkeleton) {
        return (jsxRuntime.jsx(SkeletonPageHeader, { hasBreadcrumbs: hasBreadcrumbs, hasDetails: hasDetails, hasIcon: !!iconName, level: level }));
    }
    return (jsxRuntime.jsxs("div", __assign({ className: classNames('page-header', className), ref: ref, style: style }, { children: [showBackButton && (jsxRuntime.jsx(Button, __assign({ onPress: onBackPress, size: exports.Size.sm, startIconName: iconNames.ArrowBack, style: exports.ButtonStyle.Outline, variant: exports.ButtonVariant.Neutral }, { children: translateCommon('back') }))), jsxRuntime.jsxs("div", __assign({ className: "page-header__content" }, { children: [hasBreadcrumbs && jsxRuntime.jsx(Breadcrumbs, { className: "page-header__breadcrumbs", items: breadcrumbItems }), jsxRuntime.jsxs("div", __assign({ className: "page-header__head" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "page-header__title" }, { children: [iconName && (jsxRuntime.jsx(Icon, { className: "page-header__icon", name: iconName, size: level > 1 ? exports.IconSize.LG : exports.IconSize.XL })), jsxRuntime.jsx(Heading, __assign({ className: "page-header__title-text", level: 1, size: level > 1 ? exports.Size.sm : exports.Size.md }, { children: title })), badge] })), buttons && buttons.length > 0 && jsxRuntime.jsx("div", __assign({ className: "page-header__button-group" }, { children: buttons }))] })), hasDetails && jsxRuntime.jsx("div", __assign({ className: "page-header__details" }, { children: details }))] }))] })));
}

function PageLayout(_a) {
    var children = _a.children, className = _a.className, ref = _a.ref;
    return (jsxRuntime.jsx("div", __assign({ className: classNames('page-layout', className), ref: ref }, { children: children })));
}

Object.defineProperty(exports, 'createDataTableColumnHelper', {
    enumerable: true,
    get: function () { return reactTable.createColumnHelper; }
});
exports.ACTION_ITEM_CSS_CLASS = ACTION_ITEM_CSS_CLASS;
exports.ActionItemContent = ActionItemContent;
...
exports.CTRL_MODIFIER_KEY = CTRL_MODIFIER_KEY;
...
exports.ColorSwatchPickerItem = ColorSwatchPickerItem;
exports.ColumnConfigurator = ColumnConfigurator;
exports.ContentBlock = ContentBlock;
exports.DEFAULT_TOOLBAR_CONFIG = DEFAULT_TOOLBAR_CONFIG;
exports.DataCard = DataCard;
exports.DataTable = DataTable;
exports.DataTableActionButtonCell = DataTableActionButtonCell;
exports.DataTableCheckboxCell = DataTableCheckboxCell;
exports.DataTableCheckboxHeader = DataTableCheckboxHeader;
exports.DataTableDragHandleCell = DataTableDragHandleCell;
exports.DataTableExpanderCell = DataTableExpanderCell;
exports.DataTableSelectCell = DataTableSelectCell;
exports.DataTableTextCell = DataTableTextCell;
exports.DataTableTextFieldCell = DataTableTextFieldCell;
exports.DataTableToolbar = DataTableToolbar;
exports.DatePicker = DatePicker;
exports.DateTile = DateTile;
exports.DateTimeRangeFields = DateTimeRangeFields;
exports.DayOfMonth = DayOfMonth;
exports.DialogTrigger = DialogTrigger;
exports.Divider = Divider;
exports.Drawer = Drawer;
exports.DueDateButton = DueDateButton;
...
exports.GlobalToastRegion = GlobalToastRegion;
exports.HEADING_SIZE_LG_CSS_CLASS = HEADING_SIZE_LG_CSS_CLASS;
exports.HEADING_SIZE_MD_CSS_CLASS = HEADING_SIZE_MD_CSS_CLASS;
exports.HEADING_SIZE_SM_CSS_CLASS = HEADING_SIZE_SM_CSS_CLASS;
exports.HEADING_SIZE_XS_CSS_CLASS = HEADING_SIZE_XS_CSS_CLASS;
exports.HEADING_SIZE_XXS_CSS_CLASS = HEADING_SIZE_XXS_CSS_CLASS;
...
exports.KANBAN_CARD_HOVER_BUTTON_CSS_CLASS = KANBAN_CARD_HOVER_BUTTON_CSS_CLASS;
exports.Kanban = Kanban;
exports.KanbanCard = KanbanCard;
exports.LABEL_SIZE_LG_CSS_CLASS = LABEL_SIZE_LG_CSS_CLASS;
exports.LABEL_SIZE_MD_CSS_CLASS = LABEL_SIZE_MD_CSS_CLASS;
exports.LABEL_SIZE_SM_CSS_CLASS = LABEL_SIZE_SM_CSS_CLASS;
exports.LABEL_SIZE_XS_CSS_CLASS = LABEL_SIZE_XS_CSS_CLASS;
exports.Label = Label;
exports.LayoutGrid = LayoutGrid;
exports.LayoutGridItem = LayoutGridItem;
exports.LayoutGridItemPresetSize = LayoutGridItemPresetSize;
exports.Link = Link;
exports.List = List;
...
exports.SelectOptionContent = SelectOptionContent;
exports.SelectOptionsEmptyState = SelectOptionsEmptyState;
exports.SideNav = SideNav;
exports.Skeleton = Skeleton;
exports.SkeletonText = SkeletonText;
exports.SkeletonTextMultiline = SkeletonTextMultiline;
...
exports.TextFieldCopy = TextFieldCopy;
exports.TextFieldSelect = TextFieldSelect;
exports.TextFieldUnit = TextFieldUnit;
exports.TextFieldVisibilityToggle = TextFieldVisibilityToggle;
...
exports.TreeMultiSelect = TreeMultiSelect;
exports.TreeSelect = TreeSelect;
exports.TriggerElement = TriggerElement;
exports.UploadItem = UploadItem;
exports.chartMinWidth = chartMinWidth;
exports.closeToast = closeToast;
exports.iconNames = iconNames;
exports.icons = icons;
exports.useKanbanDroppableColumnBody = useKanbanDroppableColumnBody;
