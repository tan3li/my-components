...
import { RadioGroup as ReactAriaRadioGroup } from 'react-aria-components';
...
export function RadioGroup(_a) {
    ...
    if (isSkeleton) {
        ...
        return (_jsx(SkeletonField, { className: "skeleton-radio-group", hasHelpText: hasAnyHelpText, hasLabel: !!label, inputRectHeight: size === Size.md ? '5.5rem' : '4.75rem', size: fieldSize }));
    }
    return (_jsx(ReactAriaRadioGroup, __assign({}, props, { className: classNames('radio-group', className), isDisabled: isDisabled, isInvalid: hasError, isReadOnly: isReadOnly, isRequired: isRequired, onChange: onChange !== null && onChange !== void 0 ? onChange : changeParamsCb }, { children: _jsx(Field, __assign({ dataState: dataState, helpText: helpText, helpTextSuccess: helpTextSuccess, isDisabled: isDisabled, isInvalid: isInvalid, isRequired: isRequired, label: label, showHelpTextIcon: showHelpTextIcon, size: fieldSize, tooltipContent: tooltipContent }, { children: mappedChildren })) })));
}
